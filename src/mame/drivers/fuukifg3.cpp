...
GAME( 1998, asurablds01, asurabld, fuuki32, asurabld, fuuki32_state, empty_init, ROT0, "hack", "Asura Blade - Sword of Dynasty (Energy Mode Max)", MACHINE_SUPPORTS_SAVE )
GAME( 1998, asurablds02, asurabld, fuuki32, asurabld, fuuki32_state, empty_init, ROT0, "hack", "Asura Blade - Sword of Dynasty (Enable hidden characters)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2000, asurabuss01, asurabus, fuuki32, asurabusa,fuuki32_state, empty_init, ROT0, "hack", "Asura Buster (Enable Hidden Characters)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, asurabuss02, asurabus, fuuki32, asurabusa,fuuki32_state, empty_init, ROT0, "hack", "Asura Buster (Enable Hidden Characters, Max Power)", MACHINE_SUPPORTS_SAVE )
