...
//Power Instinct
GAME( 2006, powernbr,  		powerins, powerins, 	 powerins, 	 powerins_state,   empty_init, 	   ROT0, "Neogeo BR team", "Power Instinct (Brasil)", MACHINE_SUPPORTS_SAVE ) // 06.04.25 date
GAME( 2006, powerns01,      powerins, powerins,      powerins,   powerins_state,   empty_init,     ROT0,          "Hacks", "Power Instinct (Description Of Unknown Origin 01)", MACHINE_SUPPORTS_SAVE )
GAME( 2006, powerns02,      powerins, powerins,      powerins,   powerins_state,   empty_init,     ROT0,          "Hacks", "Power Instinct (Enable Hidden Character)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1993, powerinss01,    powerins, powerins,      powerins,   powerins_state,   empty_init,     ROT0,          "Hacks", "Power Instinct (USA)(Enable Hidden Character)", MACHINE_SUPPORTS_SAVE )
GAME( 1993, powerinsas01,   powerins, powerinsa,     powerins,   powerins_state,   empty_init,     ROT0,          "Hacks", "Power Instinct (USA, bootleg set 1)(Enable Hidden Character)", MACHINE_SUPPORTS_SAVE )
GAME( 1993, powerinsas02,   powerins, powerinsa,     powerins,   powerins_state,   empty_init,     ROT0,          "Hacks", "Power Instinct (USA, bootleg set 1)(Translation-Portuguese)", MACHINE_SUPPORTS_SAVE )
GAME( 1993, powerinsbs01,   powerins, powerinsb,     powerins,   powerins_state,   empty_init,     ROT0,          "Hacks", "Power Instinct (USA, bootleg set 2)(Enable Hidden Character)", MACHINE_SUPPORTS_SAVE )
GAME( 1993, powerinsbs02,   powerins, powerinsb,     powerins,   powerins_state,   empty_init,     ROT0,          "Hacks", "Power Instinct (USA, bootleg set 2)(Translation-Portuguese)", MACHINE_SUPPORTS_SAVE )
