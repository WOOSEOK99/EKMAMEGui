...
ROM_START( savagedb )
	...
	ROM_LOAD16_WORD_SWAP( "059db-p1.bin", 0x100000, 0x100000, CRC(83BE1CFC) )
...
ROM_START( kakleh )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "092eh-p1.bin", 0x100000, 0x100000, CRC(bcf0f989 ))
	ROM_CONTINUE(						0x000000, 0x100000 )

	NEO_SFIX_128K( "092-s1.bin", CRC(a3d68ee2 ))

	NEO_BIOS_AUDIO_128K( "092-m1.bin", CRC(91957ef6 ))

	ROM_REGION( 0x700000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "092-v1.bin", 0x000000, 0x200000, CRC(69e90596 ))
	ROM_LOAD( "092-v2.bin", 0x200000, 0x200000, CRC(7abdb75d ))
	ROM_LOAD( "092-v3.bin", 0x400000, 0x200000, CRC(eccc98d3 ))
	ROM_LOAD( "092-v4.bin", 0x600000, 0x100000, CRC(a7c9c949 ))

	

	ROM_REGION( 0x1000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "092-c1.bin", 0x000000, 0x400000, CRC(2a9fab01 )) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "092-c2.bin", 0x000001, 0x400000, CRC(6d2bac02 )) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "092-c3.bin", 0x800000, 0x400000, CRC(5da735d6 )) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "092-c4.bin", 0x800001, 0x400000, CRC(de07f997 )) /* Plane 2,3 */
ROM_END

ROM_START( kabukyc )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "092yc-p1.bin", 0x100000, 0x100000, CRC(dc1b9aae ))
	ROM_CONTINUE(						0x000000, 0x100000 )
...
ROM_START( kabukc )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "092gmc-p1.bin", 0x100000, 0x100000, CRC(928aa6ce ))
	ROM_CONTINUE(						0x000000, 0x100000 )
...
ROM_START( kabukgm )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "092gm-p1.bin", 0x100000, 0x100000, CRC(af1f9201 ))
	ROM_CONTINUE(						0x000000, 0x100000 )
...
ROM_START( kabukmc )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "092mc-p1.bin", 0x100000, 0x100000, CRC(4807f850 ))
	ROM_CONTINUE(						0x000000, 0x100000 )
...
ROM_START( shocktr2h )
	...
	ROM_LOAD16_WORD_SWAP( "246-p1h.bin", 0x000000, 0x100000, CRC(0af69336 ))
	ROM_LOAD16_WORD_SWAP( "246-p2.bin", 0x100000, 0x400000, CRC(72ea04c3 ))

	NEO_SFIX_128K( "246-s1.bin", CRC(2a360637 ))

	NEO_BIOS_AUDIO_128K( "246-m1.bin", CRC(d0604ad1 ))

	ROM_REGION( 0x1000000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "246-v1.bin", 0x000000, 0x400000, CRC(16986fc6 ))
	ROM_LOAD( "246-v2.bin", 0x400000, 0x400000, CRC(ada41e83 ))
	ROM_LOAD( "246-v3.bin", 0x800000, 0x200000, CRC(a05ba5db ))

	

	ROM_REGION( 0x3000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "246-c1.bin", 0x0000000, 0x800000, CRC(47ac9ec5 )) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "246-c2.bin", 0x0000001, 0x800000, CRC(7bcab64f )) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "246-c3.bin", 0x1000000, 0x800000, CRC(db2f73e8 )) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "246-c4.bin", 0x1000001, 0x800000, CRC(5503854e )) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "246-c5.bin", 0x2000000, 0x800000, CRC(055b3701 )) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "246-c6.bin", 0x2000001, 0x800000, CRC(7e2caae1 )) /* Plane 2,3 */
ROM_END

ROM_START( aof2b )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "056-p1b.bin", 0x000000, 0x100000, CRC(c3dc11f8 ))

	NEO_SFIX_128K( "056-s1.bin", CRC(8b02638e ))

	NEO_BIOS_AUDIO_128K( "056-m1.bin", CRC(f27e9d52 ))

	ROM_REGION( 0x500000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "056-v1.bin", 0x000000, 0x200000, CRC(4628fde0 ))
	ROM_LOAD( "056-v2.bin", 0x200000, 0x200000, CRC(b710e2f2 ))
	ROM_LOAD( "056-v3.bin", 0x400000, 0x100000, CRC(d168c301 ))

	

	ROM_REGION( 0x1000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "056-c1.bin", 0x000000, 0x200000, CRC(17b9cbd2 )) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "056-c2.bin", 0x000001, 0x200000, CRC(5fd76b67 )) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "056-c3.bin", 0x400000, 0x200000, CRC(d2c88768 )) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "056-c4.bin", 0x400001, 0x200000, CRC(db39b883 )) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "056-c5.bin", 0x800000, 0x200000, CRC(c3074137 )) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "056-c6.bin", 0x800001, 0x200000, CRC(31de68d3 )) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "056-c7.bin", 0xc00000, 0x200000, CRC(3f36df57 )) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "056-c8.bin", 0xc00001, 0x200000, CRC(e546d7a8 )) /* Plane 2,3 */
ROM_END

ROM_START( aof2br )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "056br2-p1.bin", 0x000000, 0x100000, CRC(02d068b7 ))
...
ROM_START( nitdn )
	...
	ROM_LOAD16_WORD_SWAP( "260-p1.bin", 0x000000, 0x080000, CRC(61361082 ))
	...
	NEO_BIOS_AUDIO_512K( "260-m1.bin", CRC(6407c5e5 ))

	ROM_REGION( 0x0400000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "260-v1.bin", 0x000000, 0x400000, CRC(24b0480c ))

	

	ROM_REGION( 0x1000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "nitdn_c1.bin", 0x0000000, 0x800000, CRC(f3ff4953 ))
	ROM_LOAD16_BYTE( "nitdn_c2.bin", 0x0000001, 0x800000, CRC(f1e49faa ))
ROM_END

ROM_START( pnyaand )
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "267-p1.bin", 0x000000, 0x80000, CRC(400fd762) )
 ...
 /* The Encrypted Boards do _not_ have an s1 rom, data for it comes from the Cx ROMs */
  ...
  ROM_LOAD( "sfix.sfix", 0x000000, 0x20000, CRC(c2ea0cfd) SHA1(fd4a618cdcdbf849374f0a50dd8efe9dbab706c3) )
	...
	// decrypted
	NEO_BIOS_AUDIO_512K( "267-m1d.bin", CRC(d58eaa8e) ) // = 128K:m1(c13895b9) + 128K:m1(87b103b9) * 3
	
	ROM_REGION( 0x400000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "267-v1.bin", 0x000000, 0x400000, CRC(1ac7db71) )

	

	ROM_REGION( 0x1000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "267-c1.bin", 0x000000, 0x800000, CRC(2bd02a33))
	ROM_LOAD16_BYTE( "267-c2.bin", 0x000001, 0x800000, CRC(8fb27b0b) )
ROM_END

ROM_START( ganryun )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "252-p1.bin", 0x100000, 0x100000, CRC(4b8ac4fb ))
	ROM_CONTINUE(						0x000000, 0x100000 )
	...
	NEO_BIOS_AUDIO_128K( "252-m1.bin", CRC(30cc4099 ))

	ROM_REGION( 0x0400000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "252-v1.bin", 0x000000, 0x400000, CRC(e5946733 ))

	

	ROM_REGION( 0x1000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "gann_c1.bin", 0x0000000, 0x800000, CRC(6bf7605b )) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "gann_c2.bin", 0x0000001, 0x800000, CRC(596792ce )) /* Plane 2,3 */
ROM_END

ROM_START( sonicwi3h )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "097-p1h.bin", 0x100000, 0x100000, CRC(a09735bd) )
	ROM_CONTINUE(						0x000000, 0x100000 )
...
ROM_START( pbobblnb )
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "083-p1b.bin", 0x000000, 0x080000, CRC(ac1e9ef3) SHA1(a2b125ee70869667431ab125bc29e768500802ad) )

	NEO_SFIX_128K( "083-s1.bin", CRC(9caae538) SHA1(cf2d90a7c1a42107c0bb8b9a61397634286dbe0a) )

	NEO_BIOS_AUDIO_128K( "083-m1b.bin", CRC(f424368a) SHA1(5e5bbcaeb82bed2ee17df08f005ca20ad1030723) )

	ROM_REGION( 0x100000, "cslot1:ymsnd", 0 )
	/* 0x000000-0x1fffff empty */
	ROM_LOAD( "083-v1b.bin", 0x000000, 0x080000, CRC(f8872aed) SHA1(73685980253093b4f148cb38b6a47476fb2a61aa) )
	ROM_LOAD( "083-v2b.bin", 0x000001, 0x080000, CRC(5c8cf5fe) SHA1(97d74466ac48708d7f4004524288dd2f32f17793) )
...
ROM_START( aof3b )
	...
	ROM_LOAD16_WORD_SWAP( "096b-p1.bin", 0x000000, 0x100000, CRC(255aec23) )
...
ROM_START( karnovreh )
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "066eh-p1.bin", 0x000000, 0x100000, CRC(76DFB5BE) )
...
ROM_START( kizunaeh )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "216eh-p1.bin", 0x100000, 0x100000, CRC(A4CCD402) )
	ROM_CONTINUE(					 0x000000, 0x100000 )
...
ROM_START( ragnagrdh )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "218h-p1.bin", 0x100000, 0x100000, CRC(FB1E20DF) )
	ROM_CONTINUE(						0x000000, 0x100000 )
...
ROM_START( breaksp )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "230sp-p1.bin", 0x100000, 0x100000, CRC(244ad91b))
	ROM_CONTINUE(						0x000000, 0x100000 )
...
ROM_START( fightfek )
	...
	NEO_SFIX_128K( "060k-s1.bin", CRC(51eaac30))
...
ROM_START( nitda ) /* Original Version - Encrypted GFX */
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "260-p1a.bin", 0x000000, 0x080000, CRC(bdef9b73) )
...
ROM_START( njeh )
	ROM_REGION( 0x300000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "217eh-p1.bin", 0x000000, 0x100000, CRC(2cb6c199))
...
ROM_START( njehc )
	ROM_REGION( 0x300000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "217ehc-p1.bin", 0x000000, 0x100000, CRC(8b88e675))
	ROM_LOAD16_WORD_SWAP( "217-p2.bin", 0x100000, 0x200000, CRC(191fca88) SHA1(e318e5931704779bbe461719a5eeeba89bd83a5d) )
...
ROM_START( njehyc )
	ROM_REGION( 0x300000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "217ehyc-p1.bin", 0x000000, 0x100000, CRC(99a9ca85))
	ROM_LOAD16_WORD_SWAP( "217-p2.bin", 0x100000, 0x200000, CRC(191fca88) SHA1(e318e5931704779bbe461719a5eeeba89bd83a5d) )
...
ROM_START( viewpntr )
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "051tr-p1.bin", 0x000000, 0x100000, CRC(063b9fa2) SHA1(e2d43646a976d82c809c6fad7dd40cc3dda07b15) )
...
ROM_START( ww7bh )
	ROM_REGION( 0x300000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "225bh-p1.bin", 0x000000, 0x100000, CRC(7a8fda8e) )
...
ROM_START( s1945pn )
	...
	/* The Encrypted Boards do _not_ have an s1 rom, data for it comes from the Cx ROMs */
	NEO_SFIX_128K( "254-s1.bin", CRC(121a4f94 ))
...
ROM_START( mslug5fd )
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "268-p1d.bin", 0x000000, 0x100000, CRC(ca50afdf) )
	ROM_LOAD16_WORD_SWAP( "268-p2d.bin", 0x100000, 0x400000, CRC(768ee64a) )
	
  NEO_SFIX_128K( "268-s1.bin ", CRC(64952683) SHA1(88ec728c2fe18a11fdd218bed5d73bb3affe2ec1) )

  NEO_BIOS_AUDIO_64K( "268d-m1.bin", CRC(3c0655a7) SHA1(ae839d4c2b87a7aa3dd8e5caddc43eb75ee9b732) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "268-v1d.bin", 0x000000, 0x400000, CRC(F61DAA9E ))
	ROM_LOAD( "268-v2d.bin", 0x400000, 0x400000, CRC(EEB7C926 ))
	ROM_LOAD( "268-v3d.bin", 0x800000, 0x400000, CRC(02FD519E ))
	ROM_LOAD( "268-v4d.bin", 0xC00000, 0x400000, CRC(D7C67794 ))
  ...
  ROM_LOAD16_BYTE( "268-c4d.bin", 0x1000001, 0x800000, CRC(899fb2af) ) /* Plane 2,3 */
...
ROM_START( mslug5a )
	...
	NEO_BIOS_AUDIO_256K( "268-m1d.bin", CRC(6866d696) SHA1(3638b072e44277a6bffea5a78a915a14c6afcba0) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "268-v1a.bin", 0x000000, 0x800000, CRC(AE31D60C) )
	ROM_LOAD( "268-v2a.bin", 0x800000, 0x800000, CRC(C40613ED) )
...
ROM_START( mslug5ad )
	...
	ROM_REGION( 0x1000000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "268-v1ad.bin", 0x000000, 0x800000, CRC(7FF6CA47) )
	ROM_LOAD( "268-v2ad.bin", 0x800000, 0x800000, CRC(696CCE3B) )
...
ROM_START( mslug5c )
	...
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "268-c1c.bin", 0x0000000, 0x800000, CRC(ab7c389a)  )
	ROM_LOAD16_BYTE( "268-c2c.bin", 0x0000001, 0x800000, CRC(3560881b)  )
	ROM_LOAD16_BYTE( "268-c3c.bin", 0x1000000, 0x800000, CRC(3af955ea)  )
	ROM_LOAD16_BYTE( "268-c4c.bin", 0x1000001, 0x800000, CRC(c329c373)  )
	ROM_LOAD16_BYTE( "268-c5c.bin", 0x2000000, 0x800000, CRC(959c8177)  )
	ROM_LOAD16_BYTE( "268-c6c.bin", 0x2000001, 0x800000, CRC(010a831b)  )
	ROM_LOAD16_BYTE( "268-c7c.bin", 0x3000000, 0x800000, CRC(6d72a969)  )
	ROM_LOAD16_BYTE( "268-c8c.bin", 0x3000001, 0x800000, CRC(551d720e)  )
ROM_END
...
ROM_START( nam1975g ) // sound effects only, no music no voices
	...
	ROM_REGION( 0x100000, "cslot1:ymsnd", 0 ) // weapons fire
...
ROM_START( trallycd ) // title screen is corrupt
	...
	ROM_REGION( 0x0e0000, "cslot1:ymsnd", 0 )
...
ROM_START( aof2s02 )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "056s02.p1", 0x000000, 0x100000, CRC(c461e89c) SHA1(96794c45ae60acd359a99974ab49028764d8ff26) )
...
ROM_START( aof2as01 )
	...
	ROM_LOAD16_WORD_SWAP( "056hs01.ep1", 0x000000, 0x80000, CRC(e52440e4) SHA1(1cc80af76349659250821f1eadc79649d4822b19) )
...
ROM_START( aof2as02 )
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "056.p1",  0x000000, 0x100000, CRC(a3b1d021) SHA1(ee42f3ca4516226b0088d0303ed28e3ecdabcd71) )
	ROM_LOAD16_WORD_SWAP( "056hs02.ep1", 0x000000, 0x80000, CRC(c7622ec5) SHA1(e63a8cd08b3e6efec3a3bf1e1b4148cdb36b496a) )
...
ROM_START( aof2as03 )
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "056.p1",  0x000000, 0x100000, CRC(a3b1d021) SHA1(ee42f3ca4516226b0088d0303ed28e3ecdabcd71) )
	ROM_LOAD16_WORD_SWAP( "056hs03.ep1", 0x000000, 0x80000, CRC(93397a4b) SHA1(a76b3971c504ccbf293b7db0f14b60604ab581bd) )
...
ROM_START( aof2as04 )
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "056.p1",  0x000000, 0x100000, CRC(a3b1d021) SHA1(ee42f3ca4516226b0088d0303ed28e3ecdabcd71) )
	ROM_LOAD16_WORD_SWAP( "056hs04.ep1", 0x000000, 0x80000, CRC(03cb0ab3) SHA1(ef7f6cce19e3e6ac2b52c463bd328a74312f0c6a) )
...
ROM_START( aof3ks01 )
	ROM_REGION( 0x300000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "196ks01.p1", 0x000000, 0x100000, CRC(1bf9a9a7) SHA1(037ddb796d771864872c0dbbfc9c6b3f84794c28) )
	ROM_LOAD16_WORD_SWAP( "096.p2", 0x100000, 0x200000, CRC(4d5a2602) SHA1(4c26d6135d2877d9c38169662033e9d0cc24d943) )
...
ROM_START( aof3ks02 )
	ROM_REGION( 0x300000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "196ks02.p1", 0x000000, 0x100000, CRC(4e35da75) SHA1(aeba623754989523df0b4617819ead98f77af1d0) )
	ROM_LOAD16_WORD_SWAP( "096.p2", 0x100000, 0x200000, CRC(4d5a2602) SHA1(4c26d6135d2877d9c38169662033e9d0cc24d943) )
...
ROM_START( fightfevs01 ) 
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "060hc01.p1", 0x0000000, 0x100000, CRC(0b9e106d) SHA1(1704c2b416747288cf37e52e927857819badcb62) )
...
ROM_START( fightfevs02 )
	...
	NEO_SFIX_128K( "060hc02.s1", CRC(2154f605) SHA1(10d6968f87ae59746377baeea672b13290c796ab) )
...
ROM_START( kizunas01 )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "216hc01.p1", 0x100000, 0x100000, CRC(0d9a4f25) SHA1(675daf6c210cbeb79bfe54c33499de4a4eadc82f) )
	ROM_CONTINUE( 0x000000, 0x100000 )
...
ROM_START( kizunas02 )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "216hc02.p1", 0x100000, 0x100000, CRC(068341da) SHA1(94adb64ebb702e998c9adf3b8d2cae6c0200bbd5) )
	ROM_CONTINUE( 0x000000, 0x100000 )
...
ROM_START( kizunas03 )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "216hc03.p1", 0x100000, 0x100000, CRC(ce2bf8d3) SHA1(bce967db52a219895e495adca54bb629b99d13a5) )
	ROM_CONTINUE( 0x000000, 0x100000 )
...
ROM_START( kizunas04 )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "216hc04.p1", 0x100000, 0x100000, CRC(23c43c42) SHA1(5a4bef5504577096d4d8a2a64228a4d21c2ca52b) )
	ROM_CONTINUE( 0x000000, 0x100000 )
...
ROM_START( magdrop3s01 )
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "233hc01.p1", 0x000000, 0x100000, CRC(80bfe2a9) SHA1(12caa131ccdc6e1a54914440022556921fab8a5e) )
...
ROM_START( miexchngs01 )
	...
	ROM_REGION( 0x600000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "231hc01.c1", 0x000000, 0x200000, CRC(67deb71d) SHA1(1dd79cb7efe92fc793bfd92130ca646728729d70) )
	ROM_LOAD16_BYTE( "231fr.c2", 0x000001, 0x200000, CRC(6a2acd38) SHA1(bc35e7f9898ed6d7fd9ce43d4a4be91a81d0bd04) )
...
ROM_START( neocup98s01 )
	...
	ROM_REGION( 0x1000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "244hc01.c1", 0x000000, 0x800000, CRC(8505fa3e) SHA1(79cde36cb44a87a528212aa3872c680880c5af9e) )
	ROM_LOAD16_BYTE( "244k.c2", 0x000001, 0x800000, CRC(54e86379) SHA1(e76f27b5cf2ab7ed00a8abfe2e2397394c51dac5) )
ROM_END
...
ROM_START( ninjamass01 )
	ROM_REGION( 0x300000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "217hc01.p1",  0x000000, 0x100000, CRC(661d86c9) SHA1(8a8906e0fe2b1fc2e7bd69cd7f2dc7c7f8683331) )
	ROM_LOAD16_WORD_SWAP( "217.p2", 0x100000, 0x200000, CRC(191fca88) SHA1(e318e5931704779bbe461719a5eeeba89bd83a5d) )
...
ROM_START( ninjamass02 )
	ROM_REGION( 0x300000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "217hc02.p1",  0x000000, 0x100000, CRC(4a39ded2) SHA1(f761d56acbcc04b2395dda43af8f277d4673b48a) )
	ROM_LOAD16_WORD_SWAP( "217.p2", 0x100000, 0x200000, CRC(191fca88) SHA1(e318e5931704779bbe461719a5eeeba89bd83a5d) )
...
ROM_START( ninjamass03 )
	ROM_REGION( 0x300000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "217hc03.p1",  0x000000, 0x100000, CRC(26068997) SHA1(02a60c1627862c1c6d99e3c5e19264298a38735b) )
	ROM_LOAD16_WORD_SWAP( "217.p2", 0x100000, 0x200000, CRC(191fca88) SHA1(e318e5931704779bbe461719a5eeeba89bd83a5d) )
...
ROM_START( ninjamass05 )
	ROM_REGION( 0x300000, "maincpu", ROMREGION_BE|ROMREGION_16BIT )
...
ROM_START( nitds02 )
	...
	ROM_REGION( 0x1000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "260hc01.c1", 0x0000000, 0x800000, CRC(2ba215ac) SHA1(529f87d2073e452fd340b454e4f9e77c7e86b83b) )
	ROM_LOAD16_BYTE( "260hc01.c2", 0x0000001, 0x800000, CRC(989cb0bb) SHA1(f3af75c1dda10b3285ad7201e1d67c8c1ad279ef) )
ROM_END
...
ROM_START( ragnagrds01 )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "218hc01.p1", 0x100000, 0x100000, CRC(53286ebf) SHA1(2212483519d10b51eb30d6035b319321141cfc5e) )
	ROM_CONTINUE( 0x000000, 0x100000 )
...
ROM_START( savageres02 )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "059hc02.p1", 0x100000, 0x100000, CRC(51533496) SHA1(34e450f0805fd318ea98394a805155fa42a33c30) )
	ROM_CONTINUE( 0x000000, 0x100000 )
...
ROM_START( savageres03 )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "059hc03.p1", 0x100000, 0x100000, CRC(b440ea9c) SHA1(e5c6295d4b6822db79e685b57e71788dc6d2423d) )
	ROM_CONTINUE( 0x000000, 0x100000 )
...
ROM_START( sdodgebs01 )
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "208hc01.p1", 0x100000, 0x100000, CRC(e6e58566) SHA1(81197d0e02fc37cae0fa071e0343f8bdc53878ac) )
	ROM_CONTINUE( 0x000000, 0x100000 )
...
GAME( 1991, 2020bbcd,      2020bb,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "CD_conv", "2020 Super Baseball (CD conversion)", MACHINE_SUPPORTS_SAVE )

GAME( 1992, androdunpx,    androdun, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Xyahzhs", "Andro Dunos (Plus Max hack by Xyahzhs)", MACHINE_SUPPORTS_SAVE )

GAME( 1992, aofbh,         aof,      neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Yumeji", "Art of Fighting (Boss hack by Yumeji)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, aof2b,         aof2,     neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "TcwLee", "Art of Fighting 2 (Geese instead of Mr. Big)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, aof2b1,        aof2,     neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Yumeji", "Art of Fighting 2 (Boss hack)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, aof2bh,        aof2,     neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Yumeji", "Art of Fighting 2 (Boss hack by Yumeji)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, aof3b,         aof3,     neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Dodowang", "Art of Fighting 3 (Boss hack by Dodowang)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, aof3bh,        aof3,     neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Yumeji", "Art of Fighting 3 (Boss hack by Yumeji)", MACHINE_SUPPORTS_SAVE )

GAME( 2000, bangbeadd,     bangbead, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Visco", "Bang Bead (decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, bangbeadp,     bangbead, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Visco", "Bang Bead (prototype)", MACHINE_SUPPORTS_SAVE ) // commented out in official MAME source
GAME( 1990, bjourneypx,    bjourney, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Xyahzhs", "Blue's Journey / Raguy (Plus Max hack by Xyahzhs)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, breakersbh,    breakers, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Yumeji", "Breakers (Boss hack by Yumeji)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, breakersp,     breakers, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Breakers (Move change 26c?)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, breakersy,     breakers, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "ZKW", "Breakers (Boss Robert PPX Team hack remixed by ZKW)", MACHINE_SUPPORTS_SAVE )
GAME( 1998, breakrevb,     breakrev, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Yumeji", "Breakers Revenge (Boss hack by Yumeji)", MACHINE_SUPPORTS_SAVE )
GAME( 2009, breakrevpp,    breakrev, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Pipi899", "Breakers Revenge (Enhanced Power hack by Pipi899 2009-06-11)", MACHINE_SUPPORTS_SAVE )
GAME( 1998, breakrevy,     breakrev, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "ZKW", "Breakers Revenge (Boss Robert PPX Team hack remixed by ZKW)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, burningfhp,    burningf, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Lb70", "Burning Fight (High Power by EEZEZY(LB70))", MACHINE_SUPPORTS_SAVE )

GAME( 1999, ctomadaypx,    ctomaday, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Xyahzhs", "Captain Tomaday (Plus Max hack by Xyahzhs)", MACHINE_SUPPORTS_SAVE )

GAME( 1997, dragons1,      neogeo,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Face", "Dragon's Heaven", MACHINE_SUPPORTS_SAVE )

GAME( 2009, eightmaneb,    eightman, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Blackheart", "Eight Man (Enhanced Version hack by Blackheart 2009-08-22)", MACHINE_SUPPORTS_SAVE )

GAME( 1994, fightfevbs,    fightfev, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Yumeji", "Fight Fever (Boss hack by Yumeji)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, fightfevk,     fightfev, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Unk", "Fight Fever (Kanji Patch)", MACHINE_SUPPORTS_SAVE )

GAME( 1998, flipshotk,     flipshot, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Battle Flip Shot (Korean)", MACHINE_SUPPORTS_SAVE )

GAME( 1995, galaxyfgb,     galaxyfg, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Yumeji", "Galaxy Fight (Boss hack by Yumeji)", MACHINE_SUPPORTS_SAVE )
GAME( 2014, galaxyfgbh,    galaxyfg, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Yumeji", "Galaxy Fight (Boss Hack 2014 Edition by Yumeji)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, ganryud,       ganryu,   cmc42sfix_ek,  neo_ek, mvs_led_state, empty_init,  ROT0, "Visco", "Ganryu / Musashi Ganryuki (decrypted C)", MACHINE_SUPPORTS_SAVE )

GAME( 1995, gowcaizrb,     gowcaizr, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Wesker", "Voltage Fighter (Boss hack by Wesker (FGCH))", MACHINE_SUPPORTS_SAVE )
GAME( 1995, gowcaizrbs,    gowcaizr, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Yumeji", "Voltage Fighter (Boss hack by Yumeji)", MACHINE_SUPPORTS_SAVE )
GAME( 2009, gowcaizrrv,    gowcaizr, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Voltage Fighter - Gowcaizer (Boss Revised Version 2009-10-05)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, gowcaizry,     gowcaizr, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Voltage Fighter - Gowcaizer (Boss Hack - Easy Moves)", MACHINE_SUPPORTS_SAVE)

GAME( 1991, gpilotscd,     gpilots,  neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "CD_conv", "Ghost Pilots (CD conversion)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, gpilotse,      gpilots,  neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Robert", "Ghost Pilots (Enhanced Version, Hack by Robert)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, gpilotspx,     gpilots,  neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Xyahzhs", "Ghost Pilots (Plus Max hack by Xyahzhs)", MACHINE_SUPPORTS_SAVE )

GAME( 1996, ironcladb,     ironclad, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Saurus", "Ironclad (conversion from Wii)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, ironcladcd,    ironclad, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "CD_conv", "Ironclad (CD conversion)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
GAME( 2007, joyjoycd,      joyjoy,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "SNK", "Puzzled (CD conversion)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, joyjoycd1,     joyjoy,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "CD_conv", "Puzzled / Joy Joy Kid (CD conversion)", MACHINE_SUPPORTS_SAVE )

GAME( 1995, kabukiklb,     kabukikl, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Ydmis / Creamymami", "Far East of Eden - Kabuki Klash (Boss Hack by Ydmis and Creamymami)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, kabukikleh,    kabukikl, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Ydmis", "Far East of Eden - Kabuki Klash (Add Char)", MACHINE_SUPPORTS_SAVE ) // Manto, Karakuri, Jyashinsai and Lucifeller
GAME( 1995, kabukiklgm,    kabukikl, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Flycboy", "Far East of Eden - Kabuki Klash (Color Fix set 2 - Title screen and char color changed)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, kabukiklgmc,   kabukikl, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Flycboy", "Far East of Eden - Kabuki Klash (Color Fix set 1 - Title screen and char color changed)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, kabukiklmc,    kabukikl, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Creamymami", "Far East of Eden - Kabuki Klash (Magic always max)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, kabukiklyc,    kabukikl, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Creamymami and Ydmis", "Far East of Eden - Kabuki Klash (Add Char - Magic always max)", MACHINE_SUPPORTS_SAVE ) // Manto, Karakuri, Jyashinsai and Lucifeller - Based on kabukleh

GAME( 1996, kizunab,       kizuna,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Ydmis", "Kizuna Encounter (Add Char)", MACHINE_SUPPORTS_SAVE )
GAME( 2009, kizunaeasy,    kizuna,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "007325", "Kizuna Encounter (Easy Moves hack by 007325 2009-02-23)", MACHINE_SUPPORTS_SAVE )

GAME( 2004, lans2k4d,      shocktr2, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "bootleg", "Lansquenet 2004 (Shock Troopers - 2nd Squad Bootleg / fully decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, lbowlingcd,    lbowling, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "CD_conv", "League Bowling (CD conversion)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, lresortpx,     lresort,  neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Xyahzhs", "Last Resort (Plus Max hack by Xyahzhs)", MACHINE_SUPPORTS_SAVE )

GAME( 2003, magdrop3fr,    magdrop3, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Arkatrad", "Magical Drop III (French)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, maglordpx,     maglord,  neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Xyahzhs", "Magician Lord (Plus Max hack by Xyahzhs)", MACHINE_SUPPORTS_SAVE )

GAME( 2002, matrimh,      matrim,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Matrimelee (Bootleg, Hero Hack)", MACHINE_SUPPORTS_SAVE )
GAME( 2002, matrimnd,      matrim,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Matrimelee (hack nd)", MACHINE_SUPPORTS_SAVE )

GAME( 2005, miexchngfr,    miexchng, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Arkatrad", "Money Puzzle Exchanger (French)", MACHINE_SUPPORTS_SAVE )

GAME( 1992, mutnatex,      mutnat,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Pipi899", "Mutation Nation (Ex version, Pipi899)", MACHINE_SUPPORTS_SAVE )

GAME( 2008, nam1975g,      nam1975,  neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "NAM-1975 (hack?)", MACHINE_SUPPORTS_SAVE )
GAME( 2008, nam1975h,      nam1975,  neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Blast of the Wolf", "NAM-1975 (Max Blast edition)", MACHINE_SUPPORTS_SAVE )

GAME( 1990, ncombatpk,     ncombat,  neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Krizal chen", "Ninja Combat (Plus hack by Krizal chen (Dsght))", MACHINE_SUPPORTS_SAVE )
GAME( 2009, ncommandsp,    ncommand, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "e107", "Ninja Commando (Super Plus hack by e107 2009-08-16)", MACHINE_SUPPORTS_SAVE )
GAME( 1998, neocup98k,     neocup98, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Neo-Geo Cup '98 - The Road to the Victory (Korean)", MACHINE_SUPPORTS_SAVE )

GAME( 1996, ninjamasasp,   ninjamas, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "ZKW", "Ninja Master's (Plus Remixed by ZKW)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, ninjamaschl,   ninjamas, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "CHL", "Ninja Master's (Hack by CHL)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, ninjamaseh,    ninjamas, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Ydmis", "Ninja Master's (Add Char)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, ninjamasehc,   ninjamas, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Creamymami", "Ninja Master's (Pow hack)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, ninjamasehyc,  ninjamas, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Creamymami and Ydmis", "Ninja Master's (Add Char - Pow hack)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, ninjamasha,    ninjamas, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "007325", "Ninja Master's - haoh-ninpo-cho PLUS (Hack by 007325)", MACHINE_SUPPORTS_SAVE )
GAME( 2009, ninjamashb,    ninjamas, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "007325", "Ninja Master's (Happy Batter Edition hack by 007325 2009-09-09)", MACHINE_SUPPORTS_SAVE )

GAME( 2000, nitdd,         nitd,     cmc42sfix_ek,  neo_ek, mvs_led_state, empty_init, ROT0, "Eleven / Gavaking", "Nightmare in the Dark (decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 2006, nitdfr,        nitd,     cmc42sfix_ek,  neo_ek, mvs_led_state, empty_init, ROT0, "Arkatrad", "Nightmare in the Dark (French)", MACHINE_SUPPORTS_SAVE )  // based on decrypted C
GAME( 2005, nitdfro,       nitd,     cmc42sfix_ek,  neo_ek, mvs_led_state, empty_init, ROT0, "Arkatrad", "Nightmare in the Dark (French) (Old)", MACHINE_SUPPORTS_SAVE )   // based on decrypted C
GAME( 2000, nitdfro1,      nitd,     neobase_ek, 	neo_ek, mvs_led_state, empty_init, ROT0, "Eleven / Gavaking", "Nightmare in the Dark French (NEO ARC Traduction)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, nitdpx,        nitd,     nitd,      	neogeo, mvs_led_state, empty_init, ROT0, "Xyahzhs", "Nightmare in the Dark (Plus Max hack by Xyahzhs)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, nitdsp,        nitd,     nitd,      	neogeo, mvs_led_state, empty_init, ROT0, "hack", "Nightmare in the Dark (Spanish)", MACHINE_SUPPORTS_SAVE )
GAME( 2015, nitdsp1,       nitd,     cmc42sfix_ek,  neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Nightmare in the Dark (Spanish.Rev2)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, nitdsp2,       nitd,     neobase_ek, 	neo_ek, mvs_led_state, empty_init, ROT0, "Meganiuz", "Nightmare in the Dark Spanish (Version 1.1 by MEGANIUZ)", MACHINE_SUPPORTS_SAVE )

GAME( 2009, pbcrazyb1,     pbobblen, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Elrayzeur", "Puzzle Bobble Crazy (beta1 2009-07-05)", MACHINE_SUPPORTS_SAVE )
GAME( 2009, pbcrazyb2,     pbobblen, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Elrayzeur", "Puzzle Bobble Crazy (beta2 2009-07-23)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, pbobblenba,    pbobblen, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Taito", "Puzzle Bobble / Bust-A-Move (Neo-Geo) (set 3)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, pbobblencd,    pbobblen, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "bootleg", "Puzzle Bobble / Bust-A-Move (Neo-Geo)(CD conversion)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, pbobblendx,    pbobblen, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Puzzle Bobble Deluxe / Bust-A-Move Deluxe", MACHINE_SUPPORTS_SAVE )
 // Prehistoric Isle 2
GAME( 2017, preisle2s01,   preisle2, cmc42sfix_ek,  neogeo, mvs_led_state, empty_init,  ROT0, "Hacks",    "Prehistoric Isle 2 (Hack (Set 01))", MACHINE_SUPPORTS_SAVE )
GAME( 1999, preisle2d,     preisle2, cmc42sfix_ek,  neo_ek, mvs_led_state, empty_init,  ROT0, "Yumekobo", "Prehistoric Isle 2 (decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, preisle2px,    preisle2, cmc42sfix_ek,  neo_ek, mvs_led_state, empty_init,  ROT0, "Xyahzhs", "Prehistoric Isle 2 (Plus Max hack by Xyahzhs)", MACHINE_SUPPORTS_SAVE )

GAME( 1994, pspikes2cd,    pspikes2, neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "CD_conv", "Power Spikes II (CD conversion)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )

GAME( 1996, ragnagrdbe,    ragnagrd, neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Operation Ragnagard (Easy Moves hack)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, ragnagrdbs,    ragnagrd, neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "Yumeji", "Operation Ragnagard (Boss hack by Yumeji)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, ragnagrdeh,    ragnagrd, neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "Ydmis", "Operation Ragnagard (Add Char)", MACHINE_SUPPORTS_SAVE )
GAME( 2009, ragnagrdsb,    ragnagrd, neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "Lichenzhao", "Operation Ragnagard (Super Boss Easy Moves hack by Lichenzhao 2009-11-16)", MACHINE_SUPPORTS_SAVE )

GAME( 1999, s1945pd,       s1945p,   cmc42sfix_ek,  neo_ek, mvs_led_state, empty_init,  ROT0, "Psikyo", "Strikers 1945 Plus (decrypted C)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, s1945peh,      s1945p,   s1945p,    	neogeo,    mvs_led_state, empty_init,     ROT0, "KrysoFun", "Strikers 1945 Plus (Super Shot hack by KrysoFun)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, s1945ph,       s1945p,   s1945p,    	neogeo,    mvs_led_state, empty_init,     ROT0, "Yumeji", "Strikers 1945 Plus (Ascender P55 hack by Yumeji)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, s1945pwe,      s1945p,   s1945p,    neogeo,    mvs_led_state, empty_init,     ROT0, "Wesker", "Strikers 1945 Plus (Hack)", MACHINE_SUPPORTS_SAVE )

GAME( 1995, savagereb,     savagere, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Yumeji, Dodowang", "Savage Reign (Boss hack by Yumeji/Dodowang)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, savageredb,    savagere, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Dodowang", "Savage Reign (Debug menu unlocked - P1 and P2 Press select to change stage)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, sdodgebp,      sdodgeb,  neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Blackheart", "Super Dodge Ball (Power hack by Blackheart 2009-09-02)", MACHINE_SUPPORTS_SAVE )
GAME( 1998, shocktr2px,    shocktr2, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Xyahzhs", "Shock Troopers - 2nd Squad (Plus Max hack by Xyahzhs)", MACHINE_SUPPORTS_SAVE )
GAME( 1998, shocktr2w,     shocktr2, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Wesker", "Shock Troopers - 2nd Squad (Hack)", MACHINE_SUPPORTS_SAVE )
GAME( 2009, shocktrosp,    shocktro, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "e107", "Shock Troopers (Super Plus hack by e107 2009-08-18)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, sonicwi2eh,    sonicwi2, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Robert", "Aero Fighters 2 / Sonic Wings 2 (Hack alternate set by Robert)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, sonicwi2px,    sonicwi2, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Xyahzhs", "Aero Fighters 2 / Sonic Wings 2 (Plus Max hack by Xyahzhs)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, sonicwi3eh,    sonicwi3, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Robert", "Aero Fighters 3 / Sonic Wings 3 (Hack alternate set by Robert)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, sonicwi3h,     sonicwi3, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Wesker", "Aero Fighters 3 / Sonic Wings 3 (Secret Aircraft)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, sonicwi3px,    sonicwi3, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Xyahzhs", "Aero Fighters 3 / Sonic Wings 3 (Plus Max hack by Xyahzhs)", MACHINE_SUPPORTS_SAVE )
GAME( 1993, spinmasth,     spinmast, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Robert", "Spin Master / Miracle Adventure (Enhanced Version, Hack by Robert)", MACHINE_SUPPORTS_SAVE )
GAME( 1993, spinmastpx,    spinmast, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Xyahzhs", "Spin Master / Miracle Adventure (Plus Max hack by Xyahzhs)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, ssidekicd,     ssideki,  fatfur2,    neogeo, mvs_led_state, empty_init,    ROT0, "CD_conv", "Super Sidekicks / Tokuten Ou (CD conversion)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, strhoopcd,     strhoop,  neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "CD_conv", "Street Hoop (CD conversion)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, superspycd,    superspy, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "CD_conv", "The Super Spy (CD conversion)", MACHINE_SUPPORTS_SAVE )

GAME( 1994, tophuntrpx,    tophuntr, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Xyahzhs", "Top Hunter - Roddy & Cathy (Plus Max hack by Xyahzhs)", MACHINE_SUPPORTS_SAVE )
GAME( 2007, tpgolfcd,      tpgolf,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "CD_conv", "Top Player's Golf (CD conversion)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, trallycd,      trally,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "CD_conv", "Thrash Rally (CD conversion)", MACHINE_IMPERFECT_GRAPHICS | MACHINE_SUPPORTS_SAVE )
GAME( 1996, twinsprih,     twinspri, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Yumeji", "Twinkle Star Sprites (ExChar hack by Yumeji)", MACHINE_SUPPORTS_SAVE )

GAME( 1992, viewpoinf,     viewpoin, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "SHYMA.X", "Viewpoint (French by NEOARC Team)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, viewpointr,    viewpoin, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "KiWi Starlight", "Viewpoint Enhanced", MACHINE_SUPPORTS_SAVE ) // Unlimited lives and mega-bombs for p1 and p2

GAME( 1996, wakuwak7bh,    wakuwak7, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Dodowang", "Waku Waku 7 (Add Char - 2 players only)", MACHINE_SUPPORTS_SAVE ) // Fernandez and Bonus Kun
GAME( 1996, wakuwak7h,     wakuwak7, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Waku Waku 7 (Boss Hack)", MACHINE_SUPPORTS_SAVE )

GAME( 1994, wjammersf,     wjammers, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Elrayzeur", "Windjammers (French v0.1 beta by Elrayzeur)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, wjammersk,     wjammers, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Aneue Bannzai", "Windjammers (Korean hack by Aneue Bannzai)", MACHINE_SUPPORTS_SAVE )

GAME( 2001, zupapad,       zupapa,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "SNK", "Zupapa! (custom decrypted C)", MACHINE_SUPPORTS_SAVE )

// Andro Dunos
GAME( 2017, androduns01,    androdun, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Andro Dunos (Hacks Alt)", MACHINE_SUPPORTS_SAVE )
// Art of Fighting 2
GAME( 1994, aof2br,    		aof2,     neo_ek, neo_ek, mvs_led_state, empty_init, 	ROT0, "SNK", "Art of Fighting 2 (Can select Geese instead of Ryo)", MACHINE_SUPPORTS_SAVE)
GAME( 2016, aof2s01,        aof2,     neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Art of Fighting 2 (Boss, Yumeji Hack)(NGH-056)", MACHINE_SUPPORTS_SAVE )
GAME( 2016, aof2s02,        aof2,     neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Art of Fighting 2 (Description Of Unknown Origin 01)(NGH-056)", MACHINE_SUPPORTS_SAVE )
GAME( 2016, aof2s03,        aof2,     neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Art of Fighting 2 (Description Of Unknown Origin 02)(NGH-056)", MACHINE_SUPPORTS_SAVE )
//GAME( 2016, aof2s04,        aof2,     neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Art of Fighting 2 (Hidden Characters Added Palette For Hidden Characters)(NGH-056)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, aof2as01,       aof2,     neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Art of Fighting 2A (Enable Hidden Characters In Arcade Mode)(NGH-056)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, aof2as02,       aof2,     neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Art of Fighting 2A (Enable Hidden Characters In Arcade Mode V2)(NGH-056)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, aof2as03,       aof2,     neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Art of Fighting 2A (Added Palette For Hidden Characters)(NGH-056)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, aof2as04,       aof2,     neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Art of Fighting 2A (Added palette For hidden Characters V2)(NGH-056)", MACHINE_SUPPORTS_SAVE )
// Art of Fighting 3
GAME( 2017, aof3ks01,       aof3,     neo_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",    "Art of Fighting 3 (Enable Hidden Characters In Arcade Mode V1)(Korean release)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, aof3ks02,       aof3,     neo_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",    "Art of Fighting 3 (Enable Hidden Characters In Arcade Mode V2)(Korean release)", MACHINE_SUPPORTS_SAVE )
// Breakers
GAME( 2017, breakers01,     breakers, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Breakers(Mode Easy)", MACHINE_SUPPORTS_SAVE )
GAME( 200?, breakrevs01,    breakrev, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "kawada7278",    "Breakers Revenge (Mode Easy)", MACHINE_SUPPORTS_SAVE )
GAME( 200?, breakrevs02,    breakrev, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Unknown",    "Breakers Revenge (Super Remix Edition 1.0)", MACHINE_SUPPORTS_SAVE )
GAME( 200?, breakrevs03,    breakrev, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Unknown",    "Breakers Revenge (Description Of Hack Unknown)", MACHINE_SUPPORTS_SAVE ) //FBA4ANDROID BAIDU
GAME( 200?, breakrevs04,    breakrev, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Unknown",    "Breakers Revenge (Boss Version)", MACHINE_SUPPORTS_SAVE ) //FBA4ANDROID BAIDU
 // Fight Fever
GAME( 2017, fightfevs01,    fightfev, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Fight Fever (Enable Hidden Characters)(set 1)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, fightfevs02,    fightfev, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Fight Fever (Fixed Kanji Display Of Some Special Attacks)(set 1)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, fightfevas01,   fightfev, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Fight Fever (Enable Hidden Characters)(set 2)", MACHINE_SUPPORTS_SAVE )
 // Galaxy Fight
GAME( 2017, galaxyfs01,     galaxyfg, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Galaxy Fight (Add Character To Select)", MACHINE_SUPPORTS_SAVE )
 // Far East of Eden
GAME( 2017, kabukikls01,    kabukikl, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Far East of Eden (Add Character To Select)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, kabukikls02,    kabukikl, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Far East of Eden (Boss Hacks)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, kabukikls03,    kabukikl, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Far East of Eden (Enhanced Power V2)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, kabukikls04,    kabukikl, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Far East of Eden (Color Modification V2)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, kabukikls05,    kabukikl, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Far East of Eden (Super Remix Edition 1.0)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, kabukikls06,    kabukikl, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Far East of Eden (Super Remix Edition 1.1)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, kabukikls07,    kabukikl, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Far East of Eden (Super Remix Edition 1.2)", MACHINE_SUPPORTS_SAVE )
  // Karnov's Revenge
GAME( 200?, karnovrs01,	 	karnovr,  neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "yumeji",	   "Karnov's Revenge (Add hidden characters-Enable Bull v2)", MACHINE_SUPPORTS_SAVE )

 // Kizuna Encounter
GAME( 2017, kizunas01,      kizuna,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Kizuna Encounter (Unlimited Power v1)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, kizunas02,      kizuna,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Kizuna Encounter (Unlimited Power v2)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, kizunas03,      kizuna,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Kizuna Encounter (Unlimited Power v3)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, kizunas04,      kizuna,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Kizuna Encounter (Super Kill Unified)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, kizunas05,      kizuna,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Kizuna Encounter (Super Remix Edition 1.0)", MACHINE_SUPPORTS_SAVE )
GAME( 200?, kizunas06, 	 	kizuna,   neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Unknown",    "Kizuna Encounter (Arrange Ver. 1.7)(2014/07/16 )", MACHINE_SUPPORTS_SAVE )
 // Magical Drop III
GAME( 1997, magdrop3s01,   magdrop3, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Magical Drop III (Enable Hidden Characters V1)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, magdrop3s02,   magdrop3, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Magical Drop III (Super Remix Edition 1.0)", MACHINE_SUPPORTS_SAVE )
...
//GAME( 200?, matrims01,      matrim,   neogeo_noslot, neogeo, neogeo_state,         matrima,   ROT0, "Unknown",    "Matrimelee (Super Plus+)(NGM-2660) (NGH-2660)", MACHINE_SUPPORTS_SAVE )
//GAME( 200?, matrims02,      matrim,   neogeo_noslot, neogeo, neogeo_state,         matrima,   ROT0, "Unknown",    "Matrimelee (Description Of Hack Unknown)(NGM-2660) (NGH-2660)", MACHINE_SUPPORTS_SAVE )
GAME( 200?, matrims03,      matrim,   matrim,    neo_ek,    mvs_led_state, empty_init,    ROT0, "HappyAsr[EGCG]",    "Matrimelee (Enable Hidden Menu)(NGM-2660) (NGH-2660)", MACHINE_SUPPORTS_SAVE )
GAME( 200?, matrims04,      matrim,   matrim,    neo_ek,    mvs_led_state, empty_init,    ROT0, "Dodowang[EGCG][EGCG]",    "Matrimelee (Enable Hidden Characters V1)(NGM-2660) (NGH-2660)", MACHINE_SUPPORTS_SAVE )
GAME( 200?, matrims05,      matrim,   matrim,    neo_ek,    mvs_led_state, empty_init,    ROT0, "Creamymami[EGCG]",    "Matrimelee (Maximum Power)(NGM-2660) (NGH-2660)", MACHINE_SUPPORTS_SAVE )
GAME( 200?, matrims06,      matrim,   matrim,    neo_ek,    mvs_led_state, empty_init,    ROT0, "HappyAsr[EGCG]",    "Matrimelee (Power Lv 3)(NGM-2660) (NGH-2660)", MACHINE_SUPPORTS_SAVE )
GAME( 200?, matrims07,      matrim,   matrim,    neo_ek,    mvs_led_state, empty_init,    ROT0, "Unknown",    "Matrimelee (Super Remix Edition 1.0)(NGM-2660) (NGH-2660)", MACHINE_SUPPORTS_SAVE )
  // Money Puzzle Exchanger
GAME( 2017, miexchngs01,    miexchng, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Money Puzzle Exchanger (Translation French)", MACHINE_SUPPORTS_SAVE )
 // Neo Bomberman
GAME( 2017, neobombes01,    neobombe, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Neo Bomberman (Ex Super)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, neobombes02,    neobombe, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Neo Bomberman (Ex Super V2)", MACHINE_SUPPORTS_SAVE )
 // Neo-Geo Cup '98
GAME( 2017, neocup98s01,    neocup98, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Neo-Geo Cup '98 (Translation Korean)", MACHINE_SUPPORTS_SAVE )
 // Ninja Master's
GAME( 2017, ninjamass01,    ninjamas, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Ninja Master's (Enable Hidden Characters V1)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, ninjamass02,    ninjamas, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Ninja Master's (Command Change V1)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, ninjamass03,    ninjamas, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Ninja Master's (Command Change V2)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, ninjamass04,    ninjamas, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Ninja Master's (Super Remix Edition 1.0)", MACHINE_SUPPORTS_SAVE )
GAME( 200?, ninjamass05,	ninjamas, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "007325",	  "Ninja Master's (Command Change V1)(Alt)", MACHINE_SUPPORTS_SAVE )

 // Nightmare in the Dark
GAME( 2000, nitds01,        nitd,     nitd,      neogeo,  mvs_led_state, empty_init,    ROT0, "Hacks",    "Nightmare in the Dark (French Version)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, nitds02,        nitd,     nitd,      neogeo,  mvs_led_state, empty_init,    ROT0, "Hacks",    "Nightmare in the Dark (Translation French V2)" , MACHINE_SUPPORTS_SAVE )
GAME( 200?, nitds03,		nitd,	  cmc42sfix_ek,  neo_ek, mvs_led_state, empty_init, ROT0, "Ti Dragon / Shyma.X",    "Nightmare in the Dark (French Version v?)(decrypted C)" , MACHINE_SUPPORTS_SAVE ) // Version Mame Neth

 // Ragnagard
GAME( 2017, ragnagrds01,    ragnagrd, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Operation Ragnagard (Siu Shenquan Technology Unified Simplified V2)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, ragnagrds02,    ragnagrd, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Operation Ragnagard (Super God Boxing Uniform Simplification)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, ragnagrds03,    ragnagrd, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Operation Ragnagard (Super Remix Edition 1.0)", MACHINE_SUPPORTS_SAVE )
GAME( 200?, ragnagrds04,	ragnagrd, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Unknown",    "Operation Ragnagard (Boss With Simple Attack Edition)", MACHINE_SUPPORTS_SAVE )

 // S1945
GAME( 1999, s1945ps01,      s1945p,   s1945p,    neogeo,  mvs_led_state, empty_init,    ROT0, "Hacks",    "Strikers 1945 Plus (Super Remix Edition 1.0)", MACHINE_SUPPORTS_SAVE )
 // Savage Reign
GAME( 2017, savageres01,    savagere, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Savage Reign (Enable Hidden Characters)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, savageres02,    savagere, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Savage Reign (Unlimited Super Moves)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, savageres03,    savagere, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Savage Reign (Super kill Command System)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, savageres04,    savagere, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks", "Savage Reign (s04)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, savageres05,    savagere, neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Savage Reign (Super Remix Edition 1.0)", MACHINE_SUPPORTS_SAVE )
 // Super Dodge Ball
GAME( 2017, sdodgebs01,     sdodgeb,  neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Super Dodge Ball (Enable Hidden Characters)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, sdodgebs02,     sdodgeb,  neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Super Dodge Ball (s02)", MACHINE_SUPPORTS_SAVE )
GAME( 2018, sdodgebs03,     sdodgeb,  neo_ek, neo_ek, mvs_led_state, empty_init,    ROT0, "Hacks",    "Super Dodge Ball (Super Remix Edition 1.0)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1994, karnovreh, karnovr,  neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Data East Corporation", "Karnov's Revenge - Big Tornado (bull)", MACHINE_SUPPORTS_SAVE)
GAME( 1996, kizunaeh,  kizuna,   neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "SNK", "Kizuna Encounter - hidden characters: Press [START] button to see them, choose with [A] button", MACHINE_SUPPORTS_SAVE)
GAME( 1996, ragnagrdh, ragnagrd, neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Saurus", "Ragnagard / Shin-Oh-Ken (Can choose Lucifer, Eelis and Behemoth)", MACHINE_SUPPORTS_SAVE)

GAME( 2003, pnyaand,    pnyaa,   neobase_ek, 	neo_ek, mvs_led_state,         empty_init, ROT0, "Aiky","Pochi and Nyaa / Pochi tto Nyaa (Fully Decrypted)", MACHINE_SUPPORTS_SAVE)


GAME( 1995, kakleh,    kabukikl, neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Hudson", "Kabuki Klash - (Can choose Manto, Karakuri, Jyashinsai and Lucifeller)", MACHINE_SUPPORTS_SAVE)
GAME( 1995, kabukyc,   kabukikl, neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Hudson", "Kabuki Klash - (Can choose Manto, Karakuri, Jyashinsai and Lucifeller - magic is always max - bases on kakleh)", MACHINE_SUPPORTS_SAVE)
GAME( 1995, kabukc,    kabukikl, neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Hudson", "Kabuki Klash - (Title screen colour change - character color change1)" , MACHINE_SUPPORTS_SAVE)
GAME( 1995, kabukgm,   kabukikl, neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Hudson", "Kabuki Klash - (Title screen colour change - character color change2)", MACHINE_SUPPORTS_SAVE)
GAME( 1995, kabukmc,   kabukikl, neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Hudson", "Kabuki Klash - (Magic always max)", MACHINE_SUPPORTS_SAVE)


GAME( 1995, savagedb,  savagere, neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "SNK", "Savage Reign (Hero)", MACHINE_SUPPORTS_SAVE)
GAME( 1998, shocktr2h, shocktr2, neobase_ek, 	neo_ek, mvs_led_state,  		empty_init, ROT0, "Saurus", "Shock Troopers - 2nd Squad (D+(A or B or C)& Start Button)", MACHINE_SUPPORTS_SAVE)
//GAME( 1999, ganryun,   ganryu,   cmc42sfix_ek, 	neo_ek, mvs_led_state,  		empty_init, ROT0, "Visco", "Musashi Ganryuuki (Decrypted)", MACHINE_SUPPORTS_SAVE)
//GAME( 2000, nitdn,     nitd,     neobase_ek, 	neo_ek, mvs_led_state,  gfxdec42,  ROT0, "Eleven / Gavaking", "Nightmare in the Dark (Decrypted)", MACHINE_SUPPORTS_SAVE)

GAME( 1996, breaksp,   breakers, neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Visco", "Breakers (Move change)", MACHINE_SUPPORTS_SAVE)
//GAME( 1994, fightfek,  fightfev, neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Viccom", "Fight Fever (Kanji Patch)", MACHINE_SUPPORTS_SAVE)
//GAME( 1994, pbobblnb, pbobblen,  neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Taito", "Puzzle Bobble / Bust-A-Move (Neo-Geo) (set 3)", MACHINE_SUPPORTS_SAVE)

GAME( 1996,  njeh,   ninjamas,   neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "ADK / SNK",        "Ninja Master's - haoh-ninpo-cho (Can choose Ranmaru and Nobunaga)", MACHINE_SUPPORTS_SAVE)
GAME( 1996,  njehc,  ninjamas,   neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "ADK / SNK",        "Ninja Master's - haoh-ninpo-cho (Power hack)", MACHINE_SUPPORTS_SAVE)
GAME( 1996,  njehyc, ninjamas,   neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "ADK / SNK",        "Ninja Master's - haoh-ninpo-cho (Can choose Ranmaru and Nobunaga - power hack)", MACHINE_SUPPORTS_SAVE)

GAME( 1992, viewpntr, viewpoin,  neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Sammy", "Viewpoint (Unlimited lives and mega-bombs for p1 and p2)", MACHINE_SUPPORTS_SAVE)
GAME( 1996, ww7bh, wakuwak7,     neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Sunsoft", "Waku Waku 7 (Can choose Fernandez and Bonus Kun - only playable when 2 Player play AES/MVS)", MACHINE_SUPPORTS_SAVE)


//GAME( 1999, s1945pn,  neogeo,   neobase, neogeo, neobase_state,  gfxdec42,  ROT0, "Psikyo", "Strikers 1945 Plus (Fully Decrypted)" , MACHINE_SUPPORTS_SAVE)

//GAME( 2003, mslug5fd,  neogeo,   neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "SNK Playmore", "Metal Slug 5 (Fully decrypted)" , MACHINE_SUPPORTS_SAVE)
