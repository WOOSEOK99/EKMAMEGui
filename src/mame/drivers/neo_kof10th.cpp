...
ROM_START( kf10thud ) 
	...
	ROM_LOAD16_WORD_SWAP( "kf10-p1ud.bin", 0x000000, 0x800000, CRC(aeecc5a3) )

	NEO_SFIX_128K( "kf10n-s1u.bin", CRC(28128a84) )
  ...
  ROM_LOAD16_BYTE( "kf10-c1.bin", 0x0000000, 0x800000, CRC(2491AF91) ) /* Plane 0,1 */ 
  ROM_LOAD16_BYTE( "kf10-c2.bin", 0x0000001, 0x800000, CRC(47FF1D91) ) /* Plane 2,3 */
  ROM_LOAD16_BYTE( "kf10-c3.bin", 0x1000000, 0x800000, CRC(959FAD0B) ) /* Plane 0,1 */
  ROM_LOAD16_BYTE( "kf10-c4.bin", 0x1000001, 0x800000, CRC(EFE6A468) ) /* Plane 2,3 */
  ROM_LOAD16_BYTE( "kf10-c5.bin", 0x2000000, 0x800000, CRC(74BBA7C6) ) /* Plane 0,1 */
  ROM_LOAD16_BYTE( "kf10-c6.bin", 0x2000001, 0x800000, CRC(E20D2216) ) /* Plane 2,3 */
  ROM_LOAD16_BYTE( "kf10-c7.bin", 0x3000000, 0x800000, CRC(8A5B561C) ) /* Plane 0,1 */
  ROM_LOAD16_BYTE( "kf10-c8.bin", 0x3000001, 0x800000, CRC(BEF667A3) ) /* Plane 2,3 */
ROM_END

ROM_START( kf10thuda ) 
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT ) 
	ROM_LOAD16_WORD_SWAP( "kf10a-p1ud.bin", 0x000000, 0x800000, CRC(ACBE077A) )
...
GAME( 2004, kf10thud, 		neogeo,  neobase_ek,neo_ek, mvs_led_state, empty_init, ROT0, "Hack", "The King of Fighters 10th Anniversary Unique - All Team Battle (Fully Decrypted)" ,MACHINE_SUPPORTS_SAVE)
GAME( 2004, kf10thuda,		kf10thud,neobase_ek,neo_ek, mvs_led_state, empty_init, ROT0, "Hack", "The King of Fighters 10th Anniversary Unique - All Team Battle (Fully Decrypted - Always Power Maximum)" ,MACHINE_SUPPORTS_SAVE)

GAME( 2004, kof2k4mp,   kof2k4se, kof2k4se,  	neo_ek, mvs_led_state, empty_init,  ROT0, "hack", "Kof Special Edition 2004 Magic Plus (The King of Fighters 2002 bootleg)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, kof2k4mp2,  kof2k4se, kof2k4se,  	neo_ek, mvs_led_state, empty_init,  ROT0, "hack", "Kof Special Edition 2004 Magic Plus 2 (The King of Fighters 2002 bootleg)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, kof2k4omg,  kof2k4se, neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "KofOnTeam", "Kof Special Edition 2004 (Omega v0.5)", MACHINE_SUPPORTS_SAVE )
// GAME( 2004, kof2k4pls,  kof2k4se, neogeo_noslot,    neogeo, neogeo_state,  kof2k4pls, ROT0, "bootleg", "Kof Special Edition 2004 Plus (Set 1)(The King of Fighters 2002 bootleg)", MACHINE_SUPPORTS_SAVE )
GAME( 2010, kof2k4ru,   kof2k4se, neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "MVS Hacks PSP", "Kof Special Edition 2004 (Remix Ultra v2.6F)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, kof2k4se1,  kof2k4se, kof2k4se, 	 neo_ek, mvs_led_state, empty_init,  ROT0, "hack", "Kof Special Edition 2004 (Bootleg)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, kof2k4seb,  kof2k4se, neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "Dragon Co.", "Kof Special Edition 2004 (Translation portuguese)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, kof2k4spl,  kof2k4se, kof2k4se,  	neo_ek, mvs_led_state, empty_init,  ROT0, "bootleg", "Kof Special Edition 2004 Plus (Set 2)(The King of Fighters 2002 bootleg)", MACHINE_SUPPORTS_SAVE )
GAME( 2008, kof2k8uni,  kof2002,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Kof 10th Anniversary 2008 Unique (The King of Fighters 2002 bootleg)", MACHINE_SUPPORTS_SAVE )
GAME( 2005, kof10thbr,  kof2002,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "Neogeo BR Team", "Kof 10th Anniversary (Translation Brazil)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
GAME( 2005, kof10thd,   kof2002,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Kof 10th Anniversary (The King of Fighters 2002 bootleg / Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
// GAME( 2005, kof10thd16, kof2002,  neogeo_noslot,     neogeo, neogeo_state,  kof10thu,  ROT0, "hack", "Kof 10th Anniversary Unique (Simplify Edition)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
// GAME( 2015, kof10thep15,kof2002,  neogeo_noslot,     neogeo, neogeo_state,  kf10thep,  ROT0, "hack", "Kof 10th Anniversary Extra Plus (Simplify Edition)", MACHINE_SUPPORTS_SAVE )
// GAME( 2005, kof10thu,   kof2002,  neogeo_noslot,     neogeo, neogeo_state,  kof10thu,  ROT0, "hack", "Kof 10th Anniversary Unique (bootleg, set 1)", MACHINE_SUPPORTS_SAVE )
GAME( 2005, kof10thub,  kof2002,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Kof 10th Anniversary Unique (Translation portuguese edition)", MACHINE_SUPPORTS_SAVE )
GAME( 2005, kof10thud,  kof2002,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Kof 10th Anniversary Unique (The King of Fighters 2002 bootleg)(decrypted)", MACHINE_SUPPORTS_SAVE )
// GAME( 1997, kogd,       kof97,    hbmame_kog,        neogeo, neogeo_state,  kogd,      ROT0, "hack", "King of Gladiator (The King of Fighters '97 bootleg)(fully decrypted)", MACHINE_SUPPORTS_SAVE )
// GAME( 1997, kogf,       kof97,    neogeo_kog,        neogeo, neogeo_state,  kog,       ROT0, "Zxbdragon / Ryu", "King of Gladiator (Remove the mark of the screen)(Fix v3)", MACHINE_SUPPORTS_SAVE )
// GAME( 1997, koggv,      kof97,    neogeo_kog,        neogeo, neogeo_state,  kog,       ROT0, "hack", "King of Gladiator (Green Fire edition)", MACHINE_SUPPORTS_SAVE )
// GAME( 1997, kogmxpls,   kof97,    hbmame_kog,        neogeo, neogeo_state,  kogd,      ROT0, "hack", "King of Gladiator mix Plus-EX (The King of Fighters '97 bootleg)", MACHINE_SUPPORTS_SAVE )
// GAME( 1997, kogplus,    kof97,    neogeo_kog,        neogeo, neogeo_state,  kog,       ROT0, "bootleg", "King of Gladiator Plus (set 1)", MACHINE_SUPPORTS_SAVE )
// GAME( 1997, kogplus1,   kof97,    hbmame_kog,        neogeo, neogeo_state,  kogd,      ROT0, "bootleg", "King of Gladiator Plus (set 2)", MACHINE_SUPPORTS_SAVE )
// GAME( 1997, kogplusf,   kof97,    hbmame_kog,        neogeo, neogeo_state,  kogd,      ROT0, "Zxbdragon / Ryu", "King of Gladiator Plus (Fixed Edition)", MACHINE_SUPPORTS_SAVE )
// GAME( 1997, kogsm,      kof97,    neogeo_kog,        neogeo, neogeo_state,  kog,       ROT0, "KalceTin", "King of Gladiator (Smoke Version v1.5 Fix)", MACHINE_SUPPORTS_SAVE )
...
ROM_START( kof2k4ses30 )
	...
	ROM_REGION( 0x4000400, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "365.c1", 0x0000000, 0x800000, CRC(7a050288) SHA1(55a20c5b01e11a859f096af3f8e09986025d288f) )
	ROM_LOAD16_BYTE( "365.c2", 0x0000001, 0x800000, CRC(e924afcf) SHA1(651e974f7339d2cdcfa58c5398013197a0525b77) )
	ROM_LOAD16_BYTE( "265d.c3", 0x1000000, 0x800000, CRC(959fad0b) SHA1(63AB83DDC5F688DC8165A7FF8D262DF3FCD942A2) )
...
// 10th Anniversary
GAME(2005, kf10theps01,    kof2002,  kf10thep, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Creamymami[EGCG]",    "Kof 10th Anniversary Extra Plus (Unlimited Power Store)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf10theps02,    kof2002,  kf10thep, 	neo_ek, mvs_led_state, empty_init,  ROT0, "kumagorou",    "Kof 10th Anniversary Extra Plus (Green Fire)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf10theps03,    kof2002,  kf10thep, 	neo_ek, mvs_led_state, empty_init,  ROT0, "kawada7278",    "Kof 10th Anniversary Extra Plus (Violet Fire)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf10theps04,    kof2002,  kf10thep, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Kim",    "Kof 10th Anniversary Extra Plus (Icy Blue Style)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf10theps05,    kof2002,  kf10thep, 	neo_ek, mvs_led_state, empty_init,  ROT0, "oak2003",    "Kof 10th Anniversary Extra Plus (Fix s1's 3 Errors)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf10theps06,    kof2002,  kf10thep, 	neo_ek, mvs_led_state, empty_init,  ROT0, "oak2003",    "Kof 10th Anniversary Extra Plus (Turn Life Bar Into Half Transparency)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf10theps07,    kof2002,  kf10thep, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Kim",    "Kof 10th Anniversary Extra Plus (Change Color In Battle)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf10theps08,    kof2002,  kf10thep, 	neo_ek, mvs_led_state, empty_init,  ROT0, "kof1996",    "Kof 10th Anniversary Extra Plus (Remove Countdown)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf10theps09,    kof2002,  kf10thep, 	neo_ek, mvs_led_state, empty_init,  ROT0, "wesker[FGCH]",    "Kof 10th Anniversary Extra Plus (Practice Mode Maximum Power)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf10theps10,    kof2002,  kf10thep, 	neo_ek, mvs_led_state, empty_init,  ROT0, "oak2003",    "Kof 10th Anniversary Extra Plus (Turn Time-Bg Into Half Transparency V1)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf10theps11,    kof2002,  kf10thep, 	neo_ek, mvs_led_state, empty_init,  ROT0, "oak2003",    "Kof 10th Anniversary Extra Plus (Turn Time-Bg Into Half Transparency V2)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf10theps12,    kof2002,  kf10thep, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Eddids[FGCH]",    "Kof 10th Anniversary Extra Plus (Unlimited Credits in Console Mode)", MACHINE_SUPPORTS_SAVE )
GAME(2005, kof10ths01,     kof2002,  kof10th, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Creamymami[EGCG]",    "Kof 10th Anniversary (Enhanced Power)", MACHINE_SUPPORTS_SAVE )
GAME(2005, kof10ths02,     kof2002,  kof10th, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Creamymami[EGCG]",    "Kof 10th Anniversary (Unlimited Power Store)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kof10ths03,     kof2002,  kof10th, 	neo_ek, mvs_led_state, empty_init,   ROT0, "kumagorou",    "Kof 10th Anniversary (Green Fire)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kof10ths04,     kof2002,  kof10th, 	neo_ek, mvs_led_state, empty_init,   ROT0, "kawada7278",    "Kof 10th Anniversary (Violet Fire)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kof10ths05,     kof2002,  kof10th, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Kim",    "Kof 10th Anniversary (Icy Blue Style)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kof10ths06,     kof2002,  kof10th, 	neo_ek, mvs_led_state, empty_init,   ROT0, "snk2003",    "Kof 10th Anniversary (Fix Sound Effects)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kof10ths07,     kof2002,  kof10th, 	neo_ek, mvs_led_state, empty_init,   ROT0, "oak2003",    "Kof 10th Anniversary (Fix s1's 3 errors)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kof10ths08,     kof2002,  kof10th, 	neo_ek, mvs_led_state, empty_init,   ROT0, "oak2003",    "Kof 10th Anniversary (Turn Life Bar Into Half Transparency)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kof10ths09,     kof2002,  kof10th, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Kim",    "Kof 10th Anniversary (Change Color In Battle)", MACHINE_SUPPORTS_SAVE )
GAME(2005, kof10ths10,     kof2002,  kof10th, 	neo_ek, mvs_led_state, empty_init,   ROT0, "siromezm",    "Kof 10th Anniversary (Change Size)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kof10ths11,     kof2002,  kof10th, 	neo_ek, mvs_led_state, empty_init,   ROT0, "wesker[FGCH]",    "Kof 10th Anniversary (Practice Mode Maximum Power)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kof10ths12,     kof2002,  kof10th, 	neo_ek, mvs_led_state, empty_init,   ROT0, "oak2003",    "Kof 10th Anniversary (Turn Time bg Into Half Transparency V1)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kof10ths13,     kof2002,  kof10th, 	neo_ek, mvs_led_state, empty_init,   ROT0, "oak2003",    "Kof 10th Anniversary (Turn Time bg Into Half Transparency V2)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kof10ths14,     kof2002,  kof10th, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Eddids[FGCH]",    "Kof 10th Anniversary (Unlimited Credits In Console Mode)", MACHINE_SUPPORTS_SAVE )
// Kof 10th Anniversary 2005 Unique
GAME(2005, kf2k5unis01,    kof2002,  kf2k5uni, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Creamymami[EGCG]",    "Kof 10th Anniversary 2005 Unique (Unlimited Power Store)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf2k5unis02,    kof2002,  kf2k5uni, 	neo_ek, mvs_led_state, empty_init,  ROT0, "kumagorou",    "Kof 10th Anniversary 2005 Unique (Green Fire)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf2k5unis03,    kof2002,  kf2k5uni, 	neo_ek, mvs_led_state, empty_init,  ROT0, "kawada7278",    "Kof 10th Anniversary 2005 Unique (Violet Fire)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf2k5unis04,    kof2002,  kf2k5uni, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Kim",    "Kof 10th Anniversary 2005 Unique (Icy Blue Style)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf2k5unis05,    kof2002,  kf2k5uni, 	neo_ek, mvs_led_state, empty_init,  ROT0, "oak2003",    "Kof 10th Anniversary 2005 Unique (Fix s1's 3 Errors)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf2k5unis06,    kof2002,  kf2k5uni, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Kim",    "Kof 10th Anniversary 2005 Unique (Change Color In Battle)", MACHINE_SUPPORTS_SAVE )
GAME(2005, kf2k5unis07,    kof2002,  kf2k5uni, 	neo_ek, mvs_led_state, empty_init,  ROT0, "kof1996",    "Kof 10th Anniversary 2005 Unique (Remove Countdown)", MACHINE_SUPPORTS_SAVE )
GAME(2005, kf2k5unis08,    kof2002,  kf2k5uni, 	neo_ek, mvs_led_state, empty_init,  ROT0, "wesker[FGCH]",    "Kof 10th Anniversary 2005 Unique (Practice Mode Maximum Power)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf2k5unis09,    kof2002,  kf2k5uni, 	neo_ek, mvs_led_state, empty_init,  ROT0, "oak2003",    "Kof 10th Anniversary 2005 Unique (Turn Time Bg Into Half Transparency V1)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf2k5unis10,    kof2002,  kf2k5uni, 	neo_ek, mvs_led_state, empty_init,  ROT0, "oak2003",    "Kof 10th Anniversary 2005 Unique (Turn Time Bg Into Half Transparency V2)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf2k5unis11,    kof2002,  kf2k5uni, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Eddids[FGCH]",    "Kof 10th Anniversary 2005 Unique (Unlimited Credits In Console Mode)", MACHINE_SUPPORTS_SAVE )
// GAME(2005, kf2k5unis12,    kof2002,  kf2k5uni, 	neo_ek, mvs_led_state, empty_init,  ROT0, "oak2003",    "Kof 10th Anniversary 2005 Unique (Turn Life-Bar Into Half-Transparency)", MACHINE_SUPPORTS_SAVE )
GAME(2019, kf2k5unis13,    kof2002,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Kof 10th Anniversary 2005 Unique (Edition Optimized 2019 2019-05-23)", MACHINE_SUPPORTS_SAVE )
GAME(2019, kf2k5unis14,    kof2002,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Kof 10th Anniversary 2005 Unique (Optimized Version 2019 2019-06-05)", MACHINE_SUPPORTS_SAVE )
// GAME(2020, kf2k5unis15,    kof2002,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Kof 10th Anniversary 2005 Unique (Alpha Unique 2020-01-23)", MACHINE_SUPPORTS_SAVE )
GAME(2020, kf2k5unis16,    kof2002,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Kof 10th Anniversary 2005 Unique (Alpha Unique New 2020-01-24)", MACHINE_SUPPORTS_SAVE )
GAME(2020, kf2k5unis17,    kof2002,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Kof 10th Anniversary 2005 Unique (Optimization 2019 Simplified Edition 2020-02-05)", MACHINE_SUPPORTS_SAVE )
GAME(2020, kf2k5unis18,    kof2002,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Kof 10th Anniversary 2005 Unique (Omega Edition Simplified 2020-02-27)", MACHINE_SUPPORTS_SAVE )
// Kof Special Edition 2004
// GAME(2004, kof2k4ses01,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "KyoX",    "Kof Special Edition 2004 (Translation Portuguese)(Alt)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4ses04,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "wesker[FGCH]",    "Kof Special Edition 2004 (Unluck Max2 V1)", MACHINE_SUPPORTS_SAVE )
GAME(2004, kof2k4ses05,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Creamymami[EGCG]",    "Kof Special Edition 2004 (Unluck Max2 V2)", MACHINE_SUPPORTS_SAVE )
GAME(2004, kof2k4ses06,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "kof1996",    "Kof Special Edition 2004 (Hidden Characters Add Portraits)", MACHINE_SUPPORTS_SAVE )
GAME(2004, kof2k4ses07,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Creamymami[EGCG]",    "Kof Special Edition 2004 (Enhanced Power)", MACHINE_SUPPORTS_SAVE )
GAME(2004, kof2k4ses08,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Creamymami[EGCG]",    "Kof Special Edition 2004 (Unlimited Power)", MACHINE_SUPPORTS_SAVE )
GAME(2004, kof2k4ses09,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Creamymami[EGCG]",    "Kof Special Edition 2004 (Unlimited Power Store)", MACHINE_SUPPORTS_SAVE )
// GAME(2006, kof2k4ses10,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "tcwlee[EGCG]",    "Kof Special Edition 2004 (Color Change)(2006-02-02)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4ses11,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "kumagorou",    "Kof Special Edition 2004 (Green Fire)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4ses12,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "kawada7278",    "Kof Special Edition 2004 (Violet Fire)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4ses13,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Kim",    "Kof Special Edition 2004 (Icy Blue Style)", MACHINE_SUPPORTS_SAVE )
GAME(2004, kof2k4ses14,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "0 DAY-S[EGCG]",    "Kof Special Edition 2004 (Add Boss Kusanagi)", MACHINE_SUPPORTS_SAVE )
GAME(2004, kof2k4ses15,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Foxy[PHT]",    "Kof Special Edition 2004 (Add NESTS Team)", MACHINE_SUPPORTS_SAVE )
GAME(2004, kof2k4ses16,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "TSUNG823",    "Kof Special Edition 2004 (No Erotic Picture)", MACHINE_SUPPORTS_SAVE )
GAME(2004, kof2k4ses17,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "bootleg",    "Kof Special Edition 2004 (Enable random CPU color)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4ses18,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Kim",    "Kof Special Edition 2004 (Change Color In Battle(The King of Fighters 2002 bootleg)", MACHINE_SUPPORTS_SAVE )
GAME(2004, kof2k4ses19,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "siromezm",    "Kof Special Edition 2004 (Change Member)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4ses20,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "oak2003",    "Kof Special Edition 2004 (Half Transparency Timer)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4ses21,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "oak2003",    "Kof Special Edition 2004 (Fix Timer)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4ses22,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "oak2003",    "Kof Special Edition 2004 (Half Transparency Timer V1)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4ses23,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "oak2003",    "Kof Special Edition 2004 (Half Transparency Timer V2)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4ses24,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "oak2003",    "Kof Special Edition 2004 (Half Transparency Timer V3)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4ses25,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "oak2003",    "Kof Special Edition 2004 (Fixed Power Gauge)", MACHINE_SUPPORTS_SAVE )
GAME(2004, kof2k4ses26,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Creamymami[EGCG]",    "Kof Special Edition 2004 (Kyo + Kusanagi)", MACHINE_SUPPORTS_SAVE )
GAME(2004, kof2k4ses27,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "kof1996",    "Kof Special Edition 2004 (Remove Countdown)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4ses28,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "wesker[FGCH]",    "Kof Special Edition 2004 (Practice Mode Maximum Power)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4ses29,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Eddids[FGCH]",    "Kof Special Edition 2004 (Unlimited Credits In Console Mode)", MACHINE_SUPPORTS_SAVE )
GAME(2004, kof2k4ses30,    kof2k4se, neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack",    "Kof Special Edition 2004 (Omega v1.0 2011-12-13)", MACHINE_SUPPORTS_SAVE )
GAME(2004, kof2k4ses31,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "hack", "Kof Special Edition 2004 Magic Plus (Add Boss Hack )", MACHINE_SUPPORTS_SAVE )
GAME(2018, kof2k4ses32,    kof2k4se, kof2k4se, 	neo_ek, mvs_led_state, empty_init,  ROT0, "hack", "Kof Special Edition 2004 Magic Plus (Crazy Edition 2018-10-26)", MACHINE_SUPPORTS_SAVE )
GAME(2020, kof2k4ses33,    kof2k4se, neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Kof Special Edition 2004 (Omega v1.0 2020-01-03)", MACHINE_SUPPORTS_SAVE )
// GAME(2020, kof2k4ses34,    kof2k4se, neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Kof Special Edition 2004 (Resurgence Plus Enhanced 2020-01-23)", MACHINE_SUPPORTS_SAVE )
GAME(2020, kof2k4ses35,    kof2k4se, neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Kof Special Edition 2004 (Resurgence Plus Enhanced New 2020-01-24)", MACHINE_SUPPORTS_SAVE )
GAME(2020, kof2k4ses36,    kof2k4se, neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Kof Special Edition 2004 (Plus 2020-03-02)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss01,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "KyoX",    "Kof Special Edition 2004 Plus (Translation Portuguese)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss02,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "wesker[FGCH]",    "Kof Special Edition 2004 Plus (Unluck Max2 v1)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss03,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "Creamymami[EGCG]",    "Kof Special Edition 2004 Plus (Unlimited Power)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss04,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "Creamymami[EGCG]",    "Kof Special Edition 2004 Plus (Unlimited Power Store)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss06,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "Foxy[PHT]",    "Kof Special Edition 2004 Plus (Combine Kula, K9999 And Angel Into One Team)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss07,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "TSUNG823",    "Kof Special Edition 2004 Plus (Remove Erotic Picture In Background)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss08,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "bootleg",    "Kof Special Edition 2004 Plus (Enable Random Color For CPU Team)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss09,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "Kim",    "Kof Special Edition 2004 Plus (Change Color In Battle)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss10,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "siromezm",    "Kof Special Edition 2004 Plus (Change Member)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss11,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "oak2003",    "Kof Special Edition 2004 Plus (Half Transparency Timer)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss12,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "oak2003",    "Kof Special Edition 2004 Plus (Fix Timer)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss13,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "oak2003",    "Kof Special Edition 2004 Plus (Half Transparency Timer v1)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss14,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "oak2003",    "Kof Special Edition 2004 Plus (Half Transparency Timer v2)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss15,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "oak2003",    "Kof Special Edition 2004 Plus (Half Transparency Timer v3)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss16,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "oak2003",    "Kof Special Edition 2004 Plus (Fixed Power Gauge)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss17,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "Creamymami[EGCG]",    "Kof Special Edition 2004 Plus (Kyo + Kusanagi)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss18,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "kof1996",    "Kof Special Edition 2004 Plus (Remove Countdown)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss19,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "wesker[FGCH]",    "Kof Special Edition 2004 Plus (Practice Mode Maximum Power)", MACHINE_SUPPORTS_SAVE )
// GAME(2004, kof2k4plss20,   kof2k4se, kof2k4pls, 	neo_ek, mvs_led_state, empty_init, ROT0, "Eddids[FGCH]",    "Kof Special Edition 2004 Plus (Unlimited Credits In Console Mode)", MACHINE_SUPPORTS_SAVE )
