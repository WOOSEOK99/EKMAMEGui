...
static INPUT_PORTS_START( pow )
	...
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_NAME("@P1 @Button1 펀치") PORT_CONDITION("P1", 0x70, NOTEQUALS, 0x10)
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_NAME("@P1 @Button2 점프") PORT_CONDITION("P1", 0x70, NOTEQUALS, 0x20)
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_NAME("@P1 @Button3 킥")   PORT_CONDITION("P1", 0x70, NOTEQUALS, 0x40)
	PORT_BIT( 0x10+0x20, IP_ACTIVE_LOW, IPT_BUTTON4 ) PORT_NAME("@P1 @Button1@Button2 백 펀치") PORT_CONDITION("P1", 0x70, NOTEQUALS, 0x30)
	PORT_BIT( 0x10+0x40, IP_ACTIVE_LOW, IPT_BUTTON5 ) PORT_NAME("@P1 @Button1@Button3 박치기")  PORT_CONDITION("P1", 0x70, NOTEQUALS, 0x50)
	PORT_BIT( 0x20+0x40, IP_ACTIVE_LOW, IPT_BUTTON6 ) PORT_NAME("@P1 @Button2@Button3 점프 킥") PORT_CONDITION("P1", 0x70, EQUALS, 0x60)
	...
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_PLAYER(2) PORT_NAME("@P2 @Button1 펀치") PORT_CONDITION("P2", 0x70, NOTEQUALS, 0x10)
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_PLAYER(2) PORT_NAME("@P2 @Button2 점프") PORT_CONDITION("P2", 0x70, NOTEQUALS, 0x20)
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_PLAYER(2) PORT_NAME("@P2 @Button3 킥")   PORT_CONDITION("P2", 0x70, NOTEQUALS, 0x40)
	PORT_BIT( 0x10+0x20, IP_ACTIVE_LOW, IPT_BUTTON4 ) PORT_PLAYER(2) PORT_NAME("@P2 @Button1@Button2 백 펀치") PORT_CONDITION("P2", 0x70, NOTEQUALS, 0x30)
	PORT_BIT( 0x10+0x40, IP_ACTIVE_LOW, IPT_BUTTON5 ) PORT_PLAYER(2) PORT_NAME("@P2 @Button1@Button3 박치기")  PORT_CONDITION("P2", 0x70, NOTEQUALS, 0x50)
	PORT_BIT( 0x20+0x40, IP_ACTIVE_LOW, IPT_BUTTON6 ) PORT_PLAYER(2) PORT_NAME("@P2 @Button2@Button3 점프 킥") PORT_CONDITION("P2", 0x70, EQUALS, 0x60)
