...
GAME( 2003, smsho5nd,   samsho5, neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V (Fully Decrypted)" , MACHINE_SUPPORTS_SAVE)
GAME( 2003, samsho5e,   samsho5, neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V (Hero & Max Power)" , MACHINE_SUPPORTS_SAVE)  
GAME( 2003, samsho5e2,  samsho5, neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V (Hero 2nd & Max Power)" , MACHINE_SUPPORTS_SAVE)  
GAME( 2003, samsho5sh,  samsho5, neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V (MAX POWER)" , MACHINE_SUPPORTS_SAVE)  
GAME( 2003, samsho5cbh, samsho5, neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V (Hero AES)", MACHINE_SUPPORTS_SAVE)
GAME( 2003, samsho5aa,  samsho5, neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V (All Characters)", MACHINE_SUPPORTS_SAVE)
GAME( 2003, samsho5c,   samsho5, neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V (Color-Change)", MACHINE_SUPPORTS_SAVE)
GAME( 2003, samsho5fz,  samsho5, neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V (Color-Change& All Characters)" , MACHINE_SUPPORTS_SAVE)
GAME( 2003, samsho5bo,  samsho5, neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V (Can select Sankuro, Gaoh and Yumeji)" , MACHINE_SUPPORTS_SAVE)
GAME( 2003, samsho5bd,  samsho5, neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V (AES mode 'Option' menue colour change - can select Sankuro, Gaoh, Yumeji and Poppy)" , MACHINE_SUPPORTS_SAVE)
GAME( 2003, samsho5bh,  samsho5, neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V (AES mode 'Option' menue colour change - can select Sankuro, Gaoh, Yumeji and Poppy - have icons in character select menue - GFX fix for Options menue in AES mode)", MACHINE_SUPPORTS_SAVE)
GAME( 2003, samsho5cf,  samsho5, neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V (GFX fix for Options menue in AES mode)", MACHINE_SUPPORTS_SAVE)
GAME( 2003, samsho5jc,  samsho5, neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V (Character colour change1)", MACHINE_SUPPORTS_SAVE)
GAME( 2003, samsho5jl,  samsho5, neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V (Character colour change2)" , MACHINE_SUPPORTS_SAVE)
GAME( 2003, samsho5wh,  samsho5, neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V (ABC power revision - hideaway essential factor activation)", MACHINE_SUPPORTS_SAVE)
...
GAME( 2003, samsh5sd,  samsh5sp,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V Special (Fully Decrypted set1)" , MACHINE_SUPPORTS_SAVE)
GAME( 2003, samsh5spn, samsh5sp,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V Special (MVS protection removed - fatalities unlocked - move fix by Wesker)" , MACHINE_SUPPORTS_SAVE)
GAME( 2003, samsh5spc, samsh5sp,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V Special (Gauge color patch as Samsho5)" , MACHINE_SUPPORTS_SAVE)
GAME( 2003, samsh5spu, samsh5sp,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V Special (Unlock Fatality)" , MACHINE_SUPPORTS_SAVE)
GAME( 2003, samsh5sphd,samsh5sp,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V Special (the secrets of death - need not explotion of rage gauge)", MACHINE_SUPPORTS_SAVE)
GAME( 2003, ss5sphc,   samsh5sp,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V Special (MVS protection removed)" , MACHINE_SUPPORTS_SAVE)
GAME( 2003, ss50sp,    samsh5sp,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Samurai Shodown V Special (Fix 'WIN' sound & Unlock Fatality & Fix Cheat Bug & MVS protection removed)", MACHINE_SUPPORTS_SAVE)
