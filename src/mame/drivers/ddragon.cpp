...
static INPUT_PORTS_START( ddragon )
	...
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_NAME("@P1 @Button1 킥") PORT_CONDITION("P1", 0x30, NOTEQUALS, 0x10)
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_NAME("@P1 @Button2 점프") PORT_CONDITION("P1", 0x30, NOTEQUALS, 0x20)
	PORT_BIT( 0x30, IP_ACTIVE_LOW, IPT_BUTTON4 ) PORT_NAME("@P1 @Button1@Button2 뒤돌려차기") PORT_CONDITION("P1", 0x30, EQUALS, 0x30)
	...
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_PLAYER(2) PORT_NAME("@P2 @Button1 킥") PORT_CONDITION("P2", 0x30, NOTEQUALS, 0x10)
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_PLAYER(2) PORT_NAME("@P2 @Button2 점프") PORT_CONDITION("P2", 0x30, NOTEQUALS, 0x20)
	PORT_BIT( 0x30, IP_ACTIVE_LOW, IPT_BUTTON4 ) PORT_PLAYER(2) PORT_NAME("@P1 @Button1@Button2 뒤돌려차기") PORT_CONDITION("P2", 0x30, EQUALS, 0x30)
	...
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_NAME("@P1 @Button3 펀치") PORT_CONDITION("EXTRA", 0x22, NOTEQUALS, 0x02)
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_PLAYER(2) PORT_NAME("@P2 @Button3 펀치") PORT_CONDITION("EXTRA", 0x24, NOTEQUALS, 0x02)
