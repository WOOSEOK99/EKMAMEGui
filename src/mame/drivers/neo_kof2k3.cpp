...
ROM_START( kof2k3 )
	...
	ROM_LOAD16_WORD_SWAP( "kof2k3-p1.bin", 0x000000, 0x700000, CRC(7ada383c) )

//	ROM_REGION( 0x80000, "fixed", 0 )
//	ROM_LOAD( "kof2k3-s1.bin",0x000000, 0x80000, CRC(3b658d26) )
//	ROM_REGION( 0x20000, "fixedbios", 0 )
//	ROM_LOAD( "sfix.sfx",  0x000000, 0x20000, CRC(c2ea0cfd) SHA1(fd4a618cdcdbf849374f0a50dd8efe9dbab706c3) )

	NEO_SFIX_512K( "kof2k3-s1.bin", CRC(3b658d26 ))
	NEO_BIOS_AUDIO_128K( "271-m1.bin", CRC(396e17cd) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "271-v1.bin", 0x000000, 0x400000, CRC(d2b8aa5e) )
	ROM_LOAD( "271-v2.bin", 0x400000, 0x400000, CRC(71956ee2) )
	ROM_LOAD( "271-v3.bin", 0x800000, 0x400000, CRC(ddbbb199) )
	ROM_LOAD( "271-v4.bin", 0xc00000, 0x400000, CRC(01b90c4f) )

	

	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "271-c1.bin", 0x0000000, 0x800000, CRC(e42fc226) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "271-c2.bin", 0x0000001, 0x800000, CRC(1b5e3b58) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "271-c3.bin", 0x1000000, 0x800000, CRC(d334fdd9) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "271-c4.bin", 0x1000001, 0x800000, CRC(0d457699) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "271-c5.bin", 0x2000000, 0x800000, CRC(8a91aae4) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "271-c6.bin", 0x2000001, 0x800000, CRC(9f8674b8) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "271-c7.bin", 0x3000000, 0x800000, CRC(374ea523) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "271-c8.bin", 0x3000001, 0x800000, CRC(75211f4d) ) /* Plane 2,3 */
ROM_END

ROM_START( kof2003p )
	ROM_REGION( 0x700000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "271-p1p.bin", 0x000000, 0x700000, CRC(b305c6df) )

//	ROM_REGION( 0x80000, "fixed", 0 )
//	ROM_LOAD( "271-s1p.bin",0x000000, 0x80000, CRC(88f1ce13) )
//	ROM_REGION( 0x20000, "fixedbios", 0 )
//	ROM_LOAD( "sfix.sfx",  0x000000, 0x20000, CRC(354029fc) )

	NEO_SFIX_512K( "271-s1p.bin", CRC(88f1ce13 ))
...
ROM_START( kf2k3pls )
	ROM_REGION( 0x700000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "271pls-p1.bin", 0x000000, 0x700000, CRC(488da1ea) )

//	ROM_REGION( 0x80000, "fixed", 0 )
//	ROM_LOAD( "271pls-s1.bin",0x000000, 0x80000, CRC(0a47b8d1) )
//	ROM_REGION( 0x20000, "fixedbios", 0 )
//	ROM_LOAD( "sfix.sfx",  0x000000, 0x20000, CRC(354029fc) )
	
	NEO_SFIX_512K( "271pls-s1.bin", CRC(0a47b8d1 ))
	NEO_BIOS_AUDIO_128K( "271-m1.bin", CRC(396e17cd) )
...
ROM_START( kof2k3upd )
	ROM_REGION( 0x700000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "271d-p1up.bin", 0x000000, 0x100000, CRC(7397d4b7) )
	ROM_LOAD16_WORD_SWAP( "271d-p2up.bin", 0x100000, 0x600000, CRC(264744e2) )
  
//	NEO_SFIX_128K( "271d-s1up.bin", CRC(eb232b3a) )
  	NEO_SFIX_512K( "271d-s1upd.bin", CRC(4791dc0c) )
...
ROM_START( kof2k3evod )
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "kof2k3evo-p1.bin", 0x000000, 0x800000, CRC(e801c503) )

  	NEO_SFIX_128K( "kof2k3evo-s1.bin", CRC(d05be6db) )
...
ROM_START( kof2k3ryud )
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "kof2k3ryu-p1.bin", 0x000000, 0x800000, CRC(0e82da28) )
...
GAME( 2003, kof2k3,   neogeo,   neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Playmore Corporation", "The King of Fighters 2003 (Fully Decrypted)", MACHINE_SUPPORTS_SAVE) 
GAME( 2003, kof2003p, kof2k3,   neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Playmore Corporation", "The King of Fighters 2003 Plus" , MACHINE_SUPPORTS_SAVE)
GAME( 2003, kf2k3pls, kof2k3,   neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Playmore Corporation", "The King of Fighters 2004 EX Hero (Bootleg)" , MACHINE_SUPPORTS_SAVE)
GAME( 2003, kof2k3upd,kof2k3,   neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Playmore Corporation", "The King of Fighters 2003 Ultra Plus (Fully Decrypted)" , MACHINE_SUPPORTS_SAVE)
GAME( 2003, kof2k3evod,kof2k3,   neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Playmore Corporation", "The King of Fighters 2003 Ultra Plus (Evolution Version 1.2)" , MACHINE_SUPPORTS_SAVE)
GAME( 2003, kof2k3ryud,kof2k3,   neobase_ek, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Playmore Corporation", "The King of Fighters 2003 Ultra Plus (Dragon)", MACHINE_SUPPORTS_SAVE)
...
GAME( 2003, kof2003d,   kof2003,  kof2003, 		neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Kof2003 (Decrypted P&C)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003f,   kof2003,  neobase_ek, 	neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Kof2003 Original (Fully Decrypted - Fixed)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2003rebh,kof2003,  no_watchdog,   neogeo, neogeo_state, neogeo,    ROT0, "hack", "Kof2003 (Decryption, Simplified simplification)", MACHINE_SUPPORTS_SAVE )
...
// GAME( 2003, kof2k3bl2,  kof2003,  neogeo_noslot, neogeo, neogeo_state, kof2003b,  ROT0, "hack", "Kof2003 (Boss hack)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2k3br,   kof2003,  kof2003, 		neo_ek, mvs_led_state, empty_init, ROT0, "Neogeo BR team", "Kof2003 (Portuguese Brazilian)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2003, kof2k3d,    kof2003,  kof2003, 		neo_ek, mvs_led_state, empty_init, ROT0, "hack", "Kof2003 (Decrypted C)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2k3evo,  kof2003,  no_watchdog,   neogeo, neogeo_state, neogeo,    ROT0, "hack", "Kof2003 (Evolution 1.4)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2k3fd,   kof2003,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Kof2003 (Bootleg, fully decrypted)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2003, kof2k3nd,   kof2003,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Kof2003 (Fully decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2k3nrx,  kof2003,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,    ROT0, "hack", "Kof2003 (Neoragex)", MACHINE_SUPPORTS_SAVE )
...
// GAME( 2003, kof2k3pch,  kf2k3pcb, neogeo_noslot, neogeo, neogeo_state, kf2k3pcb,  ROT0, "ZKW", "Kof2003 (Boss remixed)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2k3plr,  kof2003,  neogeo_noslot, neogeo, neogeo_state, kof2003b,  ROT0, "hack", "Kof2003 (Unknown Hack Date)", MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE )
GAME( 2008, kof2k3ps2,  kof2003,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,ROT0, "EGCG / FCHT", "Kof2003 (PS2 2008-03-03 beta 1.0 (EGCG/FCHT))", MACHINE_SUPPORTS_SAVE )
GAME( 2008, kof2k3ps3,  kof2003,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,ROT0, "EGCG / FCHT", "Kof2003 (PS2 2008-10-31 (EGCG/FCHT))", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2k3ryu,  kof2003,  no_watchdog,   neogeo, neogeo_state, neogeo,    ROT0, "Iori Yagami", "Kof2003 (Ryu Hack)", MACHINE_SUPPORTS_SAVE )
...
// GAME( 2003, kf2k3zgf,   kof2003,  neogeo_noslot, neogeo, neogeo_state, kof2003b,  ROT0, "Zhaolu94", "Kof2003 (Attack cremation green)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2003, kof2003s06,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "hack",    "Kof2003 (Enable Hidden Chars V1)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s07,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "Dodowang",    "Kof2003 (Enable Hidden Chars V2)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s08,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "tcwlee",    "Kof2003 (Fix Adel & Mukai's Color)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s09,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "Eddids",    "Kof2003 (Add Rose's Color)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s10,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "Eddids",    "Kof2003 (Add Kagra-Twins' Color)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s11,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "kof1996",    "Kof2003 (Fix Kagura-Twins Vs CPU Bug)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s12,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "Foxy",    "Kof2003 (Enable Kagura-Twins, Adel or Mukai To Be a Team Leader)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s13,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "Eddids",    "Kof2003 (Fix Maki Bug)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s14,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "Eddids",    "Kof2003 (Enhanced Power Cauge)", MACHINE_SUPPORTS_SAVE )
...
// GAME( 2003, kof2003s16,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "Raymonose",    "Kof2003 (Easy Active V1)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s17,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "Andy chan",    "Kof2003 (Easy Active V2)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s18,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "Raymonose",    "Kof2003 (Better Controlling V1)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2003, kof2003s20,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "siromezm",    "Kof2003 (Take Off Athena's Bikini)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2003s21,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "Violet",    "Kof2003 (Color Change V1)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2003s22,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "oak2003 & Katana",    "Kof2003 (Color Change V2)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2003s23,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "oak2003 & Katana",    "Kof2003 (Color Change V3)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2003s24,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "tcwlee",    "Kof2003 (Replace All Chars' Color V1)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2003s25,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "Benalla",    "Kof2003 (Replace All Chars' Color V2)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2003s26,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "oak2003 & siromezm",    "Kof2003 (Replace All Chars' Color V3)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2003s27,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "yozuki",    "Kof2003 (Replace Mai & Mukai's 3P Color)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2003s28,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "oak2003 & Katana",    "Kof2003 (Green Fire)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2003s29,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "Eddids",    "Kof2003 (Violet Fire)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2003s30,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "hack",    "Kof2003 (Transparency Blood Fix)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s31,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "kof1996",    "Kof2003 (Chest Fix)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s32,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "kof1996",    "Kof2003 (Gun Fix)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2003, kof2003s35,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "Eddids",    "Kof2003 (Add Kusanagi Team)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2003s36,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "oak2003",    "Kof2003 (Blood Alt 1)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s37,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "oak2003",    "Kof2003 (Blood Alt 2)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s38,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "LG",    "Kof2003 (Red Blood)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s39,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "LG",    "Kof2003 (Silver style)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s40,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "Eddids",    "Kof2003 (Replace Time Border And Font Into PS2 Style)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2003s41,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init,   ROT0, "Eddids",    "Kof2003 (Unlimited Credits in Console Mode)", MACHINE_SUPPORTS_SAVE )
...
// GAME( 2003, kof2003s44,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init, ROT0, "marcochen",    "Kof2003 (Simplified Chinese Access Menu)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s45,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init, ROT0, "0 Day-S, Eddids, Hiker",    "Kof2003 (Kami Team)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s46,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init, ROT0, "0 Day-S, Eddids, Hiker",    "Kof2003 (Portrait)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s47,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init, ROT0, "Eddids",    "Kof2003 (PlayStation 2 Beta)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s48,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init, ROT0, "0 Day-S, Eddids, Hiker",    "Kof2003 (PS2 Style Portraits)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003s49,     kof2003,  kof2003, 	neo_ek, mvs_led_state,          empty_init, ROT0, "hack",    "Kof2003 (The Selection Interface Changes Randomly)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2003s50,     kof2003,  neogeo_noslot, neogeo, neogeo_state,  kof2003b,  ROT0, "hack", "Kof2003 (Combo)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2003s51,     kof2003,  neogeo_noslot, neogeo, neogeo_state,  xs02,      ROT0, "hack", "Kof2003 (Hero)", MACHINE_SUPPORTS_SAVE )
...
// GAME( 2003, kf2k3pls01,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "devilfox & BisonSAS", "Kof2004 Plus / Hero (Translation Portuguese)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls02,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Jason", "Kof2004 Plus / Hero (Always Change Ok)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls03,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "kof1996", "Kof2004 Plus / Hero (Enable Zoom)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kf2k3pls04,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "MR.L", "Kof2004 Plus / Hero (Unlock Leader Special Move)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls05,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "MR.L", "Kof2004 Plus / Hero (Unlock Leader Special Move v2)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls06,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "kof1996", "Kof2004 Plus / Hero (Fix Kagura Twins Vs CPU Bug)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls07,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Eddids", "Kof2004 Plus / Hero (Fix Maki Bug)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls08,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Eddids", "Kof2004 Plus / Hero (Enhanced Power Cauge)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls09,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Creamymami", "Kof2004 Plus / Hero (Enhanced Power Mode)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kf2k3pls10,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Raymonose", "Kof2004 Plus / Hero (Easy Active v1)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls11,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Andy chan", "Kof2004 Plus / Hero (Easy Active v2)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls12,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Raymonose", "Kof2004 Plus / Hero (Better Controlling v1)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls13,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "SWizard", "Kof2004 Plus / Hero (Better Controlling v2)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls14,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "kof1996", "Kof2004 Plus / Hero (Chest Fix)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls15,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "kof1996", "Kof2004 Plus / Hero (Gun Fix)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls16,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Eddids", "Kof2004 Plus / Hero (Single Mode Power Cauge)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls17,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "marcochen", "Kof2004 Plus / Hero (90 Secs Per Round)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls18,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Eddids", "Kof2004 Plus / Hero (Add Kusanagi Team)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls19,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Eddids", "Kof2004 Plus / Hero (PS2 Style)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kf2k3pls20,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "oak2003", "Kof2004 Plus / Hero (Transparency)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kf2k3pls21,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Eddids", "Kof2004 Plus / Hero (Unlimited Credits in Console Mode)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls22,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "tcwlee", "Kof2004 Plus / Hero (Fix Adel & Mukai's Color)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls23,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Eddids", "Kof2004 Plus / Hero (Add Rose's Color)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls24,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Eddids", "Kof2004 Plus / Hero (Add Kagra Twins' Color)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls25,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "siromezm", "Kof2004 Plus / Hero (Take Off Athena's Bikini)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kf2k3pls26,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "tcwlee", "Kof2004 Plus / Hero (Replace All Chars' Color)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kf2k3pls27,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "Benalla", "Kof2004 Plus / Hero (Replace Some Chars' Color)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kf2k3pls28,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "hack", "Kof2004 Plus / Hero (Replace Mukai's Color)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kf2k3pls29,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "yozuki", "Kof2004 Plus / Hero (Replace Color)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kf2k3pls30,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "LG", "Kof2004 Plus / Hero (Turn Life Bar Color To Red)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3pls31,     kof2003,   kf2k3pl, 	neo_ek, mvs_led_state, empty_init,   ROT0, "LG", "Kof2004 Plus / Hero (Silver Style)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, kof2004pd,      kof2003,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,  ROT0, "hack", "Kof2004 EX Ultra Plus (Hero)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls00,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "devilfox & BisonSAS", "Kof2004 EX Ultra Plus (Brazil Edition)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls01,  kof2003,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,  ROT0, "hack", "Kof2004 EX Ultra Plus (extended time)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls02,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Jason", "Kof2004 EX Ultra Plus (Always Change Ok)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2003, kof2004upls05,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "tcwlee", "Kof2004 EX Ultra Plus (Fix Adel & Mukai's Color)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls06,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Eddids", "Kof2004 EX Ultra Plus (Add Rose's Color)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls07,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Eddids", "Kof2004 EX Ultra Plus (Add Kagra-Twins' Color)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls08,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "kof1996", "Kof2004 EX Ultra Plus (Fix Kagura-Twins Vs CPU Bug)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls09,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Eddids", "Kof2004 EX Ultra Plus (Fix Maki Bug)", MACHINE_SUPPORTS_SAVE )
...
// GAME( 2003, kof2004upls12,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Raymonose", "Kof2004 EX Ultra Plus (Easy Active V1)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls13,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Andy chan", "Kof2004 EX Ultra Plus (Easy Active V2)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls14,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Raymonose", "Kof2004 EX Ultra Plus (Better Controlling V1)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls15,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "SWizard", "Kof2004 EX Ultra Plus (Better Controlling V2)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls16,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "siromezm", "Kof2004 EX Ultra Plus (Take Off Athena's Bikini)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2004upls17,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "tcwlee", "Kof2004 EX Ultra Plus (Replace All Chars' Color)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2004upls18,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Benalla", "Kof2004 EX Ultra Plus (Replace Some Chars' Color)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2004upls19,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "hack", "Kof2004 EX Ultra Plus (Replace Mukai's Color)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2004upls20,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "yozuki", "Kof2004 EX Ultra Plus (Replace Color)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls21,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "kof1996", "Kof2004 EX Ultra Plus (Chest Fix)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls22,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "kof1996", "Kof2004 EX Ultra Plus (Gun Fix)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls23,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Eddids", "Kof2004 EX Ultra Plus (Single Mode Power Cauge)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls24,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Eddids", "Kof2004 EX Ultra Plus (Add Kusanagi Team)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls25,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "LG", "Kof2004 EX Ultra Plus (Red Blood)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls26,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "LG", "Kof2004 EX Ultra Plus (Silver Style)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2004upls27,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Eddids", "Kof2004 EX Ultra Plus (PS2 Style)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2004upls28,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "oak2003", "Kof2004 EX Ultra Plus (Transparency)", MACHINE_SUPPORTS_SAVE )
// GAME( 2003, kof2004upls29,  kof2003,  kf2k3upl, 	neo_ek, mvs_led_state, empty_init,  ROT0, "Eddids", "Kof2004 EX Ultra Plus (Unlimited Credits In Console Mode)", MACHINE_SUPPORTS_SAVE )
// GAME( 2020, kof2004upls30,  kof2003,  neobase_ek, 	neo_ek, mvs_led_state, empty_init,  ROT0, "hack", "Kof2004 EX Ultra Plus (Fengyun Plus Simplified 2020-02-28)", MACHINE_SUPPORTS_SAVE )
