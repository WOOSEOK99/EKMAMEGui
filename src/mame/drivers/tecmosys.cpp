...
HACK( 200?, tkdenshos02,  tkdensho, tecmosys, tecmosys, tecmosys_state, tkdensho,   ROT0, "DDJ", "Toukidenshou (Always Have Super Move)(VER. 960614)", MACHINE_SUPPORTS_SAVE )
HACK( 200?, tkdenshos03,  tkdensho, tecmosys, tecmosys, tecmosys_state, tkdensho,   ROT0, "DDJ", "Toukidenshou (Easy Move)(VER. 960614)", MACHINE_SUPPORTS_SAVE )
HACK( 200?, tkdenshos04,  tkdensho, tecmosys, tecmosys, tecmosys_state, tkdensho,   ROT0, "DDJ", "Toukidenshou (Enable Hidden Characters V2)(VER. 960614)", MACHINE_SUPPORTS_SAVE )
