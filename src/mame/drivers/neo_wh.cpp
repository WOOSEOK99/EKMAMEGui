...
ROM_START( whps10 )
	...
	ROM_LOAD16_WORD_SWAP( "090s10.p1", 0x000000, 0x100000, CRC(ff7a7216) SHA1(7fd39d6aa5ac4e1dbef6ad8bfbfae72221250463) )
    ROM_LOAD16_WORD_SWAP( "090s10.p2", 0x100000, 0x100000, CRC(b1348758) SHA1(ca97603833771a8521836b73fb02a92cfb976ff5) )
...
ROM_END
 ...
 ROM_START( wh2s05 )
	 ROM_REGION( 0x200000, "maincpu", 0 )
	 ROM_LOAD16_WORD_SWAP( "064s05.p1", 0x100000, 0x100000, CRC(fbff72e2) SHA1(dda35f1440142c5acf488dd374c30263c5d8e6fc) )
	 ROM_CONTINUE( 0x000000, 0x100000 )
...
GAME( 1995, whpb,      whp,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "Creamymami, Dodowang", "World Heroes Perfect (Add Char)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, whpb2,     whp,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "Creamymami, Dodowang", "World Heroes Perfect (Add Char - 2 with Icons)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, whpbh,     whp,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "Dodowang", "World Heroes Perfect (Boss Hack)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, whpbho,    whp,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "Dodowang", "World Heroes Perfect (Boss Hack - Older - Has bug)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, whpbho2,   whp,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "Creamymami, Dodowang", "World Heroes Perfect (Add Char - Old - BugFix)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, whpeh,     whp,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "Creamymami, Dodowang, Fighters Kim", "World Heroes Perfect (Add Char - Pow hack)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, whpeho,    whp,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "Creamymami, Dodowang, Fighters Kim", "World Heroes Perfect (Add Char - Pow hack - Old)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, whphez,    whp,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "Zeng_K", "World Heroes Perfect (Boss hack by Zeng_K)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, whpsp,     whp,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "Yashional", "World Heroes Perfect (Special Boss hack by Yashional)", MACHINE_SUPPORTS_SAVE )
GAME( 2007, whpss,     whp,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "Eddids", "World Heroes Perfect (SS v1.0 hack by Eddids (EGHT) 2007-12-25)", MACHINE_SUPPORTS_SAVE )

GAME( 1992, wh1bs,     wh1,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "Yumeji", "World Heroes (Boss hack by Yumeji)", MACHINE_SUPPORTS_SAVE )

GAME( 1993, wh2bs,     wh2,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "Yumeji", "World Heroes 2 (Boss hack by Yumeji)", MACHINE_SUPPORTS_SAVE )
GAME( 1993, wh2ey,     wh2,  neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "ZKW", "World Heroes 2 (Boss, PPX hack, remixed by ZKW)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, wh2ja,     wh2j, neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "ADK / SNK", "World Heroes 2 Jet (ADM-007)(ADH-007)(old set)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, wh2jb,     wh2j, neobase_ek, neo_ek, mvs_led_state, empty_init, ROT0, "0days", "World Heroes 2 Jet (Boss hack by 0days (EGCG))", MACHINE_SUPPORTS_SAVE )
 
GAME( 2017, whps01,         whp,      neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",     "World Heroes Perfect (Always Maximum Hero Power)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, whps02,         whp,      neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",     "World Heroes Perfect (Add Character Boss)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, whps03,         whp,      neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",     "World Heroes Perfect (Add Character Boss Set 01)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, whps04,         whp,      neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",     "World Heroes Perfect (Add Character Boss Set 02)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, whps05,         whp,      neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",     "World Heroes Perfect (Enable Hidden Characters)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, whps06,         whp,      neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",     "World Heroes Perfect (Maximum Hero Power)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, whps07,         whp,      neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",     "World Heroes Perfect (Moved To Modify V1)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, whps08,         whp,      neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",     "World Heroes Perfect (Moved To Modify V2)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, whps09,         whp,      neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",     "World Heroes Perfect (Super Remix Edition 1.0)", MACHINE_SUPPORTS_SAVE )
GAME( 200?, whps10,		 	whp,	  neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Unknown", 	"World Heroes Perfect Plus (Add Boss Hack)", MACHINE_SUPPORTS_SAVE )

 // World Heroes 2 Jet
GAME( 2017, wh1s01,         wh1,      neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",     "World Heroes (Enable Hidden Characters Alt)(ALM-005)", MACHINE_SUPPORTS_SAVE )
GAME( 200?, wh1s02,         wh1,      neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Unknown",         "World Heroes (Simple Attack Edition)(ALM-005)", MACHINE_SUPPORTS_SAVE )

GAME( 2017, wh1hs01,        wh1,      neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",     "World Heroes (Enable Hidden Characters)(ALM-005)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, wh1has01,       wh1,      neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",     "World Heroes (Enable Hidden Characters Alt V2)(set 3)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, wh2s01,         wh2j,     neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",     "World Heroes 2 Jet (Enable Hidden Characters V1)(ADM-007)(ADH-007)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, wh2s02,         wh2,      neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",     "World Heroes 2 (Easy Special Attacks)(ALM-006)(ALH-006)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, wh2s03,         wh2j,     neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",     "World Heroes 2 Jet (Easy Special Attacks Alt)(ADM-007)(ADH-007)", MACHINE_SUPPORTS_SAVE )
GAME( 2017, wh2s04,         wh2j,     neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Hacks",     "World Heroes 2 Jet (Super Remix Edition 1.0)(ADM-007)(ADH-007)", MACHINE_SUPPORTS_SAVE )
GAME( 200?, wh2s05,         wh2,      neobase_ek, neo_ek, mvs_led_state, empty_init,   ROT0,  "Unknown",     "World Heroes 2 (Boss With Simple Attack Edition)(ALM-006)(ALH-006)", MACHINE_SUPPORTS_SAVE )
