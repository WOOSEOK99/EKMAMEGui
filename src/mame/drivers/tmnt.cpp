...
// Sunset Riders
GAME( 2009, ssridersaex,   ssriders, ssriders, ssriders,  tmnt_state, empty_init, ROT0,   "Pipi899","Sunset Riders (2 Players ver ABD EX Super Version)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, ssridersudas01,ssriders, ssriders, ssrid4ps,  tmnt_state, empty_init,ROT0,   "Hacks",  "Sunset Riders (4 Players ver EAC)(Ex Super version)", MACHINE_SUPPORTS_SAVE )
...
// Teenage Mutant Ninja Turtles
GAME( 1991, tmnt2s01,      tmnt2,    tmnt2,    ssrid4ps,  tmnt_state, empty_init, ROT0,   "Hacks",  "Teenage Mutant Ninja Turtles - Turtles in Time (4 Players ver ADA)(Ex Super version)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, tmnt2s02,      tmnt2,    tmnt2,    ssrid4ps,  tmnt_state, empty_init, ROT0,   "Hacks",  "Teenage Mutant Ninja Turtles - Turtles in Time (4 Players ver ADA)(Start Change Char)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, tmnt2as01,     tmnt2,    tmnt2,    ssrid4ps,  tmnt_state, empty_init, ROT0,   "Hacks",  "Teenage Mutant Ninja Turtles - Turtles in Time (4 Players ver ADA)(Cowabunga Mode)", MACHINE_SUPPORTS_SAVE )