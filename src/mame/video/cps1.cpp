...
// HBMAME
	...
	{"3wondersb01", CPS_B_21_BT1, mapper_RT24B },							//works
	...
	{"sk2h101",       HACK_H_2,     mapper_TK263B, 0, 0, 0, 0x8F },			//works, priorities
	{"sk2h101q",      HACK_H_2,     mapper_TK263B, 0, 0, 0, 0x8F },			//works, priorities
	{"sk2h102",       HACK_H_2,     mapper_TK263B, 0, 0, 0, 0x8F },			//works, priorities
	{"sk2h102q",      HACK_H_2,     mapper_TK263B, 0, 0, 0, 0x8F },			//works, priorities
	{"sk2h103",       HACK_H_2,     mapper_TK263B, 0, 0, 0, 0x8F },			//works, priorities
	{"sk2h104q",      HACK_H_2,     mapper_TK263B, 0, 0, 0, 0x8F },			//works, priorities
	{"sk2h105q",      HACK_H_2,     mapper_TK263B, 0, 0, 0, 0x8F },			//works, priorities
	{"sk2h106q",      HACK_H_2,     mapper_TK263B, 0, 0, 0, 0x8F },			//works, priorities
	...
	{"tk2p44",       CPS_B_21_DEF, mapper_sfzch },							//works
	{"tk2p45",       CPS_B_21_DEF, mapper_TK263B },							//works
	...
	{"sk3h1",       HACK_H_2,     mapper_TK263B, 0, 0, 0, 0x8F },			//works, priorities
	{"sk3h2",       HACK_H_2,     mapper_TK263B, 0, 0, 0, 0x8F },			//works, priorities

	{"3wonders01",       CPS_B_21_BT1, mapper_RT24B },	
	{"3wonders02",       CPS_B_21_BT1, mapper_RT24B },	

	{"captcommek1", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcommek2", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	...
	{"captcomms61", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms62", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms63", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms64", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms65", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms66", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms67", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms68", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms69", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms70", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms71", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms72", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms73", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms74", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms75", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms76", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms77", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms78", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms79", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms80", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms81", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms82", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms83", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms84", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	{"captcomms85", CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34 },
	...
	{"dinos64",			CPS_B_21_QS2, mapper_CD63B },//dinoh
	{"dinos65",			CPS_B_21_QS2, mapper_CD63B },
	{"dinos69",			CPS_B_21_QS2, mapper_CD63B },//dinoh
	{"dinos70",			CPS_B_21_QS2, mapper_CD63B },	
	{"dinos71",			CPS_B_21_QS2, mapper_CD63B },//dinoh
	{"dinos72",			CPS_B_21_QS2, mapper_CD63B },//dinoh
	{"dinos73",			CPS_B_21_QS2, mapper_CD63B },//dinoh
	{"dinos74",			CPS_B_21_QS2, mapper_CD63B },//dinoh
	{"dinos75",			CPS_B_21_QS2, mapper_CD63B },//dinoh
	{"dinos133",		CPS_B_21_QS2, mapper_CD63B },//dinoh
	{"dinos135",		CPS_B_21_DEF, mapper_CD63B, 0x36 },//dinoh
	{"dinos136",		CPS_B_21_QS2, mapper_CD63B },//dinoh
	...
	{"dinos215",		CPS_B_21_QS2, mapper_CD63B },	
	{"dinos220",		CPS_B_21_QS2, mapper_CD63B },	
	{"dinos185",   		CPS_B_21_QS2, mapper_CD63B },							//works
	...
	{"dinos40",		CPS_B_21_DEF, mapper_CD63B },	
	{"dinos41",		CPS_B_21_DEF, mapper_CD63B },	
	...
	{"dinos57",		CPS_B_21_QS2, mapper_CD63B },	
	{"dinos58",		CPS_B_21_QS2, mapper_CD63B },	
	...
	{"dinos123",		CPS_B_21_QS2, mapper_CD63B },
	...
	{"dinos194",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos195",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos196",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos197",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos198",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos199",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos200",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos201",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos202",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos203",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos204",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos205",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos206",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos207",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos208",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos209",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos210",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos211",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos212",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos213",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos214",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos216",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos217",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos218",		CPS_B_21_QS2, mapper_CD63B },
	{"dinos219",		CPS_B_21_QS2, mapper_CD63B },



    {"dinos221",   		CPS_B_21_QS2, mapper_CD63B },
    {"dinos222",   		CPS_B_21_QS2, mapper_CD63B },
    {"dinos223",   		CPS_B_21_QS2, mapper_CD63B },
    {"dinos224",   		CPS_B_21_QS2, mapper_CD63B },
    {"dinos225",   		CPS_B_21_QS2, mapper_CD63B },
    {"dinos226",   		CPS_B_21_QS2, mapper_CD63B },
    {"dinos227",   		CPS_B_21_QS2, mapper_CD63B },
    {"dinos228",   		CPS_B_21_QS2, mapper_CD63B },
    {"dinos229",   		CPS_B_21_QS2, mapper_CD63B },
    {"dinos230",   		CPS_B_21_QS2, mapper_CD63B },
    {"dinos231",   		CPS_B_21_QS2, mapper_CD63B },
    {"dinos232",   		CPS_B_21_QS2, mapper_CD63B },
    {"dinos233",   		CPS_B_21_QS2, mapper_CD63B },
    {"dinos234",   		CPS_B_21_QS2, mapper_CD63B },
    {"dinos235",   		CPS_B_21_QS2, mapper_CD63B },
    {"dinos236",   		CPS_B_21_QS2, mapper_CD63B },
    {"dinos237",   		CPS_B_21_QS2, mapper_CD63B },
	...
	{"ffights01",      	 CPS_B_04,     mapper_S224B },  // 1x 2x 3x
	{"ffights02",        CPS_B_04,     mapper_S224B },  // work
	{"ffightj1s01",      CPS_B_01,     mapper_S224B },  // work
	{"ffightj2s02",      CPS_B_02,     mapper_S224B },	// work
	{"ffightj2s01",      CPS_B_02,     mapper_S224B },  // work
	{"ffightjh01",      CPS_B_02,     mapper_S224B },  // work
	...
	{"punishers08",    CPS_B_21_QS3, mapper_PS63B }, 
	...
	{"sf2ces06",     CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces07",       CPS_B_21_DEF, mapper_S9263B, 0x36 },  
	{"sf2ces08",       CPS_B_21_DEF, mapper_S9263B, 0x36 },  
	{"sf2ces09",       CPS_B_21_DEF, mapper_S9263B, 0x36 }, 
	{"sf2ces13",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces14",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces15",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces16",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces17",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces18",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces19",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces20",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces21",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces22",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces23",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces24",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces25",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces26",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces27",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces28",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces29",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces30",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces31",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2ces32",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2js01",        CPS_B_21_DEF, mapper_S9263B, 0x36 },   
	{"sf2js02",        CPS_B_21_DEF, mapper_S9263B, 0x36 },  
	{"sf2s01",         CPS_B_21_DEF, mapper_S9263B, 0x36 },    
	{"sf2s02",         CPS_B_21_DEF, mapper_S9263B, 0x36 },    
	{"sf2s03",         CPS_B_21_DEF, mapper_S9263B, 0x36 },  
	{"sf2s04",         CPS_B_21_DEF, mapper_S9263B, 0x36 },  
	{"sf2s05",         CPS_B_21_DEF, mapper_S9263B, 0x36 },  
	{"sf2s06",         CPS_B_21_DEF, mapper_S9263B, 0x36 }, 
	{"sf2s08",         CPS_B_21_DEF, mapper_S9263B, 0x36 }, 
	{"sf2koryus01",    CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2koryus02",    CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2koryus03",    CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2tlonas01",    CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2tlonas02",    CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2tlonas03",    CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2tlonas04",    CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2hfus01",      CPS_B_21_DEF, mapper_S9263B, 0x36 }, 
	{"sf2hfus02",      CPS_B_21_DEF, mapper_S9263B, 0x36 }, 
	{"sf2hfus03",      CPS_B_21_DEF, mapper_S9263B, 0x36 }, 
	{"sf2hfus04",      CPS_B_21_DEF, mapper_S9263B, 0x36 }, 
	{"sf2h11s01",      CPS_B_21_DEF, mapper_S9263B, 0x36 }, 
	{"sf2puns01",      CPS_B_21_DEF, mapper_S9263B, 0x36 }, 
	{"sf2reds01",      CPS_B_21_DEF, mapper_S9263B, 0x36 }, 
	{"sf2reds02",      CPS_B_21_DEF, mapper_S9263B, 0x36 }, 
	{"sf2reds03",      CPS_B_21_DEF, mapper_S9263B, 0x36 }, 
	{"sf2reds04",      CPS_B_21_DEF, mapper_S9263B, 0x36 }, 
	{"sf2reds05",      CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2reds06",      CPS_B_21_DEF, mapper_S9263B, 0x36 },
	{"sf2m7s01",       CPS_B_21_DEF, mapper_S9263B, 0x36 },
	...
	{"tk2h44",         CPS_B_21_DEF, mapper_TK263B },
	...
	{"tk2h140",        CPS_B_21_QS1, mapper_TK263B },
	{"tk2h141",        CPS_B_21_QS1, mapper_TK263B },
	{"tk2h142",        CPS_B_21_QS1, mapper_TK263B },
	{"tk2h143",        CPS_B_21_QS1, mapper_TK263B },
	{"tk2h144",        CPS_B_21_QS1, mapper_TK263B },
	{"tk2h145",        CPS_B_21_QS1, mapper_TK263B },
	{"tk2h146",        CPS_B_21_QS1, mapper_TK263B },
	{"tk2h147",        CPS_B_21_QS1, mapper_TK263B },
	{"tk2h148",        CPS_B_21_QS1, mapper_TK263B },
	{"tk2h149",        CPS_B_21_QS1, mapper_TK263B },
	{"tk2h150",        CPS_B_21_QS1, mapper_TK263B },
	{"tk2h151",        CPS_B_21_QS1, mapper_TK263B },
	{"tk2h152",        CPS_B_21_QS1, mapper_TK263B },
	{"tk2h153",        CPS_B_21_QS1, mapper_TK263B },
	{"tk2h154",        CPS_B_21_QS1, mapper_TK263B },
	{"tk2h155",        CPS_B_21_QS1, mapper_TK263B },
	...
	{"tk2p16",       CPS_B_21_DEF, mapper_TK263B },
	{"tk2p17",       CPS_B_21_DEF, mapper_TK263B },
	...
	{"tk2p35",       CPS_B_21_DEF, mapper_TK263B },
	...
	{"tk2p40",       CPS_B_21_DEF, mapper_TK263B },
	...
	{"sk2h19",       CPS_B_21_DEF, mapper_TK263B },
...
///
	{"sk2h42",       HACK_H_2,     mapper_TK263B, 0, 0, 0, 0x8F},
	{"sk2h46",       HACK_H_2,     mapper_TK263B, 0, 0, 0, 0x8F},
	{"sk2h107",		 HACK_H_2,     mapper_TK263B, 0, 0, 0, 0x8F},
	{"sk2h108",      HACK_H_2,     mapper_TK263B, 0, 0, 0, 0x8F},
	{"sk2h116",      HACK_H_2,     mapper_TK263B, 0, 0, 0, 0x8F},
	{"sk2h117",      HACK_H_2,     mapper_TK263B, 0, 0, 0, 0x8F},
	{"sk2h118",      HACK_H_2,     mapper_TK263B, 0, 0, 0, 0x8F},

	{"sk2h114",     CPS_B_21_DEF, mapper_TK263B },
	{"sk2h115",     CPS_B_21_DEF, mapper_TK263B },
	...
	{"sk3h2",		CPS_B_21_DEF, mapper_TK263B },
	...
	{"wofs04",      CPS_B_21_DEF, mapper_TK263B },
	...
	{"wofs09",      CPS_B_21_DEF, mapper_TK263B },
	{"sf2jbh", 		CPS_B_11,	  mapper_STF29,  0x36 },
...
void cps_state::cps1_get_video_base()
{
	...
	if (m_game_config->bootleg_kludge == 0x8F) 
	{
		scroll1xoff = -0x3F;
		scroll2xoff = 0x0;
		scroll3xoff = 0x0;
