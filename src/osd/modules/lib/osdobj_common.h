...
//MAME_VAI
	const char *avi_filename() const { return value("avi_avi_filename"); }
    float def_fps() const {return float_value("avi_def_fps");}
	float fps() const {return float_value("avi_fps");}
	int frame_skip() const {return float_value("avi_frame_skip");}
	bool frame_cmp() const {return bool_value("avi_frame_cmp");}
	bool frame_cmp_pre15() const {return bool_value("avi_frame_cmp_pre15");}
	bool frame_cmp_few() const {return bool_value("avi_frame_cmp_few");}
	int width() const {return int_value("avi_width");}
	int height() const {return int_value("avi_height");}
	int depth() const {return int_value("avi_depth");}
	int orientation() const {return int_value("avi_orientation");}
	int rect_Top() const {return int_value("avi_rect_top");}
	int rect_Left() const {return int_value("avi_rect_left");}
	int rect_Width() const {return int_value("avi_rect_width");}
	int rect_Height() const {return int_value("avi_rect_height");}
	bool interlace() const {return bool_value("avi_interlace");}
	bool interlace_odd_number_field() const {return bool_value("avi_interlace_odd_field");}
	int avi_filesize() const {return int_value("avi_avi_filesize");}
	bool avi_savefile_pause() const {return bool_value("avi_avi_savefile_pause");}
	int avi_width() const {return int_value("avi_avi_width");}         
	int avi_height()const {return int_value("avi_avi_height");}         
	int avi_depth()         const {return int_value("avi_avi_depth");}         
	int avi_rect_Top()    const {return int_value("avi_avi_rect_top");}         
	int avi_rect_Left()   const {return int_value("avi_avi_rect_left");}         
	int avi_rect_Width()  const {return int_value("avi_avi_rect_width");}         
	int avi_rect_Height() const {return int_value("avi_avi_rect_height");}         
	bool avi_smooth_resize_x() const {return bool_value ("avi_avi_smooth_resize_x");}
	bool avi_smooth_resize_y() const {return bool_value ("avi_avi_smooth_resize_y");}

	const char *wav_filename() const { return value("avi_wav_filename"); }
	int audio_type()                const {return int_value("avi_audio_type");}
	int audio_channel()             const {return int_value("avi_audio_channel");}
	int audio_samples_per_sec()     const {return int_value("avi_audio_samples_per_sec");}
	int audio_bitrate()             const {return int_value("avi_audio_bitrate");}
	int avi_audio_record_type()     const {return int_value("avi_audio_record_type");}
	int avi_audio_channel()         const {return int_value("avi_avi_audio_channel");}
	int avi_audio_samples_per_sec() const {return int_value("avi_avi_audio_samples_per_sec");}
	int avi_audio_bitrate()         const {return int_value("avi_avi_audio_bitrate");}
	bool avi_audio_cmp()            const {return bool_value("");}
	int hour()   const {return int_value("avi_hour");}                   
	int minute() const {return int_value("avi_minute");}                   
	int second() const {return int_value("avi_second");}                   
};
