...
const options_entry windows_options::s_option_entries[] =
{
	...
	{ WINOPTION_HLSLPATH,                                       "disp/hlsl",              OPTION_STRING,     "path to HLSL support files" },
	...
	{ WINOPTION_TRIPLEBUFFER ";tb",                   "1",        OPTION_BOOLEAN,    "enables triple buffering" },
...
#ifdef USE_PSXPLUGIN
	{ NULL,                                           NULL,       OPTION_HEADER,     "PSXPLUGIN OPTIONS" },
	{ WINOPTION_PSXPLUGIN,		                      "0",        OPTION_BOOLEAN,    "enables PSX Plugin" },
#endif
