...
const options_entry ui_options::s_option_entries[] =
{
	...
	{ OPTION_UI_BACKGROUND_COLOR,           "ef007FFF",     OPTION_STRING,      "UI background color (ARGB)" },
	...
	{ OPTION_UI_SUBITEM_COLOR,              "efFF8000",     OPTION_STRING,      "UI subitem color (ARGB)" },
	{ OPTION_UI_TEXT_BG_COLOR,              "ff000000",     OPTION_STRING,      "UI text bg color (ARGB)" },
