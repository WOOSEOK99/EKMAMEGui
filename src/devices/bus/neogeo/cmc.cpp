...
//#ifdef USE_NEOGEO_HACK
/*************************************************
 kof2k2sr
**************************************************/

DEFINE_DEVICE_TYPE(NEOGEO_KOF2K2SR_CART, neogeo_kof2k2sr_cart_device, "neocart_kof2k2sr", "Neo Geo Kof2k2sr Cart")

neogeo_kof2k2sr_cart_device::neogeo_kof2k2sr_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock) :
	neogeo_cmc_cart_device(mconfig, NEOGEO_KOF2K2SR_CART, tag, owner, clock)
{
}

void neogeo_kof2k2sr_cart_device::decrypt_all(DECRYPT_ALL_PARAMS)
{
	m_prot->kof2k2sr_sfix_decrypt(fix_region, fix_region_size);
}
...
DEFINE_DEVICE_TYPE(NEOGEO_CMC42SFIX_CART, neogeo_cmc42sfix_cart_device, "neocart_cmc42fix", "Neo Geo CMC42 Cart")

neogeo_cmc42sfix_cart_device::neogeo_cmc42sfix_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock) :
	neogeo_cmc_cart_device(mconfig, NEOGEO_CMC42SFIX_CART, tag, owner, clock)
{
}

void neogeo_cmc42sfix_cart_device::decrypt_all(DECRYPT_ALL_PARAMS)
{
...
DEFINE_DEVICE_TYPE(NEOGEO_CMC50SFIX_CART, neogeo_cmc50sfix_cart_device, "neocart_cmc50fix", "Neo Geo CMC50 Cart")

neogeo_cmc50sfix_cart_device::neogeo_cmc50sfix_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock) :
	neogeo_cmc_cart_device(mconfig, NEOGEO_CMC50SFIX_CART, tag, owner, clock)
{
}

void neogeo_cmc50sfix_cart_device::decrypt_all(DECRYPT_ALL_PARAMS)
{
	m_prot->sfix_decrypt(spr_region, spr_region_size, fix_region, fix_region_size);
}
//#endif
...
DEFINE_DEVICE_TYPE(NEOGEO_CMC_KOF2KND_CART, neogeo_cmc_kof2knd_cart_device, "neocart_kof2knd", "Neo Geo KoF 2knd CMC50 Cart")

neogeo_cmc_kof2knd_cart_device::neogeo_cmc_kof2knd_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock) :
	neogeo_cmc_cart_device(mconfig, NEOGEO_CMC_KOF2KND_CART, tag, owner, clock)
{
}

void neogeo_cmc_kof2knd_cart_device::decrypt_all(DECRYPT_ALL_PARAMS)
{
	m_prot->sfix_decrypt(spr_region, spr_region_size, fix_region, fix_region_size);
}
...
DEFINE_DEVICE_TYPE(NEOGEO_CMC_KOF2000M_CART, neogeo_cmc_kof2000m_cart_device, "neocart_kof2000m", "Neo Geo KoF 2001m CMC50 Cart")

neogeo_cmc_kof2000m_cart_device::neogeo_cmc_kof2000m_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock) :
	neogeo_cmc_cart_device(mconfig, NEOGEO_CMC_KOF2000M_CART, tag, owner, clock)
{
}

void neogeo_cmc_kof2000m_cart_device::decrypt_all(DECRYPT_ALL_PARAMS)
{
	m_prot->cmc50_gfx_decrypt(spr_region, spr_region_size, KOF2000_GFX_KEY);
	m_prot->sfix_decrypt(spr_region, spr_region_size, fix_region, fix_region_size);	
}
