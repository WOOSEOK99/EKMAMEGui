...
class neogeo_ms6s16_cart_device : public neogeo_bootleg_cart_device
{
public:
	neogeo_ms6s16_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock);
	virtual void decrypt_all(DECRYPT_ALL_PARAMS) override;
	virtual int get_fixed_bank_type() override { return 0; }
...
DECLARE_DEVICE_TYPE(NEOGEO_MSLUG6S16_CART, neogeo_ms6s16_cart_device)
