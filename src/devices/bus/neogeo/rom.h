...
class neogeo_ek_cart_device : public neogeo_rom_device
{
public:
	neogeo_ek_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock);
...
DECLARE_DEVICE_TYPE(NEOGEO_EK_CART, neogeo_ek_cart_device)
//#endif
