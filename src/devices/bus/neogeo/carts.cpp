...
//#ifdef USE_NEOGEO_HACK
	device.option_add_internal("rom_ek",      NEOGEO_EK_CART);
//#endif
	...
	device.option_add_internal("rom_kof2k2sr", NEOGEO_KOF2K2SR_CART);      // Custom Metal Slug X protection

	// only CMC42 for gfx
//#ifdef USE_NEOGEO_HACK	
	device.option_add_internal("cmc42sfix",   	 NEOGEO_CMC42SFIX_CART);
	device.option_add_internal("cmc42_kof2knd",  NEOGEO_CMC_KOF2KND_CART);
//#endif	
...
//#ifdef USE_NEOGEO_HACK	
	device.option_add_internal("cmc50sfix", 	 NEOGEO_CMC50SFIX_CART);
	device.option_add_internal("cmc50_kof2000m",  NEOGEO_CMC_KOF2000M_CART);
//#endif	
	...
	device.option_add_internal("sma_kof2k_ek",  NEOGEO_SMA_KOF2000_CART);//

	device.option_add_internal("sma_kof2000d",  NEOGEO_SMA_KOF2000D_CART);	//USE_NEOGEO_HACK
	...
	device.option_add_internal("pvc_mslug5hb", NEOGEO_PVC_MSLUG5HB_CART);
	...
	device.option_add_internal("boot_ms6s16",   NEOGEO_MSLUG6S16_CART);  // this also uses a CMC42 for gfx
