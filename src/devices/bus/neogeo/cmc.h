...
/*************************************************
 kof2k2sr
**************************************************/
class neogeo_kof2k2sr_cart_device : public neogeo_cmc_cart_device
{
public:
	neogeo_kof2k2sr_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock);
	virtual void decrypt_all(DECRYPT_ALL_PARAMS) override;
	//virtual int get_fixed_bank_type() override { return 2; }
};

DECLARE_DEVICE_TYPE(NEOGEO_KOF2K2SR_CART, neogeo_kof2k2sr_cart_device)

/*************************************************
 cmc42sfix
**************************************************/

class neogeo_cmc42sfix_cart_device : public neogeo_cmc_cart_device
{
public:
	neogeo_cmc42sfix_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock);
	virtual void decrypt_all(DECRYPT_ALL_PARAMS) override;
	virtual int get_fixed_bank_type() override { return 1; }
};

DECLARE_DEVICE_TYPE(NEOGEO_CMC42SFIX_CART, neogeo_cmc42sfix_cart_device)

/*************************************************
 cmc50sfix
**************************************************/

class neogeo_cmc50sfix_cart_device : public neogeo_cmc_cart_device
{
public:
	neogeo_cmc50sfix_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock);
	virtual void decrypt_all(DECRYPT_ALL_PARAMS) override;
	virtual int get_fixed_bank_type() override { return 2; }
};

DECLARE_DEVICE_TYPE(NEOGEO_CMC50SFIX_CART, neogeo_cmc50sfix_cart_device)
//#endif
/*************************************************
 zupapa
**************************************************/
...
/*************************************************
 kof2knd
**************************************************/
class neogeo_cmc_kof2knd_cart_device : public neogeo_cmc_cart_device
{
public:
	neogeo_cmc_kof2knd_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock);
	virtual void decrypt_all(DECRYPT_ALL_PARAMS) override;
	virtual int get_fixed_bank_type() override { return 2; }
};

DECLARE_DEVICE_TYPE(NEOGEO_CMC_KOF2KND_CART, neogeo_cmc_kof2knd_cart_device)

/*************************************************
 kof2000m
**************************************************/

class neogeo_cmc_kof2000m_cart_device : public neogeo_cmc_cart_device
{
public:
	neogeo_cmc_kof2000m_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock);
	virtual void decrypt_all(DECRYPT_ALL_PARAMS) override;
	virtual int get_fixed_bank_type() override { return 2; }
};

DECLARE_DEVICE_TYPE(NEOGEO_CMC_KOF2000M_CART, neogeo_cmc_kof2000m_cart_device)
