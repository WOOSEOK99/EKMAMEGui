...
static std::vector<rgb_t> uifont_colortable;

enum
{
	sSYSTEM_COLOR_BACKGROUND,
	sCURSOR_SELECTED_TEXT,
	sCURSOR_SELECTED_BG,
	sCURSOR_HOVER_TEXT,
	sCURSOR_HOVER_BG,
	sBUTTON_COLOR_RED,
	sBUTTON_COLOR_YELLOW,
	sBUTTON_COLOR_GREEN,
	sBUTTON_COLOR_BLUE,
	sBUTTON_COLOR_PURPLE,
	sBUTTON_COLOR_PINK,
	sBUTTON_COLOR_AQUA,
	sBUTTON_COLOR_SILVER,
	sBUTTON_COLOR_NAVY,
	sBUTTON_COLOR_LIME,
	MAX_COLORTABLES
};
...
{
	{ "main_background",		0,		{ 16,16,48 } },
	{ "cursor_sel_text",		1,		{ 255,255,255 } },
	{ "cursor_sel_background",	2,		{ 60,120,240 } },
	{ "cursor_hov_text",		3,		{ 120,180,240 } },
	{ "cursor_hov_background",	4,		{ 32,32,0 } },
	{ "button_red", 			5,		{ 255,64,64 } },
	{ "button_yellow",			6,		{ 255,238,0 } },
	{ "button_green",			7,		{ 0,255,64 } },
	{ "button_blue",			8,		{ 0,170,255 } },
	{ "button_purple",			9,		{ 170,0,255 } },
	{ "button_pink",		   10,		{ 255,0,170 } },
	{ "button_aqua",		   11,		{ 0,255,204 } },
	{ "button_silver",		   12,		{ 255,0,255 } },
	{ "button_navy",		   13,		{ 255,160,0 } },
	{ "button_lime",		   14,		{ 190,190,190 } },
	{ NULL }
};
...
//	osd_file::error const filerr(ramfile.open_ram(font_uismall, sizeof(font_uismall)));
	osd_file::error const filerr(ramfile.open_ram(font_uismall14, sizeof(font_uismall14)));
...
rgb_t get_rgb_color(rgb_t color)
{
	...
	uifont_colortable.resize(MAX_COLORTABLES);
...
//#ifdef UI_COLOR_DISPLAY
	rgb_t fgcol = rgb_t(0xff,0xff,0xff,0xff);
//#else
...
float render_font::char_width_no_margin(float height, float aspect, char32_t ch)
{
...
bool render_font::load_cached_cmd(emu_file &file, u64 length, u32 hash)
{
	//mamep: color glyph
	#include "cmdtable.cpp"
...
void render_font::render_font_command_glyph()
{
	...
	osd_file::error const filerr(ramfile.open_ram(font_uicmd14, sizeof(font_uicmd14)));
	if (osd_file::error::NONE == filerr)
		load_cached_cmd(ramfile, 0, 0);
}

void convert_command_glyphs(char *s, int buflen)
{
	char32_t uchar;
	char *d;
	int ucharcount;
