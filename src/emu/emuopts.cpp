...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_HASHPATH ";hash_directory;hash",            "dats/hash",      OPTION_STRING,     "path to hash files" },
	{ OPTION_SAMPLEPATH ";sp",                           "dats/samples",   OPTION_STRING,     "path to samplesets" },
	{ OPTION_ARTPATH,                                    "disp/artwork",   OPTION_STRING,     "path to artwork files" },
	{ OPTION_CTRLRPATH,                                  "dats/ctrlr",     OPTION_STRING,     "path to controller definitions" },
	{ OPTION_INIPATH,                                    ".;ini;ini/presets",     OPTION_STRING,     "path to ini files" },
	{ OPTION_FONTPATH,                                   ".",         OPTION_STRING,     "path to font files" },
	{ OPTION_CHEATPATH,                                  "dats/cheat",     OPTION_STRING,     "path to cheat files" },
	{ OPTION_CROSSHAIRPATH,                              "dats/crosshair", OPTION_STRING,     "path to crosshair files" },
	{ OPTION_PLUGINSPATH,                                "dats/plugins",   OPTION_STRING,     "path to plugin files" },
	{ OPTION_LANGUAGEPATH,                               "dats/language",  OPTION_STRING,     "path to language files" },
	...
	{ OPTION_CFG_DIRECTORY,                              "savedats/cfg",       OPTION_STRING,     "directory to save configurations" },
	{ OPTION_NVRAM_DIRECTORY,                            "savedats/nvram",     OPTION_STRING,     "directory to save NVRAM contents" },
	{ OPTION_INPUT_DIRECTORY,                            "savedats/inp",       OPTION_STRING,     "directory to save input device logs" },
	{ OPTION_STATE_DIRECTORY,                            "savedats/sta",       OPTION_STRING,     "directory to save states" },
	{ OPTION_SNAPSHOT_DIRECTORY,                         "preview/snap",      OPTION_STRING,     "directory to save/load screenshots" },
	{ OPTION_DIFF_DIRECTORY,                             "savedats/diff",      OPTION_STRING,     "directory to save hard drive image difference files" },
	{ OPTION_COMMENT_DIRECTORY,                          "savedats/comments",  OPTION_STRING,     "directory to save debugger comments" },
	{ OPTION_VIDEO_DIRECTORY,                          	 "preview/video",  	  OPTION_STRING,     "directory to save/load video files" },
	...
	{ OPTION_WIDESTRETCH,					     		 "1",         OPTION_BOOLEAN,    "enable D3D wide floating point stretching" },
...
//#endif /* USE_SCALE_EFFECTS */
	...
	{ OPTION_SKIP_GAMEINFO,                              "1",         OPTION_BOOLEAN,    "skip displaying the system information screen at startup" },
	...
	{ OPTION_LANGUAGE ";lang",                           "Korean",   OPTION_STRING,     "set UI display language" },
