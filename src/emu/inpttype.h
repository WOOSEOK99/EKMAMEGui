...
#define CORE_INPUT_TYPES_P1 \
	...
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICK_UP,         "@P1 @Up",                  input_seq(KEYCODE_UP, input_seq::or_code, JOYCODE_Y_UP_SWITCH_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICK_DOWN,       "@P1 @Down",                input_seq(KEYCODE_DOWN, input_seq::or_code, JOYCODE_Y_DOWN_SWITCH_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICK_LEFT,       "@P1 @Left",                input_seq(KEYCODE_LEFT, input_seq::or_code, JOYCODE_X_LEFT_SWITCH_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICK_RIGHT,      "@P1 @Right",               input_seq(KEYCODE_RIGHT, input_seq::or_code, JOYCODE_X_RIGHT_SWITCH_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICKRIGHT_UP,    "@P1 Right Stick/Up",      input_seq(JOYCODE_BUTTON2_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICKRIGHT_DOWN,  "@P1 Right Stick/Down",    input_seq(JOYCODE_BUTTON3_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICKRIGHT_LEFT,  "@P1 Right Stick/Left",    input_seq(JOYCODE_BUTTON1_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICKRIGHT_RIGHT, "@P1 Right Stick/Right",   input_seq(JOYCODE_BUTTON4_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICKLEFT_UP,     "@P1 Left Stick/Up",       input_seq(JOYCODE_Y_UP_SWITCH_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICKLEFT_DOWN,   "@P1 Left Stick/Down",     input_seq(JOYCODE_Y_DOWN_SWITCH_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICKLEFT_LEFT,   "@P1 Left Stick/Left",     input_seq(JOYCODE_X_LEFT_SWITCH_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICKLEFT_RIGHT,  "@P1 Left Stick/Right",    input_seq(JOYCODE_X_RIGHT_SWITCH_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON1,             "@P1 @Button1",            input_seq(KEYCODE_Z, input_seq::or_code, JOYCODE_BUTTON1_INDEXED(1), input_seq::or_code, MOUSECODE_BUTTON1_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON2,             "@P1 @Button2",            input_seq(KEYCODE_X, input_seq::or_code, JOYCODE_BUTTON2_INDEXED(1), input_seq::or_code, MOUSECODE_BUTTON3_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON3,             "@P1 @Button3",            input_seq(KEYCODE_C, input_seq::or_code, JOYCODE_BUTTON3_INDEXED(1), input_seq::or_code, MOUSECODE_BUTTON2_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON4,             "@P1 @Button4",            input_seq(KEYCODE_A, input_seq::or_code, JOYCODE_BUTTON4_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON5,             "@P1 @Button5",            input_seq(KEYCODE_S, input_seq::or_code, JOYCODE_BUTTON5_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON6,             "@P1 @Button6",            input_seq(KEYCODE_D, input_seq::or_code, JOYCODE_BUTTON6_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON7,             "@P1 @Button7",            input_seq(JOYCODE_BUTTON7_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON8,             "@P1 @Button8",            input_seq(JOYCODE_BUTTON8_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON9,             "@P1 @Button9",            input_seq(JOYCODE_BUTTON9_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON10,            "@P1 @Button10",           input_seq(JOYCODE_BUTTON10_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON11,            "@P1 @Button11",           input_seq(JOYCODE_BUTTON11_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON12,            "@P1 @Button12",           input_seq(JOYCODE_BUTTON12_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON13,            "@P1 @Button13",           input_seq(JOYCODE_BUTTON13_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON14,            "@P1 @Button14",           input_seq(JOYCODE_BUTTON14_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON15,            "@P1 @Button15",           input_seq(JOYCODE_BUTTON15_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON16,            "@P1 @Button16",           input_seq(JOYCODE_BUTTON16_INDEXED(1)) ) \
//#ifdef USE_COMBOKEY
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1,	3KICKS, 		"@P1 @3Kicks",				input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1,	3PUNCHES,		"@P1 @3Punches", 			input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1,	SPEC1,			"@P1 Special Atk1",			input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1,	SPEC2,			"@P1 Special Atk2",			input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1,	SPEC3,			"@P1 Special Atk3",			input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1,	AB, 			"@P1 @Button1 _+ @Button2",									input_seq(KEYCODE_Q) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1,	CD, 			"@P1 @Button3 _+ @Button4",									input_seq(KEYCODE_W) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1,	BC, 			"@P1 @Button2 _+ @Button3",									input_seq(KEYCODE_E) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1,	AC, 			"@P1 @Button1 _+ @Button3",									input_seq(KEYCODE_R) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1,	BD, 			"@P1 @Button2 _+ @Button4",									input_seq(KEYCODE_T) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1,	ABC,			"@P1 @Button1 _+ @Button2 _+ @Button3",						input_seq(KEYCODE_Y) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1,	BCD,			"@P1 @Button2 _+ @Button3 _+ @Button4",						input_seq(KEYCODE_U) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1,	ABCD,			"@P1 @Button1 _+ @Button2 _+ @Button3 _+ @Button4",			input_seq(KEYCODE_I) ) \
//#endif //USE_COMBOKEY

#ifdef USE_CUSTOM_BUTTON
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, CUSTOM1,			  "@P1 Custom 1",			input_seq(KEYCODE_S, input_seq::or_code, JOYCODE_BUTTON5_INDEXED(1)) ) \
	...
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, START,               "@P1 @Start",               input_seq(KEYCODE_1, input_seq::or_code, JOYCODE_START_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, SELECT,              "@P1 @Select",              input_seq(KEYCODE_5, input_seq::or_code, JOYCODE_SELECT_INDEXED(1)) ) \
...
#define CORE_INPUT_TYPES_P2 \
	...
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, JOYSTICK_UP,         "@P2 @Up",                  input_seq(KEYCODE_I, input_seq::or_code, JOYCODE_Y_UP_SWITCH_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, JOYSTICK_DOWN,       "@P2 @Down",                input_seq(KEYCODE_K, input_seq::or_code, JOYCODE_Y_DOWN_SWITCH_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, JOYSTICK_LEFT,       "@P2 @Left",                input_seq(KEYCODE_J, input_seq::or_code, JOYCODE_X_LEFT_SWITCH_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, JOYSTICK_RIGHT,      "@P2 @Right",               input_seq(KEYCODE_L, input_seq::or_code, JOYCODE_X_RIGHT_SWITCH_INDEXED(0)) ) \
	...
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON1,             "@P2 @Button1",            input_seq(KEYCODE_B, input_seq::or_code, JOYCODE_BUTTON1_INDEXED(0), input_seq::or_code, MOUSECODE_BUTTON1_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON2,             "@P2 @Button2",            input_seq(KEYCODE_N, input_seq::or_code, JOYCODE_BUTTON2_INDEXED(0), input_seq::or_code, MOUSECODE_BUTTON3_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON3,             "@P2 @Button3",            input_seq(KEYCODE_G, input_seq::or_code, JOYCODE_BUTTON3_INDEXED(0), input_seq::or_code, MOUSECODE_BUTTON2_INDEXED(1)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON4,             "@P2 @Button4",            input_seq(KEYCODE_H, input_seq::or_code, JOYCODE_BUTTON4_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON5,             "@P2 @Button5",            input_seq(JOYCODE_BUTTON5_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON6,             "@P2 @Button6",            input_seq(JOYCODE_BUTTON6_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON7,             "@P2 @Button7",            input_seq(JOYCODE_BUTTON7_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON8,             "@P2 @Button8",            input_seq(JOYCODE_BUTTON8_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON9,             "@P2 @Button9",            input_seq(JOYCODE_BUTTON9_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON10,            "@P2 @Button10",           input_seq(JOYCODE_BUTTON10_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON11,            "@P2 @Button11",           input_seq(JOYCODE_BUTTON11_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON12,            "@P2 @Button12",           input_seq(JOYCODE_BUTTON12_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON13,            "@P2 @Button13",           input_seq(JOYCODE_BUTTON13_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON14,            "@P2 @Button14",           input_seq(JOYCODE_BUTTON14_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON15,            "@P2 @Button15",           input_seq(JOYCODE_BUTTON15_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON16,            "@P2 @Button16",           input_seq(JOYCODE_BUTTON16_INDEXED(0)) ) \
//#ifdef USE_COMBOKEY
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER1,	3KICKS, 		"@P2 @3Kicks",				input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER1,	3PUNCHES,		"@P2 @3Punches", 			input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER1,	SPEC1,			"@P2 Special Atk1",			input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER1,	SPEC2,			"@P2 Special Atk2",			input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER1,	SPEC3,			"@P2 Special Atk3",			input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER1,	AB, 			"@P2 @Button1 _+ @Button2",								input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER1,	CD, 			"@P2 @Button3 _+ @Button4",								input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER1,	BC, 			"@P2 @Button2 _+ @Button3",								input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER1,	AC, 			"@P2 @Button1 _+ @Button3",								input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER1,	BD, 			"@P2 @Button2 _+ @Button4",								input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER1,	ABC,			"@P2 @Button1 _+ @Button2 _+ @Button3",					input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER1,	BCD,			"@P2 @Button2 _+ @Button3 _+ @Button4",					input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER1,	ABCD,			"@P2 @Button1 _+ @Button2 _+ @Button3 _+ @Button4",		input_seq() ) \
//#endif //USE_COMBOKEY
	...
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, START,               "@P2 @Start",               input_seq(KEYCODE_2, input_seq::or_code, JOYCODE_START_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, SELECT,              "@P2 @Select",              input_seq(KEYCODE_6, input_seq::or_code, JOYCODE_SELECT_INDEXED(0)) ) \
		CORE_INPUT_TYPES_END()
...
#define CORE_INPUT_TYPES_P3 \
	...
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON1,             "@P3 @Button1",            input_seq(KEYCODE_RCONTROL, input_seq::or_code, JOYCODE_BUTTON1_INDEXED(2), input_seq::or_code, GUNCODE_BUTTON1_INDEXED(2)) ) \
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON2,             "@P3 @Button2",            input_seq(KEYCODE_RSHIFT, input_seq::or_code, JOYCODE_BUTTON2_INDEXED(2), input_seq::or_code, GUNCODE_BUTTON2_INDEXED(2)) ) \
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON3,             "@P3 @Button3",            input_seq(KEYCODE_ENTER, input_seq::or_code, JOYCODE_BUTTON3_INDEXED(2)) ) \
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON4,             "@P3 @Button4",            input_seq(JOYCODE_BUTTON4_INDEXED(2)) ) \
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON5,             "@P3 @Button5",            input_seq(JOYCODE_BUTTON5_INDEXED(2)) ) \
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON6,             "@P3 @Button6",            input_seq(JOYCODE_BUTTON6_INDEXED(2)) ) \
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON7,             "@P3 @Button7",            input_seq(JOYCODE_BUTTON7_INDEXED(2)) ) \
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON8,             "@P3 @Button8",            input_seq(JOYCODE_BUTTON8_INDEXED(2)) ) \
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON9,             "@P3 @Button9",            input_seq(JOYCODE_BUTTON9_INDEXED(2)) ) \
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON10,            "@P3 @Button10",           input_seq(JOYCODE_BUTTON10_INDEXED(2)) ) \
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON11,            "@P3 @Button11",           input_seq(JOYCODE_BUTTON11_INDEXED(2)) ) \
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON12,            "@P3 @Button12",           input_seq(JOYCODE_BUTTON12_INDEXED(2)) ) \
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON13,            "@P3 @Button13",           input_seq(JOYCODE_BUTTON13_INDEXED(2)) ) \
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON14,            "@P3 @Button14",           input_seq(JOYCODE_BUTTON14_INDEXED(2)) ) \
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON15,            "@P3 @Button15",           input_seq(JOYCODE_BUTTON15_INDEXED(2)) ) \
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON16,            "@P3 @Button16",           input_seq(JOYCODE_BUTTON16_INDEXED(2)) ) \
#ifdef USE_CUSTOM_BUTTON
...
#define CORE_INPUT_TYPES_P4 \
	...
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, BUTTON1,             "@P4 @Button1",            input_seq(KEYCODE_0_PAD, input_seq::or_code, JOYCODE_BUTTON1_INDEXED(3)) ) \
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, BUTTON2,             "@P4 @Button2",            input_seq(KEYCODE_DEL_PAD, input_seq::or_code, JOYCODE_BUTTON2_INDEXED(3)) ) \
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, BUTTON3,             "@P4 @Button3",            input_seq(KEYCODE_ENTER_PAD, input_seq::or_code, JOYCODE_BUTTON3_INDEXED(3)) ) \
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, BUTTON4,             "@P4 @Button4",            input_seq(JOYCODE_BUTTON4_INDEXED(3)) ) \
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, BUTTON5,             "@P4 @Button5",            input_seq(JOYCODE_BUTTON5_INDEXED(3)) ) \
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, BUTTON6,             "@P4 @Button6",            input_seq(JOYCODE_BUTTON6_INDEXED(3)) ) \
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, BUTTON7,             "@P4 @Button7",            input_seq(JOYCODE_BUTTON7_INDEXED(3)) ) \
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, BUTTON8,             "@P4 @Button8",            input_seq(JOYCODE_BUTTON8_INDEXED(3)) ) \
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, BUTTON9,             "@P4 @Button9",            input_seq(JOYCODE_BUTTON9_INDEXED(3)) ) \
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, BUTTON10,            "@P4 @Button10",           input_seq(JOYCODE_BUTTON10_INDEXED(3)) ) \
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, BUTTON11,            "@P4 @Button11",           input_seq(JOYCODE_BUTTON11_INDEXED(3)) ) \
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, BUTTON12,            "@P4 @Button12",           input_seq(JOYCODE_BUTTON12_INDEXED(3)) ) \
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, BUTTON13,            "@P4 @Button13",           input_seq(JOYCODE_BUTTON13_INDEXED(3)) ) \
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, BUTTON14,            "@P4 @Button14",           input_seq(JOYCODE_BUTTON14_INDEXED(3)) ) \
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, BUTTON15,            "@P4 @Button15",           input_seq(JOYCODE_BUTTON15_INDEXED(3)) ) \
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, BUTTON16,            "@P4 @Button16",           input_seq(JOYCODE_BUTTON16_INDEXED(3)) ) \
#ifdef USE_CUSTOM_BUTTON
...
#define CORE_INPUT_TYPES_P5 \
	...
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, BUTTON1,             "@P5 @Button1",            input_seq(JOYCODE_BUTTON1_INDEXED(4)) ) \
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, BUTTON2,             "@P5 @Button2",            input_seq(JOYCODE_BUTTON2_INDEXED(4)) ) \
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, BUTTON3,             "@P5 @Button3",            input_seq(JOYCODE_BUTTON3_INDEXED(4)) ) \
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, BUTTON4,             "@P5 @Button4",            input_seq(JOYCODE_BUTTON4_INDEXED(4)) ) \
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, BUTTON5,             "@P5 @Button5",            input_seq(JOYCODE_BUTTON5_INDEXED(4)) ) \
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, BUTTON6,             "@P5 @Button6",            input_seq(JOYCODE_BUTTON6_INDEXED(4)) ) \
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, BUTTON7,             "@P5 @Button7",            input_seq(JOYCODE_BUTTON7_INDEXED(4)) ) \
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, BUTTON8,             "@P5 @Button8",            input_seq(JOYCODE_BUTTON8_INDEXED(4)) ) \
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, BUTTON9,             "@P5 @Button9",            input_seq(JOYCODE_BUTTON9_INDEXED(4)) ) \
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, BUTTON10,            "@P5 @Button10",           input_seq(JOYCODE_BUTTON10_INDEXED(4)) ) \
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, BUTTON11,            "@P5 @Button11",           input_seq(JOYCODE_BUTTON11_INDEXED(4)) ) \
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, BUTTON12,            "@P5 @Button12",           input_seq(JOYCODE_BUTTON12_INDEXED(4)) ) \
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, BUTTON13,            "@P5 @Button13",           input_seq(JOYCODE_BUTTON13_INDEXED(4)) ) \
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, BUTTON14,            "@P5 @Button14",           input_seq(JOYCODE_BUTTON14_INDEXED(4)) ) \
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, BUTTON15,            "@P5 @Button15",           input_seq(JOYCODE_BUTTON15_INDEXED(4)) ) \
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, BUTTON16,            "@P5 @Button16",           input_seq(JOYCODE_BUTTON16_INDEXED(4)) ) \
#ifdef USE_CUSTOM_BUTTON
...
#define CORE_INPUT_TYPES_P6 \
	...
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, BUTTON1,             "@P6 @Button1",            input_seq(JOYCODE_BUTTON1_INDEXED(5)) ) \
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, BUTTON2,             "@P6 @Button2",            input_seq(JOYCODE_BUTTON2_INDEXED(5)) ) \
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, BUTTON3,             "@P6 @Button3",            input_seq(JOYCODE_BUTTON3_INDEXED(5)) ) \
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, BUTTON4,             "@P6 @Button4",            input_seq(JOYCODE_BUTTON4_INDEXED(5)) ) \
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, BUTTON5,             "@P6 @Button5",            input_seq(JOYCODE_BUTTON5_INDEXED(5)) ) \
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, BUTTON6,             "@P6 @Button6",            input_seq(JOYCODE_BUTTON6_INDEXED(5)) ) \
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, BUTTON7,             "@P6 @Button7",            input_seq(JOYCODE_BUTTON7_INDEXED(5)) ) \
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, BUTTON8,             "@P6 @Button8",            input_seq(JOYCODE_BUTTON8_INDEXED(5)) ) \
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, BUTTON9,             "@P6 @Button9",            input_seq(JOYCODE_BUTTON9_INDEXED(5)) ) \
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, BUTTON10,            "@P6 @Button10",           input_seq(JOYCODE_BUTTON10_INDEXED(5)) ) \
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, BUTTON11,            "@P6 @Button11",           input_seq(JOYCODE_BUTTON11_INDEXED(5)) ) \
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, BUTTON12,            "@P6 @Button12",           input_seq(JOYCODE_BUTTON12_INDEXED(5)) ) \
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, BUTTON13,            "@P6 @Button13",           input_seq(JOYCODE_BUTTON13_INDEXED(5)) ) \
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, BUTTON14,            "@P6 @Button14",           input_seq(JOYCODE_BUTTON14_INDEXED(5)) ) \
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, BUTTON15,            "@P6 @Button15",           input_seq(JOYCODE_BUTTON15_INDEXED(5)) ) \
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, BUTTON16,            "@P6 @Button16",           input_seq(JOYCODE_BUTTON16_INDEXED(5)) ) \
#ifdef USE_CUSTOM_BUTTON
...
#define CORE_INPUT_TYPES_P7 \
	...
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, BUTTON1,             "@P7 @Button1",            input_seq(JOYCODE_BUTTON1_INDEXED(6)) ) \
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, BUTTON2,             "@P7 @Button2",            input_seq(JOYCODE_BUTTON2_INDEXED(6)) ) \
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, BUTTON3,             "@P7 @Button3",            input_seq(JOYCODE_BUTTON3_INDEXED(6)) ) \
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, BUTTON4,             "@P7 @Button4",            input_seq(JOYCODE_BUTTON4_INDEXED(6)) ) \
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, BUTTON5,             "@P7 @Button5",            input_seq(JOYCODE_BUTTON5_INDEXED(6)) ) \
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, BUTTON6,             "@P7 @Button6",            input_seq(JOYCODE_BUTTON6_INDEXED(6)) ) \
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, BUTTON7,             "@P7 @Button7",            input_seq(JOYCODE_BUTTON7_INDEXED(6)) ) \
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, BUTTON8,             "@P7 @Button8",            input_seq(JOYCODE_BUTTON8_INDEXED(6)) ) \
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, BUTTON9,             "@P7 @Button9",            input_seq(JOYCODE_BUTTON9_INDEXED(6)) ) \
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, BUTTON10,            "@P7 @Button10",           input_seq(JOYCODE_BUTTON10_INDEXED(6)) ) \
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, BUTTON11,            "@P7 @Button11",           input_seq(JOYCODE_BUTTON11_INDEXED(6)) ) \
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, BUTTON12,            "@P7 @Button12",           input_seq(JOYCODE_BUTTON12_INDEXED(6)) ) \
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, BUTTON13,            "@P7 @Button13",           input_seq(JOYCODE_BUTTON13_INDEXED(6)) ) \
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, BUTTON14,            "@P7 @Button14",           input_seq(JOYCODE_BUTTON14_INDEXED(6)) ) \
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, BUTTON15,            "@P7 @Button15",           input_seq(JOYCODE_BUTTON15_INDEXED(6)) ) \
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, BUTTON16,            "@P7 @Button16",           input_seq(JOYCODE_BUTTON16_INDEXED(6)) ) \
#ifdef USE_CUSTOM_BUTTON
...
#define CORE_INPUT_TYPES_P8 \
	...
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, BUTTON1,             "@P8 @Button1",            input_seq(JOYCODE_BUTTON1_INDEXED(7)) ) \
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, BUTTON2,             "@P8 @Button2",            input_seq(JOYCODE_BUTTON2_INDEXED(7)) ) \
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, BUTTON3,             "@P8 @Button3",            input_seq(JOYCODE_BUTTON3_INDEXED(7)) ) \
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, BUTTON4,             "@P8 @Button4",            input_seq(JOYCODE_BUTTON4_INDEXED(7)) ) \
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, BUTTON5,             "@P8 @Button5",            input_seq(JOYCODE_BUTTON5_INDEXED(7)) ) \
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, BUTTON6,             "@P8 @Button6",            input_seq(JOYCODE_BUTTON6_INDEXED(7)) ) \
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, BUTTON7,             "@P8 @Button7",            input_seq(JOYCODE_BUTTON7_INDEXED(7)) ) \
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, BUTTON8,             "@P8 @Button8",            input_seq(JOYCODE_BUTTON8_INDEXED(7)) ) \
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, BUTTON9,             "@P8 @Button9",            input_seq(JOYCODE_BUTTON9_INDEXED(7)) ) \
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, BUTTON10,            "@P8 @Button10",           input_seq(JOYCODE_BUTTON10_INDEXED(7)) ) \
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, BUTTON11,            "@P8 @Button11",           input_seq(JOYCODE_BUTTON11_INDEXED(7)) ) \
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, BUTTON12,            "@P8 @Button12",           input_seq(JOYCODE_BUTTON12_INDEXED(7)) ) \
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, BUTTON13,            "@P8 @Button13",           input_seq(JOYCODE_BUTTON13_INDEXED(7)) ) \
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, BUTTON14,            "@P8 @Button14",           input_seq(JOYCODE_BUTTON14_INDEXED(7)) ) \
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, BUTTON15,            "@P8 @Button15",           input_seq(JOYCODE_BUTTON15_INDEXED(7)) ) \
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, BUTTON16,            "@P8 @Button16",           input_seq(JOYCODE_BUTTON16_INDEXED(7)) ) \
#ifdef USE_CUSTOM_BUTTON
...
#define CORE_INPUT_TYPES_P9 \
	...
	INPUT_PORT_DIGITAL_TYPE( 9, PLAYER9, BUTTON1,             "@P9 @Button1",            input_seq(JOYCODE_BUTTON1_INDEXED(8)) ) \
	INPUT_PORT_DIGITAL_TYPE( 9, PLAYER9, BUTTON2,             "@P9 @Button2",            input_seq(JOYCODE_BUTTON2_INDEXED(8)) ) \
	INPUT_PORT_DIGITAL_TYPE( 9, PLAYER9, BUTTON3,             "@P9 @Button3",            input_seq(JOYCODE_BUTTON3_INDEXED(8)) ) \
	INPUT_PORT_DIGITAL_TYPE( 9, PLAYER9, BUTTON4,             "@P9 @Button4",            input_seq(JOYCODE_BUTTON4_INDEXED(8)) ) \
	INPUT_PORT_DIGITAL_TYPE( 9, PLAYER9, BUTTON5,             "@P9 @Button5",            input_seq(JOYCODE_BUTTON5_INDEXED(8)) ) \
	INPUT_PORT_DIGITAL_TYPE( 9, PLAYER9, BUTTON6,             "@P9 @Button6",            input_seq(JOYCODE_BUTTON6_INDEXED(8)) ) \
	INPUT_PORT_DIGITAL_TYPE( 9, PLAYER9, BUTTON7,             "@P9 @Button7",            input_seq(JOYCODE_BUTTON7_INDEXED(8)) ) \
	INPUT_PORT_DIGITAL_TYPE( 9, PLAYER9, BUTTON8,             "@P9 @Button8",            input_seq(JOYCODE_BUTTON8_INDEXED(8)) ) \
	INPUT_PORT_DIGITAL_TYPE( 9, PLAYER9, BUTTON9,             "@P9 @Button9",            input_seq(JOYCODE_BUTTON9_INDEXED(8)) ) \
	INPUT_PORT_DIGITAL_TYPE( 9, PLAYER9, BUTTON10,            "@P9 @Button10",           input_seq(JOYCODE_BUTTON10_INDEXED(8)) ) \
	INPUT_PORT_DIGITAL_TYPE( 9, PLAYER9, BUTTON11,            "@P9 @Button11",           input_seq(JOYCODE_BUTTON11_INDEXED(8)) ) \
	INPUT_PORT_DIGITAL_TYPE( 9, PLAYER9, BUTTON12,            "@P9 @Button12",           input_seq(JOYCODE_BUTTON12_INDEXED(8)) ) \
	INPUT_PORT_DIGITAL_TYPE( 9, PLAYER9, BUTTON13,            "@P9 @Button13",           input_seq(JOYCODE_BUTTON13_INDEXED(8)) ) \
	INPUT_PORT_DIGITAL_TYPE( 9, PLAYER9, BUTTON14,            "@P9 @Button14",           input_seq(JOYCODE_BUTTON14_INDEXED(8)) ) \
	INPUT_PORT_DIGITAL_TYPE( 9, PLAYER9, BUTTON15,            "@P9 @Button15",           input_seq(JOYCODE_BUTTON15_INDEXED(8)) ) \
	INPUT_PORT_DIGITAL_TYPE( 9, PLAYER9, BUTTON16,            "@P9 @Button16",           input_seq(JOYCODE_BUTTON16_INDEXED(8)) ) \
...
#define CORE_INPUT_TYPES_P10 \
	...
	INPUT_PORT_DIGITAL_TYPE( 10, PLAYER10, BUTTON1,             "@P10 @Button1",            input_seq(JOYCODE_BUTTON1_INDEXED(9)) ) \
	INPUT_PORT_DIGITAL_TYPE( 10, PLAYER10, BUTTON2,             "@P10 @Button2",            input_seq(JOYCODE_BUTTON2_INDEXED(9)) ) \
	INPUT_PORT_DIGITAL_TYPE( 10, PLAYER10, BUTTON3,             "@P10 @Button3",            input_seq(JOYCODE_BUTTON3_INDEXED(9)) ) \
	INPUT_PORT_DIGITAL_TYPE( 10, PLAYER10, BUTTON4,             "@P10 @Button4",            input_seq(JOYCODE_BUTTON4_INDEXED(9)) ) \
	INPUT_PORT_DIGITAL_TYPE( 10, PLAYER10, BUTTON5,             "@P10 @Button5",            input_seq(JOYCODE_BUTTON5_INDEXED(9)) ) \
	INPUT_PORT_DIGITAL_TYPE( 10, PLAYER10, BUTTON6,             "@P10 @Button6",            input_seq(JOYCODE_BUTTON6_INDEXED(9)) ) \
	INPUT_PORT_DIGITAL_TYPE( 10, PLAYER10, BUTTON7,             "@P10 @Button7",            input_seq(JOYCODE_BUTTON7_INDEXED(9)) ) \
	INPUT_PORT_DIGITAL_TYPE( 10, PLAYER10, BUTTON8,             "@P10 @Button8",            input_seq(JOYCODE_BUTTON8_INDEXED(9)) ) \
	INPUT_PORT_DIGITAL_TYPE( 10, PLAYER10, BUTTON9,             "@P10 @Button9",            input_seq(JOYCODE_BUTTON9_INDEXED(9)) ) \
	INPUT_PORT_DIGITAL_TYPE( 10, PLAYER10, BUTTON10,            "@P10 @Button10",           input_seq(JOYCODE_BUTTON10_INDEXED(9)) ) \
	INPUT_PORT_DIGITAL_TYPE( 10, PLAYER10, BUTTON11,            "@P10 @Button11",           input_seq(JOYCODE_BUTTON11_INDEXED(9)) ) \
	INPUT_PORT_DIGITAL_TYPE( 10, PLAYER10, BUTTON12,            "@P10 @Button12",           input_seq(JOYCODE_BUTTON12_INDEXED(9)) ) \
	INPUT_PORT_DIGITAL_TYPE( 10, PLAYER10, BUTTON13,            "@P10 @Button13",           input_seq(JOYCODE_BUTTON13_INDEXED(9)) ) \
	INPUT_PORT_DIGITAL_TYPE( 10, PLAYER10, BUTTON14,            "@P10 @Button14",           input_seq(JOYCODE_BUTTON14_INDEXED(9)) ) \
	INPUT_PORT_DIGITAL_TYPE( 10, PLAYER10, BUTTON15,            "@P10 @Button15",           input_seq(JOYCODE_BUTTON15_INDEXED(9)) ) \
	INPUT_PORT_DIGITAL_TYPE( 10, PLAYER10, BUTTON16,            "@P10 @Button16",           input_seq(JOYCODE_BUTTON16_INDEXED(9)) ) \
...
#define CORE_INPUT_TYPES_START \
	...
	INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START1,              "@P1 @Start",         input_seq(KEYCODE_1, input_seq::or_code, JOYCODE_START_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START2,              "@P2 @Start",        input_seq(KEYCODE_2, input_seq::or_code, JOYCODE_START_INDEXED(1) , input_seq::or_code, JOYCODE_BUTTON9_INDEXED(0)) ) \
	INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START3,              "@P3 @Start",        input_seq(KEYCODE_3, input_seq::or_code, JOYCODE_START_INDEXED(2)) ) \
	INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START4,              "@P4 @Start",        input_seq(KEYCODE_4, input_seq::or_code, JOYCODE_START_INDEXED(3)) ) \
	INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START5,              "@P5 @Start",        input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START6,              "@P6 @Start",        input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START7,              "@P7 @Start",        input_seq() ) \
	INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START8,              "@P8 @Start",        input_seq() ) \
		CORE_INPUT_TYPES_END()
...
#define CORE_INPUT_TYPES_UI \
		...
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_RECORD_MNG,       "Record MNG",             input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_RECORD_AVI,       "Record AVI",             input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_RECORD_COM_AVI,   "Record Compressed AVI ",          input_seq(KEYCODE_F12, KEYCODE_LSHIFT, KEYCODE_LCONTROL) ) \
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_TOGGLE_CHEAT,     "Toggle Cheat",           input_seq(KEYCODE_F6, input_seq::not_code, KEYCODE_LSHIFT) )\
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_TOGGLE_CHEAT_CONFIG,     "Toggle Cheat Config",           input_seq(KEYCODE_F6, KEYCODE_LSHIFT) )\
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_TOGGLE_AUTOFIRE,  "Toggle Autofire",        input_seq() )\
		...
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_SAVE_STATE,       "Save State",             input_seq(KEYCODE_F7, input_seq::not_code,  KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_LOAD_STATE,       "Load State",             input_seq(KEYCODE_F7, KEYCODE_LSHIFT) ) \
	...
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_SHOW_COMMAND,  	  "Show Command",    		input_seq(KEYCODE_F5, input_seq::not_code, KEYCODE_LSHIFT) )\
