...
#define CORE_INPUT_TYPES_P1 \
		...
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICK_UP,         "@P1 위 @Up",              input_seq(KEYCODE_UP, input_seq::or_code, JOYCODE_Y_UP_SWITCH_INDEXED(1)) ) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICK_DOWN,       "@P1 아래 @Down",          input_seq(KEYCODE_DOWN, input_seq::or_code, JOYCODE_Y_DOWN_SWITCH_INDEXED(1)) ) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICK_LEFT,       "@P1 왼쪽 @Left",          input_seq(KEYCODE_LEFT, input_seq::or_code, JOYCODE_X_LEFT_SWITCH_INDEXED(1)) ) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICK_RIGHT,      "@P1 오른쪽 @Right",       input_seq(KEYCODE_RIGHT, input_seq::or_code, JOYCODE_X_RIGHT_SWITCH_INDEXED(1)) ) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICKRIGHT_UP,    "@P1 Right Stick/Up",      input_seq( )) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICKRIGHT_DOWN,  "@P1 Right Stick/Down",    input_seq( )) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICKRIGHT_LEFT,  "@P1 Right Stick/Left",    input_seq( )) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICKRIGHT_RIGHT, "@P1 Right Stick/Right",   input_seq( )) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICKLEFT_UP,     "@P1 Left Stick/Up",       input_seq( )) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICKLEFT_DOWN,   "@P1 Left Stick/Down",     input_seq( )) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICKLEFT_LEFT,   "@P1 Left Stick/Left",     input_seq( )) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICKLEFT_RIGHT,  "@P1 Left Stick/Right",    input_seq( )) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON1,             "@P1 버튼 @Button1",            input_seq(KEYCODE_Z, input_seq::or_code, JOYCODE_BUTTON1_INDEXED(1)) ) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON2,             "@P1 버튼 @Button2",            input_seq(KEYCODE_X, input_seq::or_code, JOYCODE_BUTTON2_INDEXED(1)) ) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON3,             "@P1 버튼 @Button3",            input_seq(KEYCODE_C, input_seq::or_code, JOYCODE_BUTTON3_INDEXED(1)) ) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON4,             "@P1 버튼 @Button4",            input_seq(KEYCODE_A, input_seq::or_code, JOYCODE_BUTTON4_INDEXED(1)) ) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON5,             "@P1 버튼 @Button5",            input_seq(KEYCODE_S, input_seq::or_code, JOYCODE_BUTTON5_INDEXED(1)) ) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON6,             "@P1 버튼 @Button6",            input_seq(KEYCODE_D, input_seq::or_code, JOYCODE_BUTTON6_INDEXED(1)) ) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON7,             "@P1 버튼 @Button7",            input_seq( ))\
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON8,             "@P1 버튼 @Button8",            input_seq( ))\
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON9,             "@P1 버튼 9",             input_seq( ))\
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON10,            "@P1 버튼 10",            input_seq( ))\
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON11,            "@P1 버튼 11",            input_seq( ))\
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON12,            "@P1 버튼 12",            input_seq( ))\
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON13,            "@P1 버튼 13",            input_seq( ))\
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON14,            "@P1 버튼 14",            input_seq( ))\
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON15,            "@P1 버튼 15",            input_seq( ))\
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, BUTTON16,            "@P1 버튼 16",            input_seq( ))\
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, START,               "@P1 게임 시작 @Start",               input_seq(KEYCODE_1, input_seq::or_code, JOYCODE_START_INDEXED(1)) ) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, SELECT,              "@P1 게임 선택 @Select",                  input_seq(KEYCODE_5, input_seq::or_code, JOYCODE_SELECT_INDEXED(1)) ) \
...
#define CORE_INPUT_TYPES_GAMBLE \
		...
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, GAMBLE_SERVICE,      "서비스",                input_seq(KEYCODE_9) ) \
...
#define CORE_INPUT_TYPES_POKER \
		...
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, POKER_HOLD1,         "홀드 1",                 input_seq(KEYCODE_Z) ) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, POKER_HOLD2,         "홀드 2",                 input_seq(KEYCODE_X) ) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, POKER_HOLD3,         "홀드 3",                 input_seq(KEYCODE_C) ) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, POKER_HOLD4,         "홀드 4",                 input_seq(KEYCODE_V) ) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, POKER_HOLD5,         "홀드 5",                 input_seq(KEYCODE_B) ) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, POKER_CANCEL,        "취소",                 input_seq(KEYCODE_N) ) \
		INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, POKER_BET,           "베팅",                    input_seq(KEYCODE_1) ) \
		CORE_INPUT_TYPES_END()
...
#define CORE_INPUT_TYPES_P2 \
		...
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, JOYSTICK_UP,         "@P2 위 @Up",              input_seq(KEYCODE_I, input_seq::or_code, JOYCODE_Y_UP_SWITCH_INDEXED(2)) ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, JOYSTICK_DOWN,       "@P2 아래 @Down",          input_seq(KEYCODE_K, input_seq::or_code, JOYCODE_Y_DOWN_SWITCH_INDEXED(2)) ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, JOYSTICK_LEFT,       "@P2 왼쪽 @Left",          input_seq(KEYCODE_J, input_seq::or_code, JOYCODE_X_LEFT_SWITCH_INDEXED(2)) ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, JOYSTICK_RIGHT,      "@P2 오른쪽 @Right",       input_seq(KEYCODE_L, input_seq::or_code, JOYCODE_X_RIGHT_SWITCH_INDEXED(2)) ) \
		...
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON1,             "@P2 버튼 @Button1",            input_seq(KEYCODE_B, input_seq::or_code, JOYCODE_BUTTON1_INDEXED(2)) ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON2,             "@P2 버튼 @Button2",            input_seq(KEYCODE_N, input_seq::or_code, JOYCODE_BUTTON2_INDEXED(2)) ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON3,             "@P2 버튼 @Button3",            input_seq(KEYCODE_G, input_seq::or_code, JOYCODE_BUTTON3_INDEXED(2)) ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON4,             "@P2 버튼 @Button4",            input_seq(KEYCODE_H, input_seq::or_code, JOYCODE_BUTTON4_INDEXED(2)) ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON5,             "@P2 버튼 @Button5",            input_seq(JOYCODE_BUTTON5_INDEXED(2)) ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON6,             "@P2 버튼 @Button6",            input_seq(JOYCODE_BUTTON6_INDEXED(2)) ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON7,             "@P2 버튼 @Button7",            input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON8,             "@P2 버튼 @Button8",            input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON9,             "@P2 버튼 9",             input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON10,            "@P2 버튼 10",            input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON11,            "@P2 버튼 11",            input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON12,            "@P2 버튼 12",            input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON13,            "@P2 버튼 13",            input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON14,            "@P2 버튼 14",            input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON15,            "@P2 버튼 15",            input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, BUTTON16,            "@P2 버튼 16",            input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, START,               "@P2 게임 시작 @Start",           input_seq(KEYCODE_2, input_seq::or_code, JOYCODE_START_INDEXED(2)) ) \
		INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, SELECT,              "@P2 게임 선택 @Select",              input_seq(KEYCODE_6, input_seq::or_code, JOYCODE_SELECT_INDEXED(2)) ) \
		CORE_INPUT_TYPES_END()
...
#define CORE_INPUT_TYPES_P3 \
		...
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, JOYSTICK_UP,         "@P3 위 @Up",                  input_seq(KEYCODE_I, input_seq::or_code, JOYCODE_Y_UP_SWITCH_INDEXED(3)) ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, JOYSTICK_DOWN,       "@P3 아래 @Down",                input_seq(KEYCODE_K, input_seq::or_code, JOYCODE_Y_DOWN_SWITCH_INDEXED(3)) ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, JOYSTICK_LEFT,       "@P3 왼쪽 @Left",                input_seq(KEYCODE_J, input_seq::or_code, JOYCODE_X_LEFT_SWITCH_INDEXED(3)) ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, JOYSTICK_RIGHT,      "@P3 오른쪽 @Right",               input_seq(KEYCODE_L, input_seq::or_code, JOYCODE_X_RIGHT_SWITCH_INDEXED(3)) ) \
		...
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON1,             "@P3 버튼 @Button1",            input_seq(KEYCODE_RCONTROL, input_seq::or_code, JOYCODE_BUTTON1_INDEXED(3)) ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON2,             "@P3 버튼 @Button2",            input_seq(KEYCODE_RSHIFT, input_seq::or_code, JOYCODE_BUTTON2_INDEXED(3)) ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON3,             "@P3 버튼 @Button3",            input_seq(KEYCODE_ENTER, input_seq::or_code, JOYCODE_BUTTON3_INDEXED(3)) ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON4,             "@P3 버튼 @Button4",            input_seq(JOYCODE_BUTTON4_INDEXED(3)) ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON5,             "@P3 버튼 @Button5",            input_seq(JOYCODE_BUTTON5_INDEXED(3)) ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON6,             "@P3 버튼 @Button6",            input_seq(JOYCODE_BUTTON6_INDEXED(3)) ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON7,             "@P3 버튼 @Button7",            input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON8,             "@P3 버튼 @Button8",            input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON9,             "@P3 버튼 9",            input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON10,            "@P3 버튼 10",           input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON11,            "@P3 버튼 11",           input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON12,            "@P3 버튼 12",           input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON13,            "@P3 버튼 13",           input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON14,            "@P3 버튼 14",           input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON15,            "@P3 버튼 15",           input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, BUTTON16,            "@P3 버튼 16",           input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, START,               "@P3 게임 시작 @Start",               input_seq(KEYCODE_3, input_seq::or_code, JOYCODE_START_INDEXED(3)) ) \
		INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, SELECT,              "@P3 게임 선택 @Select",              input_seq(KEYCODE_7, input_seq::or_code, JOYCODE_SELECT_INDEXED(3)) ) \
		CORE_INPUT_TYPES_END()
...
#define CORE_INPUT_TYPES_START \
		...
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START1,              "@P1 게임시작 @Start",         input_seq(KEYCODE_1, input_seq::or_code, JOYCODE_START_INDEXED(1)) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START2,              "@P2 게임시작 @Start",        input_seq(KEYCODE_2, input_seq::or_code, JOYCODE_START_INDEXED(2)) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START3,              "@P3 게임시작 @Start",        input_seq(KEYCODE_3, input_seq::or_code, JOYCODE_START_INDEXED(3)) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START4,              "@P4 게임시작 @Start",        input_seq(KEYCODE_4, input_seq::or_code, JOYCODE_START_INDEXED(4)) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START5,              "@P5 게임시작 @Start",        input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START6,              "@P6 게임시작 @Start",        input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START7,              "@P7 게임시작 @Start",        input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   START8,              "@P8 게임시작 @Start",        input_seq() ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_COIN \
		CORE_INPUT_TYPES_BEGIN(coin) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   COIN1,               "@P1 동전",                 input_seq(KEYCODE_5, input_seq::or_code, JOYCODE_SELECT_INDEXED(1)) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   COIN2,               "@P2 동전",                 input_seq(KEYCODE_6, input_seq::or_code, JOYCODE_SELECT_INDEXED(2)) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   COIN3,               "@P3 동전",                 input_seq(KEYCODE_7, input_seq::or_code, JOYCODE_SELECT_INDEXED(3)) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   COIN4,               "@P4 동전",                 input_seq(KEYCODE_8, input_seq::or_code, JOYCODE_SELECT_INDEXED(4)) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   COIN5,               "@P5 동전",                 input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   COIN6,               "@P6 동전",                 input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   COIN7,               "@P7 동전",                 input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   COIN8,               "@P8 동전",                 input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   COIN9,               "P9 동전",                 input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   COIN10,              "P10 동전",                input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   COIN11,              "P11 동전",                input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   COIN12,              "P12 동전",                input_seq() ) \
...
#define CORE_INPUT_TYPES_SERVICE \
		...
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   SERVICE1,            "서비스 1",              input_seq(KEYCODE_9) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   SERVICE2,            "서비스 2",              input_seq(KEYCODE_0) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   SERVICE3,            "서비스 3",              input_seq(KEYCODE_MINUS) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   SERVICE4,            "서비스 4",              input_seq(KEYCODE_EQUALS) ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_TILT \
		CORE_INPUT_TYPES_BEGIN(tilt) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   TILT1,               "틸트 1",                 input_seq(KEYCODE_T) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   TILT2,               "틸트 2",                 input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   TILT3,               "틸트 3",                 input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   TILT4,               "틸트 4",                 input_seq() ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_OTHER \
		CORE_INPUT_TYPES_BEGIN(other) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   POWER_ON,            "파워 켬",               input_seq(KEYCODE_F1) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   POWER_OFF,           "파워 끔",              input_seq(KEYCODE_F2) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   SERVICE,             "서비스",                input_seq(KEYCODE_F2) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   TILT,                "틸트",                   input_seq(KEYCODE_T) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   INTERLOCK,           "도어 인터락",         input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   MEMORY_RESET,        "메모리 리셋",           input_seq(KEYCODE_F1) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   VOLUME_DOWN,         "볼륨 다운",            input_seq(KEYCODE_MINUS) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   VOLUME_UP,           "볼륨 업",              input_seq(KEYCODE_EQUALS) ) \
		CORE_INPUT_TYPES_END()
...
#define CORE_INPUT_TYPES_PADDLE \
		...
		INPUT_PORT_ANALOG_TYPE(  1, PLAYER1, PADDLE,              "패들",                 input_seq(JOYCODE_X_INDEXED(0), input_seq::or_code, MOUSECODE_X_INDEXED(0)), input_seq(KEYCODE_LEFT), input_seq(KEYCODE_RIGHT) ) \
		INPUT_PORT_ANALOG_TYPE(  2, PLAYER2, PADDLE,              "패들 2",               input_seq(JOYCODE_X_INDEXED(1), input_seq::or_code, MOUSECODE_X_INDEXED(1)), input_seq(KEYCODE_D), input_seq(KEYCODE_G) ) \
		INPUT_PORT_ANALOG_TYPE(  3, PLAYER3, PADDLE,              "패들 3",               input_seq(JOYCODE_X_INDEXED(2), input_seq::or_code, MOUSECODE_X_INDEXED(2)), input_seq(KEYCODE_J), input_seq(KEYCODE_L) ) \
		INPUT_PORT_ANALOG_TYPE(  4, PLAYER4, PADDLE,              "패들 4",               input_seq(JOYCODE_X_INDEXED(3), input_seq::or_code, MOUSECODE_X_INDEXED(3)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  5, PLAYER5, PADDLE,              "패들 5",               input_seq(JOYCODE_X_INDEXED(4), input_seq::or_code, MOUSECODE_X_INDEXED(4)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  6, PLAYER6, PADDLE,              "패들 6",               input_seq(JOYCODE_X_INDEXED(5), input_seq::or_code, MOUSECODE_X_INDEXED(5)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  7, PLAYER7, PADDLE,              "패들 7",               input_seq(JOYCODE_X_INDEXED(6), input_seq::or_code, MOUSECODE_X_INDEXED(6)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  8, PLAYER8, PADDLE,              "패들 8",               input_seq(JOYCODE_X_INDEXED(7), input_seq::or_code, MOUSECODE_X_INDEXED(7)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, PADDLE,              "패들 9",               input_seq(JOYCODE_X_INDEXED(8), input_seq::or_code, MOUSECODE_X_INDEXED(8)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, PADDLE,             "패들 10",              input_seq(JOYCODE_X_INDEXED(9), input_seq::or_code, MOUSECODE_X_INDEXED(9)), input_seq(), input_seq() ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_PADDLE_V \
		CORE_INPUT_TYPES_BEGIN(paddle_v) \
		INPUT_PORT_ANALOG_TYPE(  1, PLAYER1, PADDLE_V,            "패들 V",               input_seq(JOYCODE_Y_INDEXED(0), input_seq::or_code, MOUSECODE_Y_INDEXED(0)), input_seq(KEYCODE_UP), input_seq(KEYCODE_DOWN) ) \
		INPUT_PORT_ANALOG_TYPE(  2, PLAYER2, PADDLE_V,            "패들 V 2",             input_seq(JOYCODE_Y_INDEXED(1), input_seq::or_code, MOUSECODE_Y_INDEXED(1)), input_seq(KEYCODE_R), input_seq(KEYCODE_F) ) \
		INPUT_PORT_ANALOG_TYPE(  3, PLAYER3, PADDLE_V,            "패들 V 3",             input_seq(JOYCODE_Y_INDEXED(2), input_seq::or_code, MOUSECODE_Y_INDEXED(2)), input_seq(KEYCODE_I), input_seq(KEYCODE_K) ) \
		INPUT_PORT_ANALOG_TYPE(  4, PLAYER4, PADDLE_V,            "패들 V 4",             input_seq(JOYCODE_Y_INDEXED(3), input_seq::or_code, MOUSECODE_Y_INDEXED(3)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  5, PLAYER5, PADDLE_V,            "패들 V 5",             input_seq(JOYCODE_Y_INDEXED(4), input_seq::or_code, MOUSECODE_Y_INDEXED(4)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  6, PLAYER6, PADDLE_V,            "패들 V 6",             input_seq(JOYCODE_Y_INDEXED(5), input_seq::or_code, MOUSECODE_Y_INDEXED(5)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  7, PLAYER7, PADDLE_V,            "패들 V 7",             input_seq(JOYCODE_Y_INDEXED(6), input_seq::or_code, MOUSECODE_Y_INDEXED(6)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  8, PLAYER8, PADDLE_V,            "패들 V 8",             input_seq(JOYCODE_Y_INDEXED(7), input_seq::or_code, MOUSECODE_Y_INDEXED(7)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, PADDLE_V,            "패들 V 9",             input_seq(JOYCODE_Y_INDEXED(8), input_seq::or_code, MOUSECODE_Y_INDEXED(8)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, PADDLE_V,            "패들 V 10",           input_seq(JOYCODE_Y_INDEXED(9), input_seq::or_code, MOUSECODE_Y_INDEXED(9)), input_seq(), input_seq() ) \
		CORE_INPUT_TYPES_END()
...
#define CORE_INPUT_TYPES_DIAL \
		...
		INPUT_PORT_ANALOG_TYPE(  1, PLAYER1, DIAL,                "다이얼",                   input_seq(MOUSECODE_X_INDEXED(0), input_seq::or_code, JOYCODE_X_INDEXED(0)), input_seq(KEYCODE_LEFT), input_seq(KEYCODE_RIGHT) ) \
		INPUT_PORT_ANALOG_TYPE(  2, PLAYER2, DIAL,                "다이얼 2",                 input_seq(MOUSECODE_X_INDEXED(1), input_seq::or_code, JOYCODE_X_INDEXED(1)), input_seq(KEYCODE_D), input_seq(KEYCODE_G) ) \
		INPUT_PORT_ANALOG_TYPE(  3, PLAYER3, DIAL,                "다이얼 3",                 input_seq(MOUSECODE_X_INDEXED(2), input_seq::or_code, JOYCODE_X_INDEXED(2)), input_seq(KEYCODE_J), input_seq(KEYCODE_L) ) \
		INPUT_PORT_ANALOG_TYPE(  4, PLAYER4, DIAL,                "다이얼 4",                 input_seq(MOUSECODE_X_INDEXED(3), input_seq::or_code, JOYCODE_X_INDEXED(3)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  5, PLAYER5, DIAL,                "다이얼 5",                 input_seq(MOUSECODE_X_INDEXED(4), input_seq::or_code, JOYCODE_X_INDEXED(4)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  6, PLAYER6, DIAL,                "다이얼 6",                 input_seq(MOUSECODE_X_INDEXED(5), input_seq::or_code, JOYCODE_X_INDEXED(5)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  7, PLAYER7, DIAL,                "다이얼 7",                 input_seq(MOUSECODE_X_INDEXED(6), input_seq::or_code, JOYCODE_X_INDEXED(6)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  8, PLAYER8, DIAL,                "다이얼 8",                 input_seq(MOUSECODE_X_INDEXED(7), input_seq::or_code, JOYCODE_X_INDEXED(7)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, DIAL,                "다이얼 9",                 input_seq(MOUSECODE_X_INDEXED(8), input_seq::or_code, JOYCODE_X_INDEXED(8)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, DIAL,               "다이얼 10",                input_seq(MOUSECODE_X_INDEXED(9), input_seq::or_code, JOYCODE_X_INDEXED(9)), input_seq(), input_seq() ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_DIAL_V \
		CORE_INPUT_TYPES_BEGIN(dial_v) \
		INPUT_PORT_ANALOG_TYPE(  1, PLAYER1, DIAL_V,              "다이얼 V",                 input_seq(MOUSECODE_Y_INDEXED(0), input_seq::or_code, JOYCODE_Y_INDEXED(0)), input_seq(KEYCODE_UP), input_seq(KEYCODE_DOWN) ) \
		INPUT_PORT_ANALOG_TYPE(  2, PLAYER2, DIAL_V,              "다이얼 V 2",               input_seq(MOUSECODE_Y_INDEXED(1), input_seq::or_code, JOYCODE_Y_INDEXED(1)), input_seq(KEYCODE_R), input_seq(KEYCODE_F) ) \
		INPUT_PORT_ANALOG_TYPE(  3, PLAYER3, DIAL_V,              "다이얼 V 3",               input_seq(MOUSECODE_Y_INDEXED(2), input_seq::or_code, JOYCODE_Y_INDEXED(2)), input_seq(KEYCODE_I), input_seq(KEYCODE_K) ) \
		INPUT_PORT_ANALOG_TYPE(  4, PLAYER4, DIAL_V,              "다이얼 V 4",               input_seq(MOUSECODE_Y_INDEXED(3), input_seq::or_code, JOYCODE_Y_INDEXED(3)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  5, PLAYER5, DIAL_V,              "다이얼 V 5",               input_seq(MOUSECODE_Y_INDEXED(4), input_seq::or_code, JOYCODE_Y_INDEXED(4)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  6, PLAYER6, DIAL_V,              "다이얼 V 6",               input_seq(MOUSECODE_Y_INDEXED(5), input_seq::or_code, JOYCODE_Y_INDEXED(5)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  7, PLAYER7, DIAL_V,              "다이얼 V 7",               input_seq(MOUSECODE_Y_INDEXED(6), input_seq::or_code, JOYCODE_Y_INDEXED(6)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  8, PLAYER8, DIAL_V,              "다이얼 V 8",               input_seq(MOUSECODE_Y_INDEXED(7), input_seq::or_code, JOYCODE_Y_INDEXED(7)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, DIAL_V,              "다이얼 V 9",               input_seq(MOUSECODE_Y_INDEXED(8), input_seq::or_code, JOYCODE_Y_INDEXED(8)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, DIAL_V,             "다이얼 V 10",              input_seq(MOUSECODE_Y_INDEXED(9), input_seq::or_code, JOYCODE_Y_INDEXED(9)), input_seq(), input_seq() ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_TRACKBALL_X \
		CORE_INPUT_TYPES_BEGIN(trackball_x) \
		INPUT_PORT_ANALOG_TYPE(  1, PLAYER1, TRACKBALL_X,         "트랙볼 X",                input_seq(MOUSECODE_X_INDEXED(0), input_seq::or_code, JOYCODE_X_INDEXED(0)), input_seq(KEYCODE_LEFT), input_seq(KEYCODE_RIGHT) ) \
		INPUT_PORT_ANALOG_TYPE(  2, PLAYER2, TRACKBALL_X,         "트랙볼 X 2",              input_seq(MOUSECODE_X_INDEXED(1), input_seq::or_code, JOYCODE_X_INDEXED(1)), input_seq(KEYCODE_D), input_seq(KEYCODE_G) ) \
		INPUT_PORT_ANALOG_TYPE(  3, PLAYER3, TRACKBALL_X,         "트랙볼 X 3",              input_seq(MOUSECODE_X_INDEXED(2), input_seq::or_code, JOYCODE_X_INDEXED(2)), input_seq(KEYCODE_J), input_seq(KEYCODE_L) ) \
		INPUT_PORT_ANALOG_TYPE(  4, PLAYER4, TRACKBALL_X,         "트랙볼 X 4",              input_seq(MOUSECODE_X_INDEXED(3), input_seq::or_code, JOYCODE_X_INDEXED(3)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  5, PLAYER5, TRACKBALL_X,         "트랙볼 X 5",              input_seq(MOUSECODE_X_INDEXED(4), input_seq::or_code, JOYCODE_X_INDEXED(4)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  6, PLAYER6, TRACKBALL_X,         "트랙볼 X 6",              input_seq(MOUSECODE_X_INDEXED(5), input_seq::or_code, JOYCODE_X_INDEXED(5)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  7, PLAYER7, TRACKBALL_X,         "트랙볼 X 7",              input_seq(MOUSECODE_X_INDEXED(6), input_seq::or_code, JOYCODE_X_INDEXED(6)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  8, PLAYER8, TRACKBALL_X,         "트랙볼 X 8",              input_seq(MOUSECODE_X_INDEXED(7), input_seq::or_code, JOYCODE_X_INDEXED(7)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, TRACKBALL_X,         "트랙볼 X 9",              input_seq(MOUSECODE_X_INDEXED(8), input_seq::or_code, JOYCODE_X_INDEXED(8)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, TRACKBALL_X,        "트랙볼 X 10",             input_seq(MOUSECODE_X_INDEXED(9), input_seq::or_code, JOYCODE_X_INDEXED(9)), input_seq(), input_seq() ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_TRACKBALL_Y \
		CORE_INPUT_TYPES_BEGIN(trackball_y) \
		INPUT_PORT_ANALOG_TYPE(  1, PLAYER1, TRACKBALL_Y,         "트랙볼 Y",                input_seq(MOUSECODE_Y_INDEXED(0), input_seq::or_code, JOYCODE_Y_INDEXED(0)), input_seq(KEYCODE_UP), input_seq(KEYCODE_DOWN) ) \
		INPUT_PORT_ANALOG_TYPE(  2, PLAYER2, TRACKBALL_Y,         "트랙볼 Y 2",              input_seq(MOUSECODE_Y_INDEXED(1), input_seq::or_code, JOYCODE_Y_INDEXED(1)), input_seq(KEYCODE_R), input_seq(KEYCODE_F) ) \
		INPUT_PORT_ANALOG_TYPE(  3, PLAYER3, TRACKBALL_Y,         "트랙볼 Y 3",              input_seq(MOUSECODE_Y_INDEXED(2), input_seq::or_code, JOYCODE_Y_INDEXED(2)), input_seq(KEYCODE_I), input_seq(KEYCODE_K) ) \
		INPUT_PORT_ANALOG_TYPE(  4, PLAYER4, TRACKBALL_Y,         "트랙볼 Y 4",              input_seq(MOUSECODE_Y_INDEXED(3), input_seq::or_code, JOYCODE_Y_INDEXED(3)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  5, PLAYER5, TRACKBALL_Y,         "트랙볼 Y 5",              input_seq(MOUSECODE_Y_INDEXED(4), input_seq::or_code, JOYCODE_Y_INDEXED(4)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  6, PLAYER6, TRACKBALL_Y,         "트랙볼 Y 6",              input_seq(MOUSECODE_Y_INDEXED(5), input_seq::or_code, JOYCODE_Y_INDEXED(5)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  7, PLAYER7, TRACKBALL_Y,         "트랙볼 Y 7",              input_seq(MOUSECODE_Y_INDEXED(6), input_seq::or_code, JOYCODE_Y_INDEXED(6)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  8, PLAYER8, TRACKBALL_Y,         "트랙볼 Y 8",              input_seq(MOUSECODE_Y_INDEXED(7), input_seq::or_code, JOYCODE_Y_INDEXED(7)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, TRACKBALL_Y,         "트랙볼 Y 9",              input_seq(MOUSECODE_Y_INDEXED(8), input_seq::or_code, JOYCODE_Y_INDEXED(8)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, TRACKBALL_Y,        "트랙볼 Y 10",             input_seq(MOUSECODE_Y_INDEXED(9), input_seq::or_code, JOYCODE_Y_INDEXED(9)), input_seq(), input_seq() ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_AD_STICK_X \
		CORE_INPUT_TYPES_BEGIN(ad_stick_x) \
		INPUT_PORT_ANALOG_TYPE(  1, PLAYER1, AD_STICK_X,          "AD 스틱 X",             input_seq(JOYCODE_X_INDEXED(0), input_seq::or_code, MOUSECODE_X_INDEXED(0)), input_seq(KEYCODE_LEFT), input_seq(KEYCODE_RIGHT) ) \
		INPUT_PORT_ANALOG_TYPE(  2, PLAYER2, AD_STICK_X,          "AD 스틱 X 2",           input_seq(JOYCODE_X_INDEXED(1), input_seq::or_code, MOUSECODE_X_INDEXED(1)), input_seq(KEYCODE_D), input_seq(KEYCODE_G) ) \
		INPUT_PORT_ANALOG_TYPE(  3, PLAYER3, AD_STICK_X,          "AD 스틱 X 3",           input_seq(JOYCODE_X_INDEXED(2), input_seq::or_code, MOUSECODE_X_INDEXED(2)), input_seq(KEYCODE_J), input_seq(KEYCODE_L) ) \
		INPUT_PORT_ANALOG_TYPE(  4, PLAYER4, AD_STICK_X,          "AD 스틱 X 4",           input_seq(JOYCODE_X_INDEXED(3), input_seq::or_code, MOUSECODE_X_INDEXED(3)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  5, PLAYER5, AD_STICK_X,          "AD 스틱 X 5",           input_seq(JOYCODE_X_INDEXED(4), input_seq::or_code, MOUSECODE_X_INDEXED(4)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  6, PLAYER6, AD_STICK_X,          "AD 스틱 X 6",           input_seq(JOYCODE_X_INDEXED(5), input_seq::or_code, MOUSECODE_X_INDEXED(5)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  7, PLAYER7, AD_STICK_X,          "AD 스틱 X 7",           input_seq(JOYCODE_X_INDEXED(6), input_seq::or_code, MOUSECODE_X_INDEXED(6)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  8, PLAYER8, AD_STICK_X,          "AD 스틱 X 8",           input_seq(JOYCODE_X_INDEXED(7), input_seq::or_code, MOUSECODE_X_INDEXED(7)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, AD_STICK_X,          "AD 스틱 X 9",           input_seq(JOYCODE_X_INDEXED(8), input_seq::or_code, MOUSECODE_X_INDEXED(8)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, AD_STICK_X,         "AD 스틱 X 10",          input_seq(JOYCODE_X_INDEXED(9), input_seq::or_code, MOUSECODE_X_INDEXED(9)), input_seq(), input_seq() ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_AD_STICK_Y \
		CORE_INPUT_TYPES_BEGIN(ad_stick_y) \
		INPUT_PORT_ANALOG_TYPE(  1, PLAYER1, AD_STICK_Y,          "AD 스틱 Y",             input_seq(JOYCODE_Y_INDEXED(0), input_seq::or_code, MOUSECODE_Y_INDEXED(0)), input_seq(KEYCODE_UP), input_seq(KEYCODE_DOWN) ) \
		INPUT_PORT_ANALOG_TYPE(  2, PLAYER2, AD_STICK_Y,          "AD 스틱 Y 2",           input_seq(JOYCODE_Y_INDEXED(1), input_seq::or_code, MOUSECODE_Y_INDEXED(1)), input_seq(KEYCODE_R), input_seq(KEYCODE_F) ) \
		INPUT_PORT_ANALOG_TYPE(  3, PLAYER3, AD_STICK_Y,          "AD 스틱 Y 3",           input_seq(JOYCODE_Y_INDEXED(2), input_seq::or_code, MOUSECODE_Y_INDEXED(2)), input_seq(KEYCODE_I), input_seq(KEYCODE_K) ) \
		INPUT_PORT_ANALOG_TYPE(  4, PLAYER4, AD_STICK_Y,          "AD 스틱 Y 4",           input_seq(JOYCODE_Y_INDEXED(3), input_seq::or_code, MOUSECODE_Y_INDEXED(3)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  5, PLAYER5, AD_STICK_Y,          "AD 스틱 Y 5",           input_seq(JOYCODE_Y_INDEXED(4), input_seq::or_code, MOUSECODE_Y_INDEXED(4)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  6, PLAYER6, AD_STICK_Y,          "AD 스틱 Y 6",           input_seq(JOYCODE_Y_INDEXED(5), input_seq::or_code, MOUSECODE_Y_INDEXED(5)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  7, PLAYER7, AD_STICK_Y,          "AD 스틱 Y 7",           input_seq(JOYCODE_Y_INDEXED(6), input_seq::or_code, MOUSECODE_Y_INDEXED(6)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  8, PLAYER8, AD_STICK_Y,          "AD 스틱 Y 8",           input_seq(JOYCODE_Y_INDEXED(7), input_seq::or_code, MOUSECODE_Y_INDEXED(7)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, AD_STICK_Y,          "AD 스틱 Y 9",           input_seq(JOYCODE_Y_INDEXED(8), input_seq::or_code, MOUSECODE_Y_INDEXED(8)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, AD_STICK_Y,         "AD 스틱 Y 10",          input_seq(JOYCODE_Y_INDEXED(9), input_seq::or_code, MOUSECODE_Y_INDEXED(9)), input_seq(), input_seq() ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_AD_STICK_Z \
		CORE_INPUT_TYPES_BEGIN(ad_stick_z) \
		INPUT_PORT_ANALOG_TYPE(  1, PLAYER1, AD_STICK_Z,          "AD 스틱 Z",             input_seq(JOYCODE_Z_INDEXED(0)), input_seq(KEYCODE_A), input_seq(KEYCODE_Z) ) \
		INPUT_PORT_ANALOG_TYPE(  2, PLAYER2, AD_STICK_Z,          "AD 스틱 Z 2",           input_seq(JOYCODE_Z_INDEXED(1)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  3, PLAYER3, AD_STICK_Z,          "AD 스틱 Z 3",           input_seq(JOYCODE_Z_INDEXED(2)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  4, PLAYER4, AD_STICK_Z,          "AD 스틱 Z 4",           input_seq(JOYCODE_Z_INDEXED(3)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  5, PLAYER5, AD_STICK_Z,          "AD 스틱 Z 5",           input_seq(JOYCODE_Z_INDEXED(4)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  6, PLAYER6, AD_STICK_Z,          "AD 스틱 Z 6",           input_seq(JOYCODE_Z_INDEXED(5)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  7, PLAYER7, AD_STICK_Z,          "AD 스틱 Z 7",           input_seq(JOYCODE_Z_INDEXED(6)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  8, PLAYER8, AD_STICK_Z,          "AD 스틱 Z 8",           input_seq(JOYCODE_Z_INDEXED(7)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, AD_STICK_Z,          "AD 스틱 Z 9",           input_seq(JOYCODE_Z_INDEXED(8)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, AD_STICK_Z,         "AD 스틱 Z 10",          input_seq(JOYCODE_Z_INDEXED(9)), input_seq(), input_seq() ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_LIGHTGUN_X \
		CORE_INPUT_TYPES_BEGIN(lightgun_x) \
		INPUT_PORT_ANALOG_TYPE(  1, PLAYER1, LIGHTGUN_X,          "라이트건 X",             input_seq(GUNCODE_X_INDEXED(0), input_seq::or_code, MOUSECODE_X_INDEXED(0), input_seq::or_code, JOYCODE_X_INDEXED(0)), input_seq(KEYCODE_LEFT), input_seq(KEYCODE_RIGHT) ) \
		INPUT_PORT_ANALOG_TYPE(  2, PLAYER2, LIGHTGUN_X,          "라이트건 X 2",           input_seq(GUNCODE_X_INDEXED(1), input_seq::or_code, MOUSECODE_X_INDEXED(1), input_seq::or_code, JOYCODE_X_INDEXED(1)), input_seq(KEYCODE_D), input_seq(KEYCODE_G) ) \
		INPUT_PORT_ANALOG_TYPE(  3, PLAYER3, LIGHTGUN_X,          "라이트건 X 3",           input_seq(GUNCODE_X_INDEXED(2), input_seq::or_code, MOUSECODE_X_INDEXED(2), input_seq::or_code, JOYCODE_X_INDEXED(2)), input_seq(KEYCODE_J), input_seq(KEYCODE_L) ) \
		INPUT_PORT_ANALOG_TYPE(  4, PLAYER4, LIGHTGUN_X,          "라이트건 X 4",           input_seq(GUNCODE_X_INDEXED(3), input_seq::or_code, MOUSECODE_X_INDEXED(3), input_seq::or_code, JOYCODE_X_INDEXED(3)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  5, PLAYER5, LIGHTGUN_X,          "라이트건 X 5",           input_seq(GUNCODE_X_INDEXED(4), input_seq::or_code, MOUSECODE_X_INDEXED(4), input_seq::or_code, JOYCODE_X_INDEXED(4)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  6, PLAYER6, LIGHTGUN_X,          "라이트건 X 6",           input_seq(GUNCODE_X_INDEXED(5), input_seq::or_code, MOUSECODE_X_INDEXED(5), input_seq::or_code, JOYCODE_X_INDEXED(5)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  7, PLAYER7, LIGHTGUN_X,          "라이트건 X 7",           input_seq(GUNCODE_X_INDEXED(6), input_seq::or_code, MOUSECODE_X_INDEXED(6), input_seq::or_code, JOYCODE_X_INDEXED(6)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  8, PLAYER8, LIGHTGUN_X,          "라이트건 X 8",           input_seq(GUNCODE_X_INDEXED(7), input_seq::or_code, MOUSECODE_X_INDEXED(7), input_seq::or_code, JOYCODE_X_INDEXED(7)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, LIGHTGUN_X,          "라이트건 X 9",           input_seq(GUNCODE_X_INDEXED(8), input_seq::or_code, MOUSECODE_X_INDEXED(8), input_seq::or_code, JOYCODE_X_INDEXED(8)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, LIGHTGUN_X,         "라이트건 X 10",          input_seq(GUNCODE_X_INDEXED(9), input_seq::or_code, MOUSECODE_X_INDEXED(9), input_seq::or_code, JOYCODE_X_INDEXED(9)), input_seq(), input_seq() ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_LIGHTGUN_Y \
		CORE_INPUT_TYPES_BEGIN(lightgun_y) \
		INPUT_PORT_ANALOG_TYPE(  1, PLAYER1, LIGHTGUN_Y,          "라이트건 Y",             input_seq(GUNCODE_Y_INDEXED(0), input_seq::or_code, MOUSECODE_Y_INDEXED(0), input_seq::or_code, JOYCODE_Y_INDEXED(0)), input_seq(KEYCODE_UP), input_seq(KEYCODE_DOWN) ) \
		INPUT_PORT_ANALOG_TYPE(  2, PLAYER2, LIGHTGUN_Y,          "라이트건 Y 2",           input_seq(GUNCODE_Y_INDEXED(1), input_seq::or_code, MOUSECODE_Y_INDEXED(1), input_seq::or_code, JOYCODE_Y_INDEXED(1)), input_seq(KEYCODE_R), input_seq(KEYCODE_F) ) \
		INPUT_PORT_ANALOG_TYPE(  3, PLAYER3, LIGHTGUN_Y,          "라이트건 Y 3",           input_seq(GUNCODE_Y_INDEXED(2), input_seq::or_code, MOUSECODE_Y_INDEXED(2), input_seq::or_code, JOYCODE_Y_INDEXED(2)), input_seq(KEYCODE_I), input_seq(KEYCODE_K) ) \
		INPUT_PORT_ANALOG_TYPE(  4, PLAYER4, LIGHTGUN_Y,          "라이트건 Y 4",           input_seq(GUNCODE_Y_INDEXED(3), input_seq::or_code, MOUSECODE_Y_INDEXED(3), input_seq::or_code, JOYCODE_Y_INDEXED(3)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  5, PLAYER5, LIGHTGUN_Y,          "라이트건 Y 5",           input_seq(GUNCODE_Y_INDEXED(4), input_seq::or_code, MOUSECODE_Y_INDEXED(4), input_seq::or_code, JOYCODE_Y_INDEXED(4)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  6, PLAYER6, LIGHTGUN_Y,          "라이트건 Y 6",           input_seq(GUNCODE_Y_INDEXED(5), input_seq::or_code, MOUSECODE_Y_INDEXED(5), input_seq::or_code, JOYCODE_Y_INDEXED(5)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  7, PLAYER7, LIGHTGUN_Y,          "라이트건 Y 7",           input_seq(GUNCODE_Y_INDEXED(6), input_seq::or_code, MOUSECODE_Y_INDEXED(6), input_seq::or_code, JOYCODE_Y_INDEXED(6)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  8, PLAYER8, LIGHTGUN_Y,          "라이트건 Y 8",           input_seq(GUNCODE_Y_INDEXED(7), input_seq::or_code, MOUSECODE_Y_INDEXED(7), input_seq::or_code, JOYCODE_Y_INDEXED(7)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, LIGHTGUN_Y,          "라이트건 Y 9",           input_seq(GUNCODE_Y_INDEXED(8), input_seq::or_code, MOUSECODE_Y_INDEXED(8), input_seq::or_code, JOYCODE_Y_INDEXED(8)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, LIGHTGUN_Y,         "라이트건 Y 10",          input_seq(GUNCODE_Y_INDEXED(9), input_seq::or_code, MOUSECODE_Y_INDEXED(9), input_seq::or_code, JOYCODE_Y_INDEXED(9)), input_seq(), input_seq() ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_MOUSE_X \
		CORE_INPUT_TYPES_BEGIN(mouse_x) \
		INPUT_PORT_ANALOG_TYPE(  1, PLAYER1, MOUSE_X,             "마우스 X",                input_seq(MOUSECODE_X_INDEXED(0)), input_seq(KEYCODE_LEFT), input_seq(KEYCODE_RIGHT) ) \
		INPUT_PORT_ANALOG_TYPE(  2, PLAYER2, MOUSE_X,             "마우스 X 2",              input_seq(MOUSECODE_X_INDEXED(1)), input_seq(KEYCODE_D), input_seq(KEYCODE_G) ) \
		INPUT_PORT_ANALOG_TYPE(  3, PLAYER3, MOUSE_X,             "마우스 X 3",              input_seq(MOUSECODE_X_INDEXED(2)), input_seq(KEYCODE_J), input_seq(KEYCODE_L) ) \
		INPUT_PORT_ANALOG_TYPE(  4, PLAYER4, MOUSE_X,             "마우스 X 4",              input_seq(MOUSECODE_X_INDEXED(3)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  5, PLAYER5, MOUSE_X,             "마우스 X 5",              input_seq(MOUSECODE_X_INDEXED(4)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  6, PLAYER6, MOUSE_X,             "마우스 X 6",              input_seq(MOUSECODE_X_INDEXED(5)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  7, PLAYER7, MOUSE_X,             "마우스 X 7",              input_seq(MOUSECODE_X_INDEXED(6)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  8, PLAYER8, MOUSE_X,             "마우스 X 8",              input_seq(MOUSECODE_X_INDEXED(7)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, MOUSE_X,             "마우스 X 9",              input_seq(MOUSECODE_X_INDEXED(8)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, MOUSE_X,            "마우스 X 10",             input_seq(MOUSECODE_X_INDEXED(9)), input_seq(), input_seq() ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_MOUSE_Y \
		CORE_INPUT_TYPES_BEGIN(mouse_y) \
		INPUT_PORT_ANALOG_TYPE(  1, PLAYER1, MOUSE_Y,             "마우스 Y",                input_seq(MOUSECODE_Y_INDEXED(0)), input_seq(KEYCODE_UP), input_seq(KEYCODE_DOWN) ) \
		INPUT_PORT_ANALOG_TYPE(  2, PLAYER2, MOUSE_Y,             "마우스 Y 2",              input_seq(MOUSECODE_Y_INDEXED(1)), input_seq(KEYCODE_R), input_seq(KEYCODE_F) ) \
		INPUT_PORT_ANALOG_TYPE(  3, PLAYER3, MOUSE_Y,             "마우스 Y 3",              input_seq(MOUSECODE_Y_INDEXED(2)), input_seq(KEYCODE_I), input_seq(KEYCODE_K) ) \
		INPUT_PORT_ANALOG_TYPE(  4, PLAYER4, MOUSE_Y,             "마우스 Y 4",              input_seq(MOUSECODE_Y_INDEXED(3)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  5, PLAYER5, MOUSE_Y,             "마우스 Y 5",              input_seq(MOUSECODE_Y_INDEXED(4)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  6, PLAYER6, MOUSE_Y,             "마우스 Y 6",              input_seq(MOUSECODE_Y_INDEXED(5)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  7, PLAYER7, MOUSE_Y,             "마우스 Y 7",              input_seq(MOUSECODE_Y_INDEXED(6)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  8, PLAYER8, MOUSE_Y,             "마우스 Y 8",              input_seq(MOUSECODE_Y_INDEXED(7)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE(  9, PLAYER9, MOUSE_Y,             "마우스 Y 9",              input_seq(MOUSECODE_Y_INDEXED(8)), input_seq(), input_seq() ) \
		INPUT_PORT_ANALOG_TYPE( 10, PLAYER10, MOUSE_Y,            "마우스 Y 10",             input_seq(MOUSECODE_Y_INDEXED(9)), input_seq(), input_seq() ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_KEYPAD \
		CORE_INPUT_TYPES_BEGIN(keypad) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   KEYPAD,              "키패드",                 input_seq() ) \
		INPUT_PORT_DIGITAL_TYPE( 0, OTHER,   KEYBOARD,            "키보드",               input_seq() ) \
		CORE_INPUT_TYPES_END()

#define CORE_INPUT_TYPES_UI \
		CORE_INPUT_TYPES_BEGIN(ui) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_ON_SCREEN_DISPLAY,"온스크린 디스플레이",      input_seq(KEYCODE_TILDE, input_seq::not_code, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_DEBUG_BREAK,      "디버거 브레이크",      input_seq(KEYCODE_TILDE, input_seq::not_code, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_CONFIGURE,        "설정 메뉴",            input_seq(KEYCODE_TAB) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_PAUSE,            "일시 정지",                  input_seq(KEYCODE_P, input_seq::not_code, KEYCODE_LSHIFT, input_seq::not_code, KEYCODE_RSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_PAUSE_SINGLE,     "일시 저징 - 싱글스탭",    input_seq(KEYCODE_P, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_REWIND_SINGLE,    "되감기 - 싱글스탭",   input_seq(KEYCODE_TILDE, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_RESET_MACHINE,    "게임 재실행",          input_seq(KEYCODE_F3, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_SOFT_RESET,       "소프트 리셋",             input_seq(KEYCODE_F3, input_seq::not_code, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_SHOW_GFX,         "Gfx 보기",               input_seq(KEYCODE_F4) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_FRAMESKIP_DEC,    "프레임 스킵 감소",          input_seq(KEYCODE_F8) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_FRAMESKIP_INC,    "프레임 스킵 증가",          input_seq(KEYCODE_F9) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_THROTTLE,         "쓰로틀",               input_seq(KEYCODE_F10) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_FAST_FORWARD,     "앞으로 빨리감기",           input_seq(KEYCODE_INSERT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_SHOW_FPS,         "프레임 보기",               input_seq(KEYCODE_F11, input_seq::not_code, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_SNAPSHOT,         "스냅샷 저장",          input_seq(KEYCODE_F12, input_seq::not_code, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_TIMECODE,         "현재 타임코드 기록", input_seq(KEYCODE_F12, input_seq::not_code, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_RECORD_MNG,       "MNG 녹화",             input_seq(KEYCODE_F12, KEYCODE_LSHIFT, input_seq::not_code, KEYCODE_LCONTROL) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_RECORD_AVI,       "AVI 녹화",             input_seq(KEYCODE_F12, KEYCODE_LSHIFT, KEYCODE_LCONTROL) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_TOGGLE_CHEAT,     "토글 치트",           input_seq(KEYCODE_F6, KEYCODE_LSHIFT) )\
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_TOGGLE_CHEAT_CONFIG,"치트 설정",           input_seq(KEYCODE_F6, input_seq::not_code, KEYCODE_LSHIFT) )\
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_TOGGLE_AUTOFIRE,  "토글 자동연사",        input_seq() )\
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_UP,               "UI 위",                input_seq(KEYCODE_UP, input_seq::or_code, JOYCODE_Y_UP_SWITCH_INDEXED(1), input_seq::or_code, JOYCODE_Y_UP_SWITCH_INDEXED(2)) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_DOWN,             "UI 아래",              input_seq(KEYCODE_DOWN, input_seq::or_code, JOYCODE_Y_DOWN_SWITCH_INDEXED(1), input_seq::or_code, JOYCODE_Y_UP_SWITCH_INDEXED(2)) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_LEFT,             "UI 왼쪽",              input_seq(KEYCODE_LEFT, input_seq::or_code, JOYCODE_X_LEFT_SWITCH_INDEXED(1), input_seq::or_code, JOYCODE_Y_UP_SWITCH_INDEXED(2)) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_RIGHT,            "UI 오른쪽",            input_seq(KEYCODE_RIGHT, input_seq::or_code, JOYCODE_X_RIGHT_SWITCH_INDEXED(1), input_seq::or_code, JOYCODE_Y_UP_SWITCH_INDEXED(2)) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_HOME,             "UI 홈",                input_seq(KEYCODE_HOME) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_END,              "UI 엔드",                 input_seq(KEYCODE_END) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_PAGE_UP,          "UI 페이지업",             input_seq(KEYCODE_PGUP) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_PAGE_DOWN,        "UI 페이지다운",           input_seq(KEYCODE_PGDN) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_FOCUS_NEXT,       "UI 포커스 다움",          input_seq(KEYCODE_TAB, input_seq::not_code, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_FOCUS_PREV,       "UI 포커스 이전",      input_seq(KEYCODE_TAB, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_SELECT,           "UI 선택",              input_seq(KEYCODE_ENTER, input_seq::or_code, JOYCODE_BUTTON1_INDEXED(1), input_seq::or_code, JOYCODE_BUTTON1_INDEXED(2), input_seq::or_code, KEYCODE_ENTER_PAD) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_CANCEL,           "UI 취소",              input_seq(KEYCODE_ESC) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_DISPLAY_COMMENT,  "UI 디스플레이 코맨트",     input_seq(KEYCODE_SPACE) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_CLEAR,            "UI 클리어",               input_seq(KEYCODE_DEL) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_ZOOM_IN,          "UI 줌 인",             input_seq(KEYCODE_EQUALS) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_ZOOM_OUT,         "UI 줌 아웃",            input_seq(KEYCODE_MINUS) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_PREV_GROUP,       "UI 이전 그룹",      input_seq(KEYCODE_OPENBRACE) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_NEXT_GROUP,       "UI 다음 그룹",          input_seq(KEYCODE_CLOSEBRACE) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_ROTATE,           "UI 회전",              input_seq(KEYCODE_R) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_SHOW_PROFILER,    "프로필 보기",          input_seq(KEYCODE_F11, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_TOGGLE_UI,        "UI 토글",              input_seq(KEYCODE_SCRLOCK, input_seq::not_code, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_PASTE,            "UI 텍스트 붙여넣기",          input_seq(KEYCODE_SCRLOCK, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_TOGGLE_DEBUG,     "토글 디버거",        input_seq(KEYCODE_F5, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_SAVE_STATE,       "게임 저장",             input_seq(KEYCODE_F7, input_seq::not_code,  KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_LOAD_STATE,       "게임 로드",             input_seq(KEYCODE_F7, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_TAPE_START,       "UI (첫번째) 테이프 시작",  input_seq(KEYCODE_F2, input_seq::not_code, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_TAPE_STOP,        "UI (첫번째) 테이프 중지",   input_seq(KEYCODE_F2, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_DATS,             "UI 외부 DATA 뷰",   			input_seq(KEYCODE_LALT, KEYCODE_D) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_FAVORITES,        "UI 즐겨찾기 추가/삭제",	input_seq(KEYCODE_LALT, KEYCODE_F) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_EXPORT,           "UI 목록 출력",         	input_seq(KEYCODE_LALT, KEYCODE_E) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_AUDIT_FAST,       "UI 불가능 검사",   		input_seq(KEYCODE_F1, input_seq::not_code, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_AUDIT_ALL,        "UI 모든 검사",           input_seq(KEYCODE_F1, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_SHOW_TIME,        "현재시간 보기",      input_seq(KEYCODE_G, KEYCODE_LSHIFT) ) \
		INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_SHOW_COMMAND,  	  "공략 보기",    		input_seq(KEYCODE_F5, input_seq::not_code, KEYCODE_LSHIFT) )\
		CORE_INPUT_TYPES_END()
